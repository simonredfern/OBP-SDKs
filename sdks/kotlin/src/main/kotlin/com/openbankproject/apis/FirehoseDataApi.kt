...
open class FirehoseDataApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun oBPv400GetFastFirehoseAccountsAtOneBank(bankid: kotlin.String) : OBPv400GetFastFirehoseAccountsAtOneBank200Response {
        val localVarResponse = oBPv400GetFastFirehoseAccountsAtOneBankWithHttpInfo(bankid = bankid)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as OBPv400GetFastFirehoseAccountsAtOneBank200Response
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun oBPv400GetFastFirehoseAccountsAtOneBankWithHttpInfo(bankid: kotlin.String) : ApiResponse<OBPv400GetFastFirehoseAccountsAtOneBank200Response?> {
        val localVariableConfig = oBPv400GetFastFirehoseAccountsAtOneBankRequestConfig(bankid = bankid)

        return request<Unit, OBPv400GetFastFirehoseAccountsAtOneBank200Response>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation oBPv400GetFastFirehoseAccountsAtOneBank
     *
     * @param bankid The BANKID identifier
     * @return RequestConfig
     */
    fun oBPv400GetFastFirehoseAccountsAtOneBankRequestConfig(bankid: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "application/json"
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/obp/v4.0.0/management/banks/{bankid}/fast-firehose/accounts".replace("{"+"bankid"+"}", encodeURIComponent(bankid.toString())),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
            body = localVariableBody
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun oBPv400GetFirehoseAccountsAtOneBank(bankid: kotlin.String, viewid: kotlin.String) : OBPv400GetFirehoseAccountsAtOneBank200Response {
        val localVarResponse = oBPv400GetFirehoseAccountsAtOneBankWithHttpInfo(bankid = bankid, viewid = viewid)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as OBPv400GetFirehoseAccountsAtOneBank200Response
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun oBPv400GetFirehoseAccountsAtOneBankWithHttpInfo(bankid: kotlin.String, viewid: kotlin.String) : ApiResponse<OBPv400GetFirehoseAccountsAtOneBank200Response?> {
        val localVariableConfig = oBPv400GetFirehoseAccountsAtOneBankRequestConfig(bankid = bankid, viewid = viewid)

        return request<Unit, OBPv400GetFirehoseAccountsAtOneBank200Response>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation oBPv400GetFirehoseAccountsAtOneBank
     *
     * @param bankid The BANKID identifier
     * @param viewid The VIEWID identifier
     * @return RequestConfig
     */
    fun oBPv400GetFirehoseAccountsAtOneBankRequestConfig(bankid: kotlin.String, viewid: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "application/json"
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/obp/v4.0.0/banks/{bankid}/firehose/accounts/views/{viewid}".replace("{"+"bankid"+"}", encodeURIComponent(bankid.toString())).replace("{"+"viewid"+"}", encodeURIComponent(viewid.toString())),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
            body = localVariableBody
