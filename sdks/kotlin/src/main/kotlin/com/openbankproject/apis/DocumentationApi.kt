...
open class DocumentationApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun oBPv300GetApiGlossary() : OBPv300GetApiGlossary200Response {
        val localVarResponse = oBPv300GetApiGlossaryWithHttpInfo()

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as OBPv300GetApiGlossary200Response
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun oBPv300GetApiGlossaryWithHttpInfo() : ApiResponse<OBPv300GetApiGlossary200Response?> {
        val localVariableConfig = oBPv300GetApiGlossaryRequestConfig()

        return request<Unit, OBPv300GetApiGlossary200Response>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation oBPv300GetApiGlossary
     *
     * @return RequestConfig
     */
    fun oBPv300GetApiGlossaryRequestConfig() : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "application/json"
