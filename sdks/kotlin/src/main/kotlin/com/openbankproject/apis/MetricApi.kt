...
open class MetricApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    /**
     * GET /obp/v3.1.0/management/metrics/top-consumers
     * Get Top Consumers
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun oBPv310GetMetricsTopConsumers() : OBPv310GetMetricsTopConsumers200Response {
        val localVarResponse = oBPv310GetMetricsTopConsumersWithHttpInfo()

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as OBPv310GetMetricsTopConsumers200Response
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun oBPv310GetMetricsTopConsumersWithHttpInfo() : ApiResponse<OBPv310GetMetricsTopConsumers200Response?> {
        val localVariableConfig = oBPv310GetMetricsTopConsumersRequestConfig()

        return request<Unit, OBPv310GetMetricsTopConsumers200Response>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation oBPv310GetMetricsTopConsumers
     *
     * @return RequestConfig
     */
    fun oBPv310GetMetricsTopConsumersRequestConfig() : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "application/json"
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/obp/v3.1.0/management/metrics/top-consumers",
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
            body = localVariableBody
