...
val apiInstance = AccountFirehoseApi()
...
try {
    ...
    println("4xx response calling AccountFirehoseApi#oBPv300GetFirehoseTransactionsForBankAccount")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling AccountFirehoseApi#oBPv300GetFirehoseTransactionsForBankAccount")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling AccountFirehoseApi#oBPv400GetFastFirehoseAccountsAtOneBank")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling AccountFirehoseApi#oBPv400GetFastFirehoseAccountsAtOneBank")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling AccountFirehoseApi#oBPv400GetFirehoseAccountsAtOneBank")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling AccountFirehoseApi#oBPv400GetFirehoseAccountsAtOneBank")
    e.printStackTrace()
}
```
