...
try {
    ...
    println("4xx response calling SignallingApi#oBPv600DeleteSignalChannel")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling SignallingApi#oBPv600DeleteSignalChannel")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling SignallingApi#oBPv600GetSignalChannelInfo")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling SignallingApi#oBPv600GetSignalChannelInfo")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling SignallingApi#oBPv600GetSignalChannels")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling SignallingApi#oBPv600GetSignalChannels")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling SignallingApi#oBPv600GetSignalMessages")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling SignallingApi#oBPv600GetSignalMessages")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling SignallingApi#oBPv600GetSignalStats")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling SignallingApi#oBPv600GetSignalStats")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling SignallingApi#oBPv600PublishSignalMessage")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling SignallingApi#oBPv600PublishSignalMessage")
    e.printStackTrace()
}
```
