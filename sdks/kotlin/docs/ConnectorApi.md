...
try {
    ...
    println("4xx response calling ConnectorApi#oBPv600GetConnectors")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ConnectorApi#oBPv600GetConnectors")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling ConnectorApi#oBPv600GetStoredProcedureConnectorHealth")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ConnectorApi#oBPv600GetStoredProcedureConnectorHealth")
    e.printStackTrace()
}
```
