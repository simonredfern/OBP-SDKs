...
try {
    ...
    println("4xx response calling PersonApi#oBPv140AddCustomerMessage")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling PersonApi#oBPv140AddCustomerMessage")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling PersonApi#oBPv400CreateCustomerMessage")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling PersonApi#oBPv400CreateCustomerMessage")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling PersonApi#oBPv510CreateAgent")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling PersonApi#oBPv510CreateAgent")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling PersonApi#oBPv510UpdateAgentStatus")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling PersonApi#oBPv510UpdateAgentStatus")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling PersonApi#oBPv600CreateCustomer")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling PersonApi#oBPv600CreateCustomer")
    e.printStackTrace()
}
```
