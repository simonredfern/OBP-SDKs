...
try {
    ...
    println("4xx response calling AccountAttributeApi#oBPv310CreateAccountAttribute")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling AccountAttributeApi#oBPv310CreateAccountAttribute")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling AccountAttributeApi#oBPv310UpdateAccountAttribute")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling AccountAttributeApi#oBPv310UpdateAccountAttribute")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling AccountAttributeApi#oBPv400CreateOrUpdateAccountAttributeDefinition")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling AccountAttributeApi#oBPv400CreateOrUpdateAccountAttributeDefinition")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling AccountAttributeApi#oBPv400DeleteAccountAttributeDefinition")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling AccountAttributeApi#oBPv400DeleteAccountAttributeDefinition")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling AccountAttributeApi#oBPv400GetAccountAttributeDefinition")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling AccountAttributeApi#oBPv400GetAccountAttributeDefinition")
    e.printStackTrace()
}
```
