...
try {
    ...
    println("4xx response calling OnboardingApi#oBPv500CreateAccount")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling OnboardingApi#oBPv500CreateAccount")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling OnboardingApi#oBPv600CreateUser")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling OnboardingApi#oBPv600CreateUser")
    e.printStackTrace()
}
```
