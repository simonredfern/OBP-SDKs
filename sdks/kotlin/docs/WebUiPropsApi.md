...
<a id="oBPv310CreateWebUiProps"></a>
...
try {
    ...
    println("4xx response calling WebUiPropsApi#oBPv310CreateWebUiProps")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling WebUiPropsApi#oBPv310CreateWebUiProps")
    e.printStackTrace()
}
```
...
<a id="oBPv310DeleteWebUiProps"></a>
...
try {
    ...
    println("4xx response calling WebUiPropsApi#oBPv310DeleteWebUiProps")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling WebUiPropsApi#oBPv310DeleteWebUiProps")
    e.printStackTrace()
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **webuipropsid** | **kotlin.String**| The WEBUIPROPSID identifier | |
...
try {
    ...
    println("4xx response calling WebUiPropsApi#oBPv310GetWebUiProps")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling WebUiPropsApi#oBPv310GetWebUiProps")
    e.printStackTrace()
}
```
...
<a id="oBPv600CreateOrUpdateWebUiProps"></a>
...
try {
    ...
    println("4xx response calling WebUiPropsApi#oBPv600CreateOrUpdateWebUiProps")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling WebUiPropsApi#oBPv600CreateOrUpdateWebUiProps")
    e.printStackTrace()
}
```

### Parameters
| **webuipropname** | **kotlin.String**| The WEBUIPROPNAME identifier | |
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
...
<a id="oBPv600DeleteWebUiProps"></a>
...
try {
    ...
    println("4xx response calling WebUiPropsApi#oBPv600DeleteWebUiProps")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling WebUiPropsApi#oBPv600DeleteWebUiProps")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling WebUiPropsApi#oBPv600GetWebUiProp")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling WebUiPropsApi#oBPv600GetWebUiProp")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling WebUiPropsApi#oBPv600GetWebUiProps")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling WebUiPropsApi#oBPv600GetWebUiProps")
    e.printStackTrace()
}
```
