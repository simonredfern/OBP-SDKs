...
try {
    ...
    println("4xx response calling OIDCApi#oBPv310GetOAuth2ServerJWKsURIs")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling OIDCApi#oBPv310GetOAuth2ServerJWKsURIs")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling OIDCApi#oBPv310GetObpConnectorLoopback")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling OIDCApi#oBPv310GetObpConnectorLoopback")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling OIDCApi#oBPv600GetOidcClient")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling OIDCApi#oBPv600GetOidcClient")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling OIDCApi#oBPv600VerifyOidcClient")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling OIDCApi#oBPv600VerifyOidcClient")
    e.printStackTrace()
}
```
