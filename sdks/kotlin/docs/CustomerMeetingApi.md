...
val apiInstance = CustomerMeetingApi()
...
try {
    ...
    println("4xx response calling CustomerMeetingApi#oBPv310CreateMeeting")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling CustomerMeetingApi#oBPv310CreateMeeting")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling CustomerMeetingApi#oBPv310GetMeeting")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling CustomerMeetingApi#oBPv310GetMeeting")
    e.printStackTrace()
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **meetingid** | **kotlin.String**| The MEETINGID identifier | |
...
try {
    ...
    println("4xx response calling CustomerMeetingApi#oBPv310GetMeetings")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling CustomerMeetingApi#oBPv310GetMeetings")
    e.printStackTrace()
}
```
