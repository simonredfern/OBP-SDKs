...
try {
    ...
    println("4xx response calling ChannelApi#oBPv600DeleteSignalChannel")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ChannelApi#oBPv600DeleteSignalChannel")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling ChannelApi#oBPv600GetSignalChannelInfo")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ChannelApi#oBPv600GetSignalChannelInfo")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling ChannelApi#oBPv600GetSignalChannels")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ChannelApi#oBPv600GetSignalChannels")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling ChannelApi#oBPv600GetSignalMessages")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ChannelApi#oBPv600GetSignalMessages")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling ChannelApi#oBPv600GetSignalStats")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ChannelApi#oBPv600GetSignalStats")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling ChannelApi#oBPv600PublishSignalMessage")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ChannelApi#oBPv600PublishSignalMessage")
    e.printStackTrace()
}
```
