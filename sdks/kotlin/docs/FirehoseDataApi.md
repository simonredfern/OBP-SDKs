...
try {
    ...
    println("4xx response calling FirehoseDataApi#oBPv300GetFirehoseTransactionsForBankAccount")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling FirehoseDataApi#oBPv300GetFirehoseTransactionsForBankAccount")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling FirehoseDataApi#oBPv310GetFirehoseCustomers")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling FirehoseDataApi#oBPv310GetFirehoseCustomers")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling FirehoseDataApi#oBPv400GetFastFirehoseAccountsAtOneBank")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling FirehoseDataApi#oBPv400GetFastFirehoseAccountsAtOneBank")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling FirehoseDataApi#oBPv400GetFirehoseAccountsAtOneBank")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling FirehoseDataApi#oBPv400GetFirehoseAccountsAtOneBank")
    e.printStackTrace()
}
```
