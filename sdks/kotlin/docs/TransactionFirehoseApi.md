...
try {
    ...
    println("4xx response calling TransactionFirehoseApi#oBPv300GetFirehoseTransactionsForBankAccount")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling TransactionFirehoseApi#oBPv300GetFirehoseTransactionsForBankAccount")
    e.printStackTrace()
}
```
