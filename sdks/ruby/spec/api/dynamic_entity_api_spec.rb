...
# Unit tests for OpenBankProject::DynamicEntityApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'DynamicEntityApi' do
  before do
  ...
  describe 'test an instance of DynamicEntityApi' do
    it 'should create an instance of DynamicEntityApi' do
      expect(@api_instance).to be_instance_of(OpenBankProject::DynamicEntityApi)
    end
  end
