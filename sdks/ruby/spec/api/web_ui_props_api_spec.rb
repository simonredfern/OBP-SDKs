...
# Unit tests for OpenBankProject::WebUiPropsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'WebUiPropsApi' do
  before do
  ...
  describe 'test an instance of WebUiPropsApi' do
    it 'should create an instance of WebUiPropsApi' do
      expect(@api_instance).to be_instance_of(OpenBankProject::WebUiPropsApi)
    end
  end

  # unit tests for o_bpv3_1_0_create_web_ui_props
  # Create WebUiProps
  ...
  # @param obpv400_create_transaction_request_counterparty200_response_properties_attributes_items Request body
  # @param [Hash] opts the optional parameters
  # @return [OBPv310GetWebUiProps200ResponsePropertiesWebuiPropsItems]
  describe 'o_bpv3_1_0_create_web_ui_props test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for o_bpv3_1_0_delete_web_ui_props
  # Delete WebUiProps
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'o_bpv3_1_0_delete_web_ui_props test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for o_bpv3_1_0_get_web_ui_props
  # Get WebUiProps
  ...
  describe 'o_bpv3_1_0_get_web_ui_props test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for o_bpv6_0_0_create_or_update_web_ui_props
  ...
  # @param [Hash] opts the optional parameters
  # @return [OBPv310GetWebUiProps200ResponsePropertiesWebuiPropsItems]
  describe 'o_bpv6_0_0_create_or_update_web_ui_props test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for o_bpv6_0_0_delete_web_ui_props
  # Delete WebUiProps
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'o_bpv6_0_0_delete_web_ui_props test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for o_bpv6_0_0_get_web_ui_prop
  ...
  describe 'o_bpv6_0_0_get_web_ui_prop test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for o_bpv6_0_0_get_web_ui_props
  # Get WebUiProps
  ...
  describe 'o_bpv6_0_0_get_web_ui_props test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
