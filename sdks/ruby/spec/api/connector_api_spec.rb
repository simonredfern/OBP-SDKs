...
# Unit tests for OpenBankProject::ConnectorApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ConnectorApi' do
  before do
  ...
  describe 'test an instance of ConnectorApi' do
    it 'should create an instance of ConnectorApi' do
      expect(@api_instance).to be_instance_of(OpenBankProject::ConnectorApi)
    end
  end
