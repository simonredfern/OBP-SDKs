...
# Unit tests for OpenBankProject::CustomerMeetingApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CustomerMeetingApi' do
  before do
  ...
  describe 'test an instance of CustomerMeetingApi' do
    it 'should create an instance of CustomerMeetingApi' do
      expect(@api_instance).to be_instance_of(OpenBankProject::CustomerMeetingApi)
    end
  end
