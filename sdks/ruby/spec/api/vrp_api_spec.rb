...
# Unit tests for OpenBankProject::VRPApi
...
describe 'VRPApi' do
  ...
  describe 'test an instance of VRPApi' do
    it 'should create an instance of VRPApi' do
      expect(@api_instance).to be_instance_of(OpenBankProject::VRPApi)
    end
  end

  # unit tests for o_bpv5_0_0_create_consent_by_consent_request_id_email
  ...
  describe 'o_bpv5_0_0_create_consent_by_consent_request_id_email test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for o_bpv5_1_0_create_vrp_consent_request
  ...
  # @param obpv510_create_vrp_consent_request_request Request body
  # @param [Hash] opts the optional parameters
  # @return [OBPv510CreateVRPConsentRequest200Response]
  describe 'o_bpv5_1_0_create_vrp_consent_request test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
