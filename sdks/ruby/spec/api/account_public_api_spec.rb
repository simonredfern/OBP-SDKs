...
# Unit tests for OpenBankProject::AccountPublicApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AccountPublicApi' do
  before do
  ...
  describe 'test an instance of AccountPublicApi' do
    it 'should create an instance of AccountPublicApi' do
      expect(@api_instance).to be_instance_of(OpenBankProject::AccountPublicApi)
    end
  end
  ...
  # unit tests for o_bpv3_0_0_get_public_account_by_id
  ...
  describe 'o_bpv3_0_0_get_public_account_by_id test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
