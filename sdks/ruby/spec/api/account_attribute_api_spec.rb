...
# Unit tests for OpenBankProject::AccountAttributeApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AccountAttributeApi' do
  before do
  ...
  describe 'test an instance of AccountAttributeApi' do
    it 'should create an instance of AccountAttributeApi' do
      expect(@api_instance).to be_instance_of(OpenBankProject::AccountAttributeApi)
    end
  end
