...
# Unit tests for OpenBankProject::StandingOrderApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'StandingOrderApi' do
  before do
  ...
  describe 'test an instance of StandingOrderApi' do
    it 'should create an instance of StandingOrderApi' do
      expect(@api_instance).to be_instance_of(OpenBankProject::StandingOrderApi)
    end
  end

  # unit tests for o_bpv4_0_0_create_standing_order
  ...
  # @param obpv400_create_standing_order_request Request body
  # @param [Hash] opts the optional parameters
  # @return [OBPv400CreateStandingOrder200Response]
  describe 'o_bpv4_0_0_create_standing_order test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for o_bpv4_0_0_create_standing_order_management
  ...
  # @param [Hash] opts the optional parameters
  # @return [OBPv400CreateStandingOrder200Response]
  describe 'o_bpv4_0_0_create_standing_order_management test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
