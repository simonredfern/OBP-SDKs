...
# Unit tests for OpenBankProject::AIAgentApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AIAgentApi' do
  before do
  ...
  describe 'test an instance of AIAgentApi' do
    it 'should create an instance of AIAgentApi' do
      expect(@api_instance).to be_instance_of(OpenBankProject::AIAgentApi)
    end
  end
