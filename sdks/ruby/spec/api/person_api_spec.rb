...
# Unit tests for OpenBankProject::PersonApi
...
describe 'PersonApi' do
  ...
  describe 'test an instance of PersonApi' do
    it 'should create an instance of PersonApi' do
      expect(@api_instance).to be_instance_of(OpenBankProject::PersonApi)
    end
  end
  ...
  # unit tests for o_bpv5_1_0_create_agent
  # Create Agent
  ...
  # @param bankid The BANKID identifier
  # @param obpv510_create_agent_request Request body
  # @param [Hash] opts the optional parameters
  # @return [OBPv510GetAgent200Response]
  describe 'o_bpv5_1_0_create_agent test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for o_bpv5_1_0_update_agent_status
  # Update Agent status
  ...
  # @param obpv510_update_agent_status_request Request body
  # @param [Hash] opts the optional parameters
  # @return [OBPv510GetAgent200Response]
  describe 'o_bpv5_1_0_update_agent_status test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for o_bpv6_0_0_create_customer
  # Create Customer
  ...
  # @param bankid The BANKID identifier
  # @param obpv600_create_customer_request Request body
  # @param [Hash] opts the optional parameters
  # @return [OBPv600GetCustomerChildren200ResponsePropertiesCustomersItems]
  describe 'o_bpv6_0_0_create_customer test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
