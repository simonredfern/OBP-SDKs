...
# Unit tests for OpenBankProject::TransactionFirehoseApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TransactionFirehoseApi' do
  before do
  ...
  describe 'test an instance of TransactionFirehoseApi' do
    it 'should create an instance of TransactionFirehoseApi' do
      expect(@api_instance).to be_instance_of(OpenBankProject::TransactionFirehoseApi)
    end
  end
