...
# Unit tests for OpenBankProject::ProductAttributeApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ProductAttributeApi' do
  before do
  ...
  describe 'test an instance of ProductAttributeApi' do
    it 'should create an instance of ProductAttributeApi' do
      expect(@api_instance).to be_instance_of(OpenBankProject::ProductAttributeApi)
    end
  end
