...
# Unit tests for OpenBankProject::AggregateMetricsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AggregateMetricsApi' do
  before do
  ...
  describe 'test an instance of AggregateMetricsApi' do
    it 'should create an instance of AggregateMetricsApi' do
      expect(@api_instance).to be_instance_of(OpenBankProject::AggregateMetricsApi)
    end
  end

  # unit tests for o_bpv6_0_0_get_aggregate_metrics
  ...
  describe 'o_bpv6_0_0_get_aggregate_metrics test' do
    it 'should work' do
