...
# Unit tests for OpenBankProject::SignalApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SignalApi' do
  before do
  ...
  describe 'test an instance of SignalApi' do
    it 'should create an instance of SignalApi' do
      expect(@api_instance).to be_instance_of(OpenBankProject::SignalApi)
    end
  end
