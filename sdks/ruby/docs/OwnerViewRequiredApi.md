...
api_instance = OpenBankProject::OwnerViewRequiredApi.new
...
begin
  ...
  puts "Error when calling OwnerViewRequiredApi->o_bpv5_1_0_create_user_with_account_access_by_id: #{e}"
end
```
...
begin
  ...
  puts "Error when calling OwnerViewRequiredApi->o_bpv5_1_0_create_user_with_account_access_by_id_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling OwnerViewRequiredApi->o_bpv5_1_0_grant_user_access_to_view_by_id: #{e}"
end
```
...
begin
  ...
  puts "Error when calling OwnerViewRequiredApi->o_bpv5_1_0_grant_user_access_to_view_by_id_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling OwnerViewRequiredApi->o_bpv5_1_0_revoke_user_access_to_view_by_id: #{e}"
end
```
...
begin
  ...
  puts "Error when calling OwnerViewRequiredApi->o_bpv5_1_0_revoke_user_access_to_view_by_id_with_http_info: #{e}"
end
```
