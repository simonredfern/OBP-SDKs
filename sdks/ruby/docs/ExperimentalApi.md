# OpenBankProject::ExperimentalApi
...
begin
  ...
  puts "Error when calling ExperimentalApi->o_bpv3_1_0_create_meeting: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ExperimentalApi->o_bpv3_1_0_create_meeting_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ExperimentalApi->o_bpv3_1_0_get_meeting: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ExperimentalApi->o_bpv3_1_0_get_meeting_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ExperimentalApi->o_bpv3_1_0_get_meetings: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ExperimentalApi->o_bpv3_1_0_get_meetings_with_http_info: #{e}"
end
```
