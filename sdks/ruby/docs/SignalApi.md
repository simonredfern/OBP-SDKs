...
api_instance = OpenBankProject::SignalApi.new
...
begin
  ...
  puts "Error when calling SignalApi->o_bpv6_0_0_delete_signal_channel: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SignalApi->o_bpv6_0_0_delete_signal_channel_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SignalApi->o_bpv6_0_0_get_signal_channel_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SignalApi->o_bpv6_0_0_get_signal_channel_info_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SignalApi->o_bpv6_0_0_get_signal_channels: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SignalApi->o_bpv6_0_0_get_signal_channels_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SignalApi->o_bpv6_0_0_get_signal_messages: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SignalApi->o_bpv6_0_0_get_signal_messages_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SignalApi->o_bpv6_0_0_get_signal_stats: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SignalApi->o_bpv6_0_0_get_signal_stats_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SignalApi->o_bpv6_0_0_publish_signal_message: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SignalApi->o_bpv6_0_0_publish_signal_message_with_http_info: #{e}"
end
```
