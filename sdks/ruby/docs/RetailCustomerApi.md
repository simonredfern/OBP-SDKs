...
api_instance = OpenBankProject::RetailCustomerApi.new
...
begin
  ...
  puts "Error when calling RetailCustomerApi->o_bpv6_0_0_create_retail_customer: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RetailCustomerApi->o_bpv6_0_0_create_retail_customer_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RetailCustomerApi->o_bpv6_0_0_get_retail_customer_by_customer_id: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RetailCustomerApi->o_bpv6_0_0_get_retail_customer_by_customer_id_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RetailCustomerApi->o_bpv6_0_0_get_retail_customers_at_one_bank: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RetailCustomerApi->o_bpv6_0_0_get_retail_customers_at_one_bank_with_http_info: #{e}"
end
```
