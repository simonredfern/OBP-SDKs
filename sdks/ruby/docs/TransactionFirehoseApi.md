...
api_instance = OpenBankProject::TransactionFirehoseApi.new
...
begin
  ...
  puts "Error when calling TransactionFirehoseApi->o_bpv3_0_0_get_firehose_transactions_for_bank_account: #{e}"
end
```
...
begin
  ...
  puts "Error when calling TransactionFirehoseApi->o_bpv3_0_0_get_firehose_transactions_for_bank_account_with_http_info: #{e}"
end
```
