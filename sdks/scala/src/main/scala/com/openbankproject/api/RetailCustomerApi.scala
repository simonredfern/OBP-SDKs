...
object RetailCustomerApi {
  def apply(baseUrl: String = "https://apisandbox.openbankproject.com") = new RetailCustomerApi(baseUrl)
}

class RetailCustomerApi(baseUrl: String) {
