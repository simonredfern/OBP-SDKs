...
object CounterpartyMetadataApi {
  def apply(baseUrl: String = "https://apisandbox.openbankproject.com") = new CounterpartyMetadataApi(baseUrl)
}

class CounterpartyMetadataApi(baseUrl: String) {
