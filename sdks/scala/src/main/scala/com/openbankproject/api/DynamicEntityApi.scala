...
object DynamicEntityApi {
  def apply(baseUrl: String = "https://apisandbox.openbankproject.com") = new DynamicEntityApi(baseUrl)
}

class DynamicEntityApi(baseUrl: String) {
