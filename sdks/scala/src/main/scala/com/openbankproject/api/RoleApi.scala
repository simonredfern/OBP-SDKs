...
object RoleApi {
  def apply(baseUrl: String = "https://apisandbox.openbankproject.com") = new RoleApi(baseUrl)
}
...
class RoleApi(baseUrl: String) {
   ...
   * 
   * Expected answers:
   *   code 200 : OBPv210GetRoles200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def oBPv210GetRoles(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], OBPv210GetRoles200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v2.1.0/roles")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .response(asJson[OBPv210GetRoles200Response])
