...
object TransactionFirehoseApi {
  def apply(baseUrl: String = "https://apisandbox.openbankproject.com") = new TransactionFirehoseApi(baseUrl)
}

class TransactionFirehoseApi(baseUrl: String) {
