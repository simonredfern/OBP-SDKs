...
object JSONSchemaValidationApi {
  def apply(baseUrl: String = "https://apisandbox.openbankproject.com") = new JSONSchemaValidationApi(baseUrl)
}

class JSONSchemaValidationApi(baseUrl: String) {
   ...
   * 
   * Expected answers:
   *   code 200 : OBPv400GetAllJsonSchemaValidationsPublic200ResponsePropertiesJsonSchemaValidationsItems (Successful operation)
   ...
   */
  def oBPv400CreateJsonSchemaValidation(apiKeyHeader: String, apiKeyHeader: String)(operationid: String, oBPv400GetAllJsonSchemaValidationsPublic200ResponsePropertiesJsonSchemaValidationsItemsPropertiesJsonSchema: OBPv400GetAllJsonSchemaValidationsPublic200ResponsePropertiesJsonSchemaValidationsItemsPropertiesJsonSchema): Request[Either[ResponseException[String, Exception], OBPv400GetAllJsonSchemaValidationsPublic200ResponsePropertiesJsonSchemaValidationsItems]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v4.0.0/management/json-schema-validations/${operationid}")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .body(oBPv400GetAllJsonSchemaValidationsPublic200ResponsePropertiesJsonSchemaValidationsItemsPropertiesJsonSchema)
      .response(asJson[OBPv400GetAllJsonSchemaValidationsPublic200ResponsePropertiesJsonSchemaValidationsItems])
   ...
   * @param operationid The OPERATIONID identifier
   */
  def oBPv400DeleteJsonSchemaValidation(apiKeyHeader: String, apiKeyHeader: String)(operationid: String): Request[Either[ResponseException[String, Exception], Unit]] =
    basicRequest
      .method(Method.DELETE, uri"$baseUrl/obp/v4.0.0/management/json-schema-validations/${operationid}")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
   ...
   * 
   * Expected answers:
   *   code 200 : OBPv400GetAllJsonSchemaValidationsPublic200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def oBPv400GetAllJsonSchemaValidations(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], OBPv400GetAllJsonSchemaValidationsPublic200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v4.0.0/management/json-schema-validations")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .response(asJson[OBPv400GetAllJsonSchemaValidationsPublic200Response])
   ...
   *   code 500 :  (Internal Server Error)
   */
  def oBPv400GetAllJsonSchemaValidationsPublic(): Request[Either[ResponseException[String, Exception], OBPv400GetAllJsonSchemaValidationsPublic200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v4.0.0/endpoints/json-schema-validations")
      .contentType("application/json")
      .response(asJson[OBPv400GetAllJsonSchemaValidationsPublic200Response])
   ...
   * @param operationid The OPERATIONID identifier
   */
  def oBPv400GetJsonSchemaValidation(apiKeyHeader: String, apiKeyHeader: String)(operationid: String): Request[Either[ResponseException[String, Exception], OBPv400GetAllJsonSchemaValidationsPublic200ResponsePropertiesJsonSchemaValidationsItems]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v4.0.0/management/json-schema-validations/${operationid}")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .response(asJson[OBPv400GetAllJsonSchemaValidationsPublic200ResponsePropertiesJsonSchemaValidationsItems])
   ...
   * @param oBPv400GetAllJsonSchemaValidationsPublic200ResponsePropertiesJsonSchemaValidationsItemsPropertiesJsonSchema Request body
   */
  def oBPv400UpdateJsonSchemaValidation(apiKeyHeader: String, apiKeyHeader: String)(operationid: String, oBPv400GetAllJsonSchemaValidationsPublic200ResponsePropertiesJsonSchemaValidationsItemsPropertiesJsonSchema: OBPv400GetAllJsonSchemaValidationsPublic200ResponsePropertiesJsonSchemaValidationsItemsPropertiesJsonSchema): Request[Either[ResponseException[String, Exception], OBPv400GetAllJsonSchemaValidationsPublic200ResponsePropertiesJsonSchemaValidationsItems]] =
    basicRequest
      .method(Method.PUT, uri"$baseUrl/obp/v4.0.0/management/json-schema-validations/${operationid}")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .body(oBPv400GetAllJsonSchemaValidationsPublic200ResponsePropertiesJsonSchemaValidationsItemsPropertiesJsonSchema)
