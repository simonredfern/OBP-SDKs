...
object SandboxApi {
  def apply(baseUrl: String = "https://apisandbox.openbankproject.com") = new SandboxApi(baseUrl)
}

class SandboxApi(baseUrl: String) {
   ...
   *   DirectLogin (apiKey)
   * 
   * @param oBPv210SandboxDataImportRequest Request body
   */
  def oBPv210SandboxDataImport(apiKeyHeader: String, apiKeyHeader: String)(oBPv210SandboxDataImportRequest: OBPv210SandboxDataImportRequest): Request[Either[ResponseException[String, Exception], OBPv121UpdateTransactionNarrative200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v2.1.0/sandbox/data-import")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .body(oBPv210SandboxDataImportRequest)
