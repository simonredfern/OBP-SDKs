...
import com.openbankproject.model.OBPv310RefreshUser200Response
...
import com.openbankproject.model.OBPv400GetExplicitCounterpartyById200ResponsePropertiesBespokeItems
import com.openbankproject.model.OBPv400GetLogoutLink200Response
import com.openbankproject.model.OBPv400GetMySpaces200Response
import com.openbankproject.model.OBPv400GetUserCustomerLinksByCustomerId200ResponsePropertiesUserCustomerLinksItems
import com.openbankproject.model.OBPv400GetUsersByEmail200Response
import com.openbankproject.model.OBPv500AnswerUserAuthContextUpdateChallenge200Response
import com.openbankproject.model.OBPv500GetMyCustomersAtBank200ResponsePropertiesCustomersItems
import com.openbankproject.model.OBPv500GetUserAuthContexts200Response
...
import com.openbankproject.model.OBPv510GetUserByProviderAndUsername200Response
import com.openbankproject.model.OBPv510GetUserByProviderAndUsername200ResponsePropertiesEntitlements
import com.openbankproject.model.OBPv510GetUserLockStatus200Response
import com.openbankproject.model.OBPv510LockUserByProviderAndUsername200Response
...
import com.openbankproject.model.OBPv600GetProviders200Response
import com.openbankproject.model.OBPv600GetUserGroupMemberships200Response
import com.openbankproject.model.OBPv600GetUsers200Response
import com.openbankproject.model.OBPv600GetUsers200ResponsePropertiesUsersItems
import com.openbankproject.model.OBPv600ResetPasswordComplete200Response
import com.openbankproject.model.OBPv600ResetPasswordCompleteRequest
import com.openbankproject.model.OBPv600ResetPasswordUrl200Response
import com.openbankproject.model.OBPv600ResetPasswordUrlAnonymousRequest
import com.openbankproject.model.OBPv600ResetPasswordUrlRequest
import com.openbankproject.model.OBPv600ValidateUserEmail200Response
import com.openbankproject.model.OBPv600ValidateUserEmailRequest
import com.openbankproject.model.OBPv600VerifyUserCredentials200Response
import com.openbankproject.model.OBPv600VerifyUserCredentialsRequest
import org.openapitools.client.core.JsonSupport._
import sttp.client4._
import sttp.model.Method

object UserApi {
  def apply(baseUrl: String = "https://apisandbox.openbankproject.com") = new UserApi(baseUrl)
}
...
class UserApi(baseUrl: String) {
   ...
   */
  def oBPv310DeleteUserAuthContextById(apiKeyHeader: String, apiKeyHeader: String)(userid: String, userauthcontextid: String): Request[Either[ResponseException[String, Exception], Unit]] =
    basicRequest
      .method(Method.DELETE, uri"$baseUrl/obp/v3.1.0/users/${userid}/auth-context/${userauthcontextid}")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .response(asString.mapWithMetadata(ResponseAs.deserializeRightWithError(_ => Right(()))))
   ...
   * @param userid The USERID identifier
   */
  def oBPv310DeleteUserAuthContexts(apiKeyHeader: String, apiKeyHeader: String)(userid: String): Request[Either[ResponseException[String, Exception], Unit]] =
    basicRequest
      .method(Method.DELETE, uri"$baseUrl/obp/v3.1.0/users/${userid}/auth-context")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .response(asString.mapWithMetadata(ResponseAs.deserializeRightWithError(_ => Right(()))))
   ...
   * 
   * Expected answers:
   *   code 200 : OBPv310RefreshUser200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   ...
   * @param userid The USERID identifier
   */
  def oBPv310RefreshUser(apiKeyHeader: String, apiKeyHeader: String)(userid: String): Request[Either[ResponseException[String, Exception], OBPv310RefreshUser200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v3.1.0/users/${userid}/refresh")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .response(asJson[OBPv310RefreshUser200Response])
   ...
   * @param userid The USERID identifier
   */
  def oBPv400DeleteUser(apiKeyHeader: String, apiKeyHeader: String)(userid: String): Request[Either[ResponseException[String, Exception], Unit]] =
    basicRequest
      .method(Method.DELETE, uri"$baseUrl/obp/v4.0.0/users/${userid}")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .response(asString.mapWithMetadata(ResponseAs.deserializeRightWithError(_ => Right(()))))
   ...
   * 
   * Expected answers:
   *   code 200 : OBPv400AddConsentUserRequest (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def oBPv400GetCurrentUserId(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], OBPv400AddConsentUserRequest]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v4.0.0/users/current/user_id")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .response(asJson[OBPv400AddConsentUserRequest])
   ...
   * 
   * Expected answers:
   *   code 200 : OBPv400GetLogoutLink200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def oBPv400GetLogoutLink(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], OBPv400GetLogoutLink200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v4.0.0/users/current/logout-link")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .response(asJson[OBPv400GetLogoutLink200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : OBPv400GetMySpaces200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def oBPv400GetMySpaces(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], OBPv400GetMySpaces200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v4.0.0/my/spaces")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .response(asJson[OBPv400GetMySpaces200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : OBPv510GetUserByProviderAndUsername200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   * @param userid The USERID identifier
   */
  def oBPv400GetUserByUserId(apiKeyHeader: String, apiKeyHeader: String)(userid: String): Request[Either[ResponseException[String, Exception], OBPv510GetUserByProviderAndUsername200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v4.0.0/users/user_id/${userid}")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .response(asJson[OBPv510GetUserByProviderAndUsername200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : OBPv400GetUsersByEmail200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   */
  def oBPv400GetUsersByEmail(apiKeyHeader: String, apiKeyHeader: String)(email: String): Request[Either[ResponseException[String, Exception], OBPv400GetUsersByEmail200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v4.0.0/users/email/${email}/terminator")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .response(asJson[OBPv400GetUsersByEmail200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : OBPv500AnswerUserAuthContextUpdateChallenge200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   */
  def oBPv500AnswerUserAuthContextUpdateChallenge(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, authcontextupdateid: String, oBPv310AnswerConsentChallengeRequest: OBPv310AnswerConsentChallengeRequest): Request[Either[ResponseException[String, Exception], OBPv500AnswerUserAuthContextUpdateChallenge200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v5.0.0/banks/${bankid}/users/current/auth-context-updates/${authcontextupdateid}/challenge")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .body(oBPv310AnswerConsentChallengeRequest)
      .response(asJson[OBPv500AnswerUserAuthContextUpdateChallenge200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : OBPv500GetUserAuthContexts200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   ...
   */
  def oBPv500CreateUserAuthContext(apiKeyHeader: String, apiKeyHeader: String)(userid: String, oBPv400GetExplicitCounterpartyById200ResponsePropertiesBespokeItems: OBPv400GetExplicitCounterpartyById200ResponsePropertiesBespokeItems): Request[Either[ResponseException[String, Exception], OBPv500GetUserAuthContexts200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v5.0.0/users/${userid}/auth-context")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .body(oBPv400GetExplicitCounterpartyById200ResponsePropertiesBespokeItems)
      .response(asJson[OBPv500GetUserAuthContexts200Response])
   ...
   * @param oBPv400GetExplicitCounterpartyById200ResponsePropertiesBespokeItems Request body
   */
  def oBPv500CreateUserAuthContextUpdateRequest(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, scamethod: String, oBPv400GetExplicitCounterpartyById200ResponsePropertiesBespokeItems: OBPv400GetExplicitCounterpartyById200ResponsePropertiesBespokeItems): Request[Either[ResponseException[String, Exception], OBPv500AnswerUserAuthContextUpdateChallenge200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v5.0.0/banks/${bankid}/users/current/auth-context-updates/${scamethod}")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .body(oBPv400GetExplicitCounterpartyById200ResponsePropertiesBespokeItems)
   ...
   * @param userid The USERID identifier
   */
  def oBPv500GetUserAuthContexts(apiKeyHeader: String, apiKeyHeader: String)(userid: String): Request[Either[ResponseException[String, Exception], OBPv500GetUserAuthContexts200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v5.0.0/users/${userid}/auth-context")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .response(asJson[OBPv500GetUserAuthContexts200Response])
   ...
   */
  def oBPv510GetUserByProviderAndUsername(apiKeyHeader: String, apiKeyHeader: String)(provider: String, username: String): Request[Either[ResponseException[String, Exception], OBPv510GetUserByProviderAndUsername200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v5.1.0/users/provider/${provider}/username/${username}")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .response(asJson[OBPv510GetUserByProviderAndUsername200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : OBPv510GetUserLockStatus200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   * @param username The USERNAME identifier
   */
  def oBPv510GetUserLockStatus(apiKeyHeader: String, apiKeyHeader: String)(provider: String, username: String): Request[Either[ResponseException[String, Exception], OBPv510GetUserLockStatus200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v5.1.0/users/${provider}/${username}/lock-status")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .response(asJson[OBPv510GetUserLockStatus200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : OBPv510LockUserByProviderAndUsername200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   * @param username The USERNAME identifier
   */
  def oBPv510LockUserByProviderAndUsername(apiKeyHeader: String, apiKeyHeader: String)(provider: String, username: String): Request[Either[ResponseException[String, Exception], OBPv510LockUserByProviderAndUsername200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v5.1.0/users/${provider}/${username}/locks")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .response(asJson[OBPv510LockUserByProviderAndUsername200Response])
   ...
   * @param providerid The PROVIDERID identifier
   */
  def oBPv510SyncExternalUser(apiKeyHeader: String, apiKeyHeader: String)(provider: String, providerid: String): Request[Either[ResponseException[String, Exception], OBPv310RefreshUser200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v5.1.0/users/${provider}/${providerid}/sync")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .response(asJson[OBPv310RefreshUser200Response])
   ...
   * @param username The USERNAME identifier
   */
  def oBPv510UnlockUserByProviderAndUsername(apiKeyHeader: String, apiKeyHeader: String)(provider: String, username: String): Request[Either[ResponseException[String, Exception], OBPv510GetUserLockStatus200Response]] =
    basicRequest
      .method(Method.PUT, uri"$baseUrl/obp/v5.1.0/users/${provider}/${username}/lock-status")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .response(asJson[OBPv510GetUserLockStatus200Response])
   ...
   * @param userid The USERID identifier
   */
  def oBPv510ValidateUserByUserId(apiKeyHeader: String, apiKeyHeader: String)(userid: String): Request[Either[ResponseException[String, Exception], OBPv510LockUserByProviderAndUsername200Response]] =
    basicRequest
      .method(Method.PUT, uri"$baseUrl/obp/v5.1.0/management/users/${userid}")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .response(asJson[OBPv510LockUserByProviderAndUsername200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : OBPv600VerifyUserCredentials200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * @param oBPv600CreateUserRequest Request body
   */
  def oBPv600CreateUser(oBPv600CreateUserRequest: OBPv600CreateUserRequest): Request[Either[ResponseException[String, Exception], OBPv600VerifyUserCredentials200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v6.0.0/users")
      .contentType("application/json")
      .body(oBPv600CreateUserRequest)
      .response(asJson[OBPv600VerifyUserCredentials200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : OBPv600ValidateUserEmailRequest (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def oBPv600DirectLoginEndpoint(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], OBPv600ValidateUserEmailRequest]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v6.0.0/my/logins/direct")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .response(asJson[OBPv600ValidateUserEmailRequest])
   ...
   *   DirectLogin (apiKey)
   */
  def oBPv600GetCurrentUser(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], OBPv510GetEntitlementsAndPermissions200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/users/current")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .response(asJson[OBPv510GetEntitlementsAndPermissions200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : OBPv600GetProviders200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def oBPv600GetProviders(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], OBPv600GetProviders200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/providers")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .response(asJson[OBPv600GetProviders200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : OBPv600GetUsers200ResponsePropertiesUsersItems (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   * @param userid The USERID identifier
   */
  def oBPv600GetUserByUserId(apiKeyHeader: String, apiKeyHeader: String)(userid: String): Request[Either[ResponseException[String, Exception], OBPv600GetUsers200ResponsePropertiesUsersItems]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/users/user-id/${userid}")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .response(asJson[OBPv600GetUsers200ResponsePropertiesUsersItems])
   ...
   * 
   * Expected answers:
   *   code 200 : OBPv600GetUsers200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def oBPv600GetUsers(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], OBPv600GetUsers200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/users")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .response(asJson[OBPv600GetUsers200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : OBPv600ResetPasswordComplete200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   ...
   */
  def oBPv600ResetPasswordComplete(apiKeyHeader: String, apiKeyHeader: String)(oBPv600ResetPasswordCompleteRequest: OBPv600ResetPasswordCompleteRequest): Request[Either[ResponseException[String, Exception], OBPv600ResetPasswordComplete200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v6.0.0/users/password")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .body(oBPv600ResetPasswordCompleteRequest)
      .response(asJson[OBPv600ResetPasswordComplete200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : OBPv600ResetPasswordUrl200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   ...
   */
  def oBPv600ResetPasswordUrl(apiKeyHeader: String, apiKeyHeader: String)(oBPv600ResetPasswordUrlRequest: OBPv600ResetPasswordUrlRequest): Request[Either[ResponseException[String, Exception], OBPv600ResetPasswordUrl200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v6.0.0/management/user/reset-password-url")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .body(oBPv600ResetPasswordUrlRequest)
      .response(asJson[OBPv600ResetPasswordUrl200Response])
   ...
   */
  def oBPv600ResetPasswordUrlAnonymous(apiKeyHeader: String, apiKeyHeader: String)(oBPv600ResetPasswordUrlAnonymousRequest: OBPv600ResetPasswordUrlAnonymousRequest): Request[Either[ResponseException[String, Exception], OBPv600ResetPasswordComplete200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v6.0.0/users/password-reset-url")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .body(oBPv600ResetPasswordUrlAnonymousRequest)
      .response(asJson[OBPv600ResetPasswordComplete200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : OBPv600ValidateUserEmail200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   */
  def oBPv600ValidateUserEmail(apiKeyHeader: String, apiKeyHeader: String)(oBPv600ValidateUserEmailRequest: OBPv600ValidateUserEmailRequest): Request[Either[ResponseException[String, Exception], OBPv600ValidateUserEmail200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v6.0.0/users/email-validation")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .body(oBPv600ValidateUserEmailRequest)
      .response(asJson[OBPv600ValidateUserEmail200Response])
   ...
   */
  def oBPv600VerifyUserCredentials(apiKeyHeader: String, apiKeyHeader: String)(oBPv600VerifyUserCredentialsRequest: OBPv600VerifyUserCredentialsRequest): Request[Either[ResponseException[String, Exception], OBPv600VerifyUserCredentials200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v6.0.0/users/verify-credentials")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .body(oBPv600VerifyUserCredentialsRequest)
      .response(asJson[OBPv600VerifyUserCredentials200Response])
