...
object AggregateMetricsApi {
  def apply(baseUrl: String = "https://apisandbox.openbankproject.com") = new AggregateMetricsApi(baseUrl)
}

class AggregateMetricsApi(baseUrl: String) {
