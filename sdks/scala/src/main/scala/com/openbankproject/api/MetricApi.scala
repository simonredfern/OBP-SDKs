...
object MetricApi {
  def apply(baseUrl: String = "https://apisandbox.openbankproject.com") = new MetricApi(baseUrl)
}

class MetricApi(baseUrl: String) {
   ...
   * 
   * Expected answers:
   *   code 200 : OBPv310GetMetricsTopConsumers200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def oBPv310GetMetricsTopConsumers(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], OBPv310GetMetricsTopConsumers200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v3.1.0/management/metrics/top-consumers")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .response(asJson[OBPv310GetMetricsTopConsumers200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : OBPv600GetAggregateMetrics200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def oBPv600GetAggregateMetrics(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], OBPv600GetAggregateMetrics200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/management/aggregate-metrics")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("Authorization", apiKeyHeader)
      .response(asJson[OBPv600GetAggregateMetrics200Response])
