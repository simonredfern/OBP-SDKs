...
open class DocumentationAPI {
    ...
    /**
     ...
     - parameter apiConfiguration: The configuration for the http request.
     - returns: OBPv300GetApiGlossary200Response
     */
    open class func oBPv300GetApiGlossary(apiConfiguration: OBPSwiftAPIConfiguration = OBPSwiftAPIConfiguration.shared) async throws(ErrorResponse) -> OBPv300GetApiGlossary200Response {
        return try await oBPv300GetApiGlossaryWithRequestBuilder(apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - parameter apiConfiguration: The configuration for the http request.
     - returns: RequestBuilder<OBPv300GetApiGlossary200Response> 
     */
    open class func oBPv300GetApiGlossaryWithRequestBuilder(apiConfiguration: OBPSwiftAPIConfiguration = OBPSwiftAPIConfiguration.shared) -> RequestBuilder<OBPv300GetApiGlossary200Response> {
        let localVariablePath = "/obp/v3.0.0/api/glossary"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters: [String: any Sendable]? = nil
        ...
        let localVariableRequestBuilder: RequestBuilder<OBPv300GetApiGlossary200Response>.Type = apiConfiguration.requestBuilderFactory.getBuilder()
