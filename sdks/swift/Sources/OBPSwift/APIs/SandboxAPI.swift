...
open class SandboxAPI {
    ...
    /**
     ...
     - parameter oBPv210SandboxDataImportRequest: (body) Request body 
     - parameter apiConfiguration: The configuration for the http request.
     - returns: OBPv121UpdateTransactionNarrative200Response
     */
    open class func oBPv210SandboxDataImport(oBPv210SandboxDataImportRequest: OBPv210SandboxDataImportRequest, apiConfiguration: OBPSwiftAPIConfiguration = OBPSwiftAPIConfiguration.shared) async throws(ErrorResponse) -> OBPv121UpdateTransactionNarrative200Response {
        return try await oBPv210SandboxDataImportWithRequestBuilder(oBPv210SandboxDataImportRequest: oBPv210SandboxDataImportRequest, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func oBPv210SandboxDataImportWithRequestBuilder(oBPv210SandboxDataImportRequest: OBPv210SandboxDataImportRequest, apiConfiguration: OBPSwiftAPIConfiguration = OBPSwiftAPIConfiguration.shared) -> RequestBuilder<OBPv121UpdateTransactionNarrative200Response> {
        let localVariablePath = "/obp/v2.1.0/sandbox/data-import"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: oBPv210SandboxDataImportRequest, codableHelper: apiConfiguration.codableHelper)
