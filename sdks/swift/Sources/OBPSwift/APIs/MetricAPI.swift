...
open class MetricAPI {
    ...
    /**
     ...
     - parameter apiConfiguration: The configuration for the http request.
     - returns: OBPv310GetMetricsTopConsumers200Response
     */
    open class func oBPv310GetMetricsTopConsumers(apiConfiguration: OBPSwiftAPIConfiguration = OBPSwiftAPIConfiguration.shared) async throws(ErrorResponse) -> OBPv310GetMetricsTopConsumers200Response {
        return try await oBPv310GetMetricsTopConsumersWithRequestBuilder(apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - API Key:
       ...
       - name: DirectLogin
     - parameter apiConfiguration: The configuration for the http request.
     - returns: RequestBuilder<OBPv310GetMetricsTopConsumers200Response> 
     */
    open class func oBPv310GetMetricsTopConsumersWithRequestBuilder(apiConfiguration: OBPSwiftAPIConfiguration = OBPSwiftAPIConfiguration.shared) -> RequestBuilder<OBPv310GetMetricsTopConsumers200Response> {
        let localVariablePath = "/obp/v3.1.0/management/metrics/top-consumers"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters: [String: any Sendable]? = nil
        ...
        let localVariableRequestBuilder: RequestBuilder<OBPv310GetMetricsTopConsumers200Response>.Type = apiConfiguration.requestBuilderFactory.getBuilder()
