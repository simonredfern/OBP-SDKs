...
open class OBPSwiftAPIConfiguration: @unchecked Sendable {
    ...
    public static let shared = OBPSwiftAPIConfiguration()
}
...
open class RequestBuilder<T: Sendable>: @unchecked Sendable, Identifiable {
    ...
    public let apiConfiguration: OBPSwiftAPIConfiguration

    /// Optional block to obtain a reference to the request's progress instance when available.
    public var onProgressReady: ((Progress) -> Void)?

    required public init(method: String, URLString: String, parameters: [String: any Sendable]?, headers: [String: String] = [:], requiresAuthentication: Bool, apiConfiguration: OBPSwiftAPIConfiguration = OBPSwiftAPIConfiguration.shared) {
        self.method = method
