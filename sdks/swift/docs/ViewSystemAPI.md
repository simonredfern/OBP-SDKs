...
```swift
    open class func oBPv500CreateSystemView(oBPv500CreateSystemViewRequest: OBPv500CreateSystemViewRequest, completion: @escaping (_ data: OBPv500GetViewsForBankAccount200ResponsePropertiesViewsItems?, _ error: Error?) -> Void)
```
...
let oBPv500CreateSystemViewRequest = OBPv5_0_0_createSystemView_request(type: "type_example", properties: OBPv5_0_0_createSystemView_request_properties(canGrantAccessToViews: OBPv6_0_0_getActiveRateLimitsAtDate_200_response_properties_considered_rate_limit_ids(type: "type_example", items: OBPv4_0_0_updateSystemLevelEndpointTag_request_properties_tag_name(type: "type_example")), name: nil, description: nil, isPublic: nil, hideMetadataIfAliasUsed: nil, canRevokeAccessToViews: nil, whichAliasToUse: nil, metadataView: nil, allowedActions: nil)) // OBPv500CreateSystemViewRequest | Request body

// Create System View
ViewSystemAPI.oBPv500CreateSystemView(oBPv500CreateSystemViewRequest: oBPv500CreateSystemViewRequest) { (response, error) in
...
```swift
    open class func oBPv500DeleteSystemView(viewid: String, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
// Delete System View
ViewSystemAPI.oBPv500DeleteSystemView(viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv500GetSystemView(viewid: String, completion: @escaping (_ data: OBPv500GetViewsForBankAccount200ResponsePropertiesViewsItems?, _ error: Error?) -> Void)
```
...
// Get System View
ViewSystemAPI.oBPv500GetSystemView(viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv500GetSystemViewsIds(completion: @escaping (_ data: OBPv500GetSystemViewsIds200Response?, _ error: Error?) -> Void)
```
...
// Get Ids of System Views
ViewSystemAPI.oBPv500GetSystemViewsIds() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv510AddSystemViewPermission(viewid: String, oBPv510AddSystemViewPermissionRequest: OBPv510AddSystemViewPermissionRequest, completion: @escaping (_ data: OBPv510AddSystemViewPermission200Response?, _ error: Error?) -> Void)
```
...
let viewid = "viewid_example" // String | The VIEWID identifier
let oBPv510AddSystemViewPermissionRequest = OBPv5_1_0_addSystemViewPermission_request(type: "type_example", properties: OBPv5_1_0_addSystemViewPermission_request_properties(extraData: OBPv6_0_0_getActiveRateLimitsAtDate_200_response_properties_considered_rate_limit_ids(type: "type_example", items: OBPv4_0_0_updateSystemLevelEndpointTag_request_properties_tag_name(type: "type_example")), permissionName: nil)) // OBPv510AddSystemViewPermissionRequest | Request body

// Add Permission to a System View
ViewSystemAPI.oBPv510AddSystemViewPermission(viewid: viewid, oBPv510AddSystemViewPermissionRequest: oBPv510AddSystemViewPermissionRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv510DeleteSystemViewPermission(viewid: String, permissionname: String, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
let viewid = "viewid_example" // String | The VIEWID identifier
let permissionname = "permissionname_example" // String | The PERMISSIONNAME identifier

// Delete Permission to a System View
ViewSystemAPI.oBPv510DeleteSystemViewPermission(viewid: viewid, permissionname: permissionname) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Custom Views
ViewSystemAPI.oBPv600GetCustomViews() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get System View
ViewSystemAPI.oBPv600GetSystemViewById(viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get System Views
ViewSystemAPI.oBPv600GetSystemViews() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get View Permissions
ViewSystemAPI.oBPv600GetViewPermissions() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Update System View
ViewSystemAPI.oBPv600UpdateSystemView(viewid: viewid, oBPv600UpdateSystemViewRequest: oBPv600UpdateSystemViewRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
