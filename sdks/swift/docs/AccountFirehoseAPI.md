...
// Get Firehose Transactions for Account
AccountFirehoseAPI.oBPv300GetFirehoseTransactionsForBankAccount(bankid: bankid, accountid: accountid, viewid: viewid) { (response, error) in
...
// Get Fast Firehose Accounts at Bank
AccountFirehoseAPI.oBPv400GetFastFirehoseAccountsAtOneBank(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Firehose Accounts at Bank
AccountFirehoseAPI.oBPv400GetFirehoseAccountsAtOneBank(bankid: bankid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
