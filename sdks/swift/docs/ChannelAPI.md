...
// Delete Signal Channel
ChannelAPI.oBPv600DeleteSignalChannel(channelname: channelname) { (response, error) in
...
// Get Signal Channel Info
ChannelAPI.oBPv600GetSignalChannelInfo(channelname: channelname) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// List Signal Channels
ChannelAPI.oBPv600GetSignalChannels() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Signal Messages
ChannelAPI.oBPv600GetSignalMessages(channelname: channelname) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Signal Channel Stats
ChannelAPI.oBPv600GetSignalStats() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Publish Signal Message
ChannelAPI.oBPv600PublishSignalMessage(channelname: channelname, oBPv600PublishSignalMessageRequest: oBPv600PublishSignalMessageRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
