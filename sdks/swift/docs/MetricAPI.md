...
// Search API Metrics via Elasticsearch
MetricAPI.oBPv200ElasticSearchMetrics() { (response, error) in
...
// Get Connector Metrics
MetricAPI.oBPv220GetConnectorMetrics() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv310GetMetricsTopConsumers(completion: @escaping (_ data: OBPv310GetMetricsTopConsumers200Response?, _ error: Error?) -> Void)
```
...
// Get Top Consumers
MetricAPI.oBPv310GetMetricsTopConsumers() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Metrics at Bank
MetricAPI.oBPv500GetMetricsAtBank(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Aggregate Metrics
MetricAPI.oBPv600GetAggregateMetrics() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Connector Call Counts
MetricAPI.oBPv600GetConnectorCallCounts() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Connector Traces
MetricAPI.oBPv600GetConnectorTraces() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Metrics
MetricAPI.oBPv600GetMetrics() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Popular Endpoints
MetricAPI.oBPv600GetPopularApis() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Top APIs
MetricAPI.oBPv600GetTopAPIs() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
