...
// Delete Custom View
AccountAPI.oBPv121DeleteViewForBankAccount(bankid: bankid, accountid: accountid, viewid: viewid) { (response, error) in
...
// Get access
AccountAPI.oBPv200GetPermissionsForBankAccount(bankid: bankid, accountid: accountid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Public Accounts at all Banks
AccountAPI.oBPv200PublicAccountsAllBanks() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Public Accounts at Bank
AccountAPI.oBPv200PublicAccountsAtOneBank(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Accounts at all Banks (private)
AccountAPI.oBPv300CorePrivateAccountsAllBanks() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Custom View
AccountAPI.oBPv300CreateViewForBankAccount(bankid: bankid, accountid: accountid, oBPv600CreateCustomViewManagementRequest: oBPv600CreateCustomViewManagementRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Accounts Held
AccountAPI.oBPv300GetAccountsHeld(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Transactions for Account (Core)
AccountAPI.oBPv300GetCoreTransactionsForBankAccount(bankid: bankid, accountid: accountid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv300GetOtherAccountByIdForBankAccount(bankid: String, accountid: String, viewid: String, otheraccountid: String, completion: @escaping (_ data: OBPv310GetTransactionByIdForBankAccount200ResponsePropertiesOtherAccount?, _ error: Error?) -> Void)
```
...
// Get Other Account by Id
AccountAPI.oBPv300GetOtherAccountByIdForBankAccount(bankid: bankid, accountid: accountid, viewid: viewid, otheraccountid: otheraccountid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv300GetOtherAccountsForBankAccount(bankid: String, accountid: String, viewid: String, completion: @escaping (_ data: OBPv300GetOtherAccountsForBankAccount200Response?, _ error: Error?) -> Void)
```
...
// Get Other Accounts of one Account
AccountAPI.oBPv300GetOtherAccountsForBankAccount(bankid: bankid, accountid: accountid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Account access for User
AccountAPI.oBPv300GetPermissionForUserForBankAccount(bankid: bankid, accountid: accountid, provider: provider, providerid: providerid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Accounts at Bank (IDs only)
AccountAPI.oBPv300GetPrivateAccountIdsbyBankId(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Public Account by Id
AccountAPI.oBPv300GetPublicAccountById(bankid: bankid, accountid: accountid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Accounts at Bank (Minimal)
AccountAPI.oBPv300PrivateAccountsAtOneBank(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Update Custom View
AccountAPI.oBPv300UpdateViewForBankAccount(bankid: bankid, accountid: accountid, viewid: viewid, oBPv300UpdateViewForBankAccountRequest: oBPv300UpdateViewForBankAccountRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Check Available Funds
AccountAPI.oBPv310CheckFundsAvailable(bankid: bankid, accountid: accountid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Account Application
AccountAPI.oBPv310CreateAccountApplication(bankid: bankid, oBPv310CreateAccountApplicationRequest: oBPv310CreateAccountApplicationRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Account Attribute
AccountAPI.oBPv310CreateAccountAttribute(bankid: bankid, accountid: accountid, productcode: productcode, oBPv310UpdateAccountAttributeRequest: oBPv310UpdateAccountAttributeRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Account Application by Id
AccountAPI.oBPv310GetAccountApplication(bankid: bankid, accountapplicationid: accountapplicationid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Account Applications
AccountAPI.oBPv310GetAccountApplications(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv310GetCheckbookOrders(bankid: String, accountid: String, viewid: String, completion: @escaping (_ data: OBPv310GetCheckbookOrders200Response?, _ error: Error?) -> Void)
```
...
// Get Checkbook orders
AccountAPI.oBPv310GetCheckbookOrders(bankid: bankid, accountid: accountid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv310UpdateAccount(bankid: String, accountid: String, oBPv310UpdateAccountRequest: OBPv310UpdateAccountRequest, completion: @escaping (_ data: OBPv310UpdateAccount200Response?, _ error: Error?) -> Void)
```
...
let bankid = "bankid_example" // String | The BANKID identifier
let accountid = "accountid_example" // String | The ACCOUNTID identifier
let oBPv310UpdateAccountRequest = OBPv3_1_0_updateAccount_request(type: "type_example", properties: OBPv3_1_0_updateAccount_request_properties(accountRoutings: OBPv3_1_0_getCheckbookOrders_200_response_properties_account_properties_account_routings(type: "type_example", items: OBPv3_1_0_getCheckbookOrders_200_response_properties_account_properties_account_routings_items(type: "type_example", properties: OBPv3_1_0_getCheckbookOrders_200_response_properties_account_properties_account_routings_items_properties(address: OBPv4_0_0_updateSystemLevelEndpointTag_request_properties_tag_name(type: "type_example"), scheme: nil))), branchId: nil, label: nil, type: nil)) // OBPv310UpdateAccountRequest | Request body

// Update Account
AccountAPI.oBPv310UpdateAccount(bankid: bankid, accountid: accountid, oBPv310UpdateAccountRequest: oBPv310UpdateAccountRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Update Account Application Status
AccountAPI.oBPv310UpdateAccountApplicationStatus(bankid: bankid, accountapplicationid: accountapplicationid, oBPv510UpdateTransactionRequestStatusRequest: oBPv510UpdateTransactionRequestStatusRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Update Account Attribute
AccountAPI.oBPv310UpdateAccountAttribute(bankid: bankid, accountid: accountid, productcode: productcode, accountattributeid: accountattributeid, oBPv310UpdateAccountAttributeRequest: oBPv310UpdateAccountAttributeRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **oBPv400AddAccount**
```swift
    open class func oBPv400AddAccount(bankid: String, oBPv400AddAccountRequest: OBPv400AddAccountRequest, completion: @escaping (_ data: OBPv400AddAccount200Response?, _ error: Error?) -> Void)
```
...
// Create Account (POST)
AccountAPI.oBPv400AddAccount(bankid: bankid, oBPv400AddAccountRequest: oBPv400AddAccountRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create a tag on account
AccountAPI.oBPv400AddTagForViewOnAccount(bankid: bankid, accountid: accountid, viewid: viewid, oBPv400DeleteSystemLevelEndpointTag200Response: oBPv400DeleteSystemLevelEndpointTag200Response) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv400CreateCounterparty(bankid: String, accountid: String, viewid: String, oBPv400CreateCounterpartyForAnyAccountRequest: OBPv400CreateCounterpartyForAnyAccountRequest, completion: @escaping (_ data: OBPv400GetExplicitCounterpartyById200Response?, _ error: Error?) -> Void)
```
...
let accountid = "accountid_example" // String | The ACCOUNTID identifier
let viewid = "viewid_example" // String | The VIEWID identifier
let oBPv400CreateCounterpartyForAnyAccountRequest = OBPv4_0_0_createCounterpartyForAnyAccount_request(type: "type_example", properties: OBPv4_0_0_createCounterpartyForAnyAccount_request_properties(otherAccountRoutingAddress: OBPv4_0_0_updateSystemLevelEndpointTag_request_properties_tag_name(type: "type_example"), otherAccountRoutingScheme: nil, name: nil, otherAccountSecondaryRoutingAddress: nil, isBeneficiary: nil, description: nil, otherBranchRoutingAddress: nil, bespoke: OBPv4_0_0_getExplicitCounterpartyById_200_response_properties_bespoke(type: "type_example", items: OBPv4_0_0_getExplicitCounterpartyById_200_response_properties_bespoke_items(type: "type_example", properties: OBPv4_0_0_getExplicitCounterpartyById_200_response_properties_bespoke_items_properties(value: nil, key: nil))), otherBankRoutingScheme: nil, otherBranchRoutingScheme: nil, currency: nil, otherBankRoutingAddress: nil, otherAccountSecondaryRoutingScheme: nil)) // OBPv400CreateCounterpartyForAnyAccountRequest | Request body

// Create Counterparty (Explicit)
AccountAPI.oBPv400CreateCounterparty(bankid: bankid, accountid: accountid, viewid: viewid, oBPv400CreateCounterpartyForAnyAccountRequest: oBPv400CreateCounterpartyForAnyAccountRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv400CreateCounterpartyForAnyAccount(bankid: String, accountid: String, viewid: String, oBPv400CreateCounterpartyForAnyAccountRequest: OBPv400CreateCounterpartyForAnyAccountRequest, completion: @escaping (_ data: OBPv400GetExplicitCounterpartyById200Response?, _ error: Error?) -> Void)
```
...
// Create Counterparty for any account (Explicit)
AccountAPI.oBPv400CreateCounterpartyForAnyAccount(bankid: bankid, accountid: accountid, viewid: viewid, oBPv400CreateCounterpartyForAnyAccountRequest: oBPv400CreateCounterpartyForAnyAccountRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Direct Debit
AccountAPI.oBPv400CreateDirectDebit(bankid: bankid, accountid: accountid, viewid: viewid, oBPv400CreateDirectDebitRequest: oBPv400CreateDirectDebitRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Direct Debit (management)
AccountAPI.oBPv400CreateDirectDebitManagement(bankid: bankid, accountid: accountid, oBPv400CreateDirectDebitRequest: oBPv400CreateDirectDebitRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create or Update Account Attribute Definition
AccountAPI.oBPv400CreateOrUpdateAccountAttributeDefinition(bankid: bankid, oBPv400CreateOrUpdateTransactionRequestAttributeDefinitionRequest: oBPv400CreateOrUpdateTransactionRequestAttributeDefinitionRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Standing Order
AccountAPI.oBPv400CreateStandingOrder(bankid: bankid, accountid: accountid, viewid: viewid, oBPv400CreateStandingOrderRequest: oBPv400CreateStandingOrderRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Standing Order (management)
AccountAPI.oBPv400CreateStandingOrderManagement(bankid: bankid, accountid: accountid, oBPv400CreateStandingOrderRequest: oBPv400CreateStandingOrderRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Delete Account Attribute Definition
AccountAPI.oBPv400DeleteAccountAttributeDefinition(bankid: bankid, attributedefinitionid: attributedefinitionid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv400DeleteAccountCascade(bankid: String, accountid: String, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
// Delete Account Cascade
AccountAPI.oBPv400DeleteAccountCascade(bankid: bankid, accountid: accountid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv400DeleteCounterpartyForAnyAccount(bankid: String, accountid: String, viewid: String, counterpartyid: String, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
// Delete Counterparty for any account (Explicit)
AccountAPI.oBPv400DeleteCounterpartyForAnyAccount(bankid: bankid, accountid: accountid, viewid: viewid, counterpartyid: counterpartyid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv400DeleteExplicitCounterparty(bankid: String, accountid: String, viewid: String, counterpartyid: String, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
// Delete Counterparty (Explicit)
AccountAPI.oBPv400DeleteExplicitCounterparty(bankid: bankid, accountid: accountid, viewid: viewid, counterpartyid: counterpartyid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Delete a tag on account
AccountAPI.oBPv400DeleteTagForViewOnAccount(bankid: bankid, accountid: accountid, viewid: viewid, tagid: tagid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Account Attribute Definition
AccountAPI.oBPv400GetAccountAttributeDefinition(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv400GetAccountByAccountRouting(oBPv400GetAccountsByAccountRoutingRegexRequest: OBPv400GetAccountsByAccountRoutingRegexRequest, completion: @escaping (_ data: OBPv400GetPrivateAccountByIdFull200Response?, _ error: Error?) -> Void)
```
...
let oBPv400GetAccountsByAccountRoutingRegexRequest = OBPv4_0_0_getAccountsByAccountRoutingRegex_request(type: "type_example", properties: OBPv4_0_0_getAccountsByAccountRoutingRegex_request_properties(bankId: OBPv4_0_0_updateSystemLevelEndpointTag_request_properties_tag_name(type: "type_example"), accountRouting: OBPv3_1_0_getCheckbookOrders_200_response_properties_account_properties_account_routings_items(type: "type_example", properties: OBPv3_1_0_getCheckbookOrders_200_response_properties_account_properties_account_routings_items_properties(address: nil, scheme: nil)))) // OBPv400GetAccountsByAccountRoutingRegexRequest | Request body

// Get Account by Account Routing
AccountAPI.oBPv400GetAccountByAccountRouting(oBPv400GetAccountsByAccountRoutingRegexRequest: oBPv400GetAccountsByAccountRoutingRegexRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv400GetAccountsByAccountRoutingRegex(oBPv400GetAccountsByAccountRoutingRegexRequest: OBPv400GetAccountsByAccountRoutingRegexRequest, completion: @escaping (_ data: OBPv400GetAccountsByAccountRoutingRegex200Response?, _ error: Error?) -> Void)
```
...
// Get Accounts by Account Routing Regex
AccountAPI.oBPv400GetAccountsByAccountRoutingRegex(oBPv400GetAccountsByAccountRoutingRegexRequest: oBPv400GetAccountsByAccountRoutingRegexRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv400GetAccountsMinimalByCustomerId(customerid: String, completion: @escaping (_ data: OBPv510GetApiTags200Response?, _ error: Error?) -> Void)
```
...
// Get Accounts Minimal for a Customer
AccountAPI.oBPv400GetAccountsMinimalByCustomerId(customerid: customerid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Counterparties for any account (Explicit)
AccountAPI.oBPv400GetCounterpartiesForAnyAccount(bankid: bankid, accountid: accountid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv400GetCounterpartyByIdForAnyAccount(bankid: String, accountid: String, viewid: String, counterpartyid: String, completion: @escaping (_ data: OBPv400GetExplicitCounterpartyById200Response?, _ error: Error?) -> Void)
```
...
// Get Counterparty by Id for any account (Explicit)
AccountAPI.oBPv400GetCounterpartyByIdForAnyAccount(bankid: bankid, accountid: accountid, viewid: viewid, counterpartyid: counterpartyid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv400GetCounterpartyByNameForAnyAccount(bankid: String, accountid: String, viewid: String, counterpartyname: String, completion: @escaping (_ data: OBPv400GetExplicitCounterpartyById200Response?, _ error: Error?) -> Void)
```
...
// Get Counterparty by name for any account (Explicit) 
AccountAPI.oBPv400GetCounterpartyByNameForAnyAccount(bankid: bankid, accountid: accountid, viewid: viewid, counterpartyname: counterpartyname) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Counterparties (Explicit)
AccountAPI.oBPv400GetExplicitCounterpartiesForAccount(bankid: bankid, accountid: accountid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Fast Firehose Accounts at Bank
AccountAPI.oBPv400GetFastFirehoseAccountsAtOneBank(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Firehose Accounts at Bank
AccountAPI.oBPv400GetFirehoseAccountsAtOneBank(bankid: bankid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv400GetPrivateAccountByIdFull(bankid: String, accountid: String, viewid: String, completion: @escaping (_ data: OBPv400GetPrivateAccountByIdFull200Response?, _ error: Error?) -> Void)
```
...
// Get Account by Id (Full)
AccountAPI.oBPv400GetPrivateAccountByIdFull(bankid: bankid, accountid: accountid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get tags on account
AccountAPI.oBPv400GetTagsForViewOnAccount(bankid: bankid, accountid: accountid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **oBPv400IbanChecker**
```swift
    open class func oBPv400IbanChecker(oBPv400IbanCheckerRequest: OBPv400IbanCheckerRequest, completion: @escaping (_ data: OBPv400IbanChecker200Response?, _ error: Error?) -> Void)
```
...
let oBPv400IbanCheckerRequest = OBPv4_0_0_ibanChecker_request(type: "type_example", properties: OBPv4_0_0_ibanChecker_request_properties(address: OBPv4_0_0_updateSystemLevelEndpointTag_request_properties_tag_name(type: "type_example"))) // OBPv400IbanCheckerRequest | Request body

// Validate and check IBAN
AccountAPI.oBPv400IbanChecker(oBPv400IbanCheckerRequest: oBPv400IbanCheckerRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv400UpdateAccountLabel(bankid: String, accountid: String, oBPv400UpdateAccountLabelRequest: OBPv400UpdateAccountLabelRequest, completion: @escaping (_ data: OBPv121UpdateTransactionNarrative200Response?, _ error: Error?) -> Void)
```
...
let bankid = "bankid_example" // String | The BANKID identifier
let accountid = "accountid_example" // String | The ACCOUNTID identifier
let oBPv400UpdateAccountLabelRequest = OBPv4_0_0_updateAccountLabel_request(type: "type_example", properties: OBPv4_0_0_updateAccountLabel_request_properties(label: OBPv4_0_0_updateSystemLevelEndpointTag_request_properties_tag_name(type: "type_example"))) // OBPv400UpdateAccountLabelRequest | Request body

// Update Account Label
AccountAPI.oBPv400UpdateAccountLabel(bankid: bankid, accountid: accountid, oBPv400UpdateAccountLabelRequest: oBPv400UpdateAccountLabelRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Account (PUT)
AccountAPI.oBPv500CreateAccount(bankid: bankid, accountid: accountid, oBPv400AddAccountRequest: oBPv400AddAccountRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Customer Account Link
AccountAPI.oBPv500CreateCustomerAccountLink(bankid: bankid, oBPv500CreateCustomerAccountLinkRequest: oBPv500CreateCustomerAccountLinkRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Views for Account
AccountAPI.oBPv500GetViewsForBankAccount(bankid: bankid, accountid: accountid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Bank Account Balance
AccountAPI.oBPv510CreateBankAccountBalance(bankid: bankid, accountid: accountid, oBPv510CreateBankAccountBalanceRequest: oBPv510CreateBankAccountBalanceRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Custom View
AccountAPI.oBPv510CreateCustomView(bankid: bankid, accountid: accountid, viewid: viewid, oBPv510CreateCustomViewRequest: oBPv510CreateCustomViewRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create (DAuth) User with Account Access
AccountAPI.oBPv510CreateUserWithAccountAccessById(bankid: bankid, accountid: accountid, viewid: viewid, oBPv510CreateUserWithAccountAccessByIdRequest: oBPv510CreateUserWithAccountAccessByIdRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Delete Bank Account Balance
AccountAPI.oBPv510DeleteBankAccountBalance(bankid: bankid, accountid: accountid, balanceid: balanceid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Delete Custom View
AccountAPI.oBPv510DeleteCustomView(bankid: bankid, accountid: accountid, viewid: viewid, targetviewid: targetviewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv510GetAccountAccessByUserId(userid: String, completion: @escaping (_ data: OBPv510GetApiTags200Response?, _ error: Error?) -> Void)
```
...
// Get Account Access by USER_ID
AccountAPI.oBPv510GetAccountAccessByUserId(userid: userid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv510GetAccountsHeldByUser(userid: String, completion: @escaping (_ data: OBPv510GetAccountsHeldByUserAtBank200Response?, _ error: Error?) -> Void)
```
...
// Get Accounts Held By User
AccountAPI.oBPv510GetAccountsHeldByUser(userid: userid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv510GetAccountsHeldByUserAtBank(userid: String, bankid: String, completion: @escaping (_ data: OBPv510GetAccountsHeldByUserAtBank200Response?, _ error: Error?) -> Void)
```
...
// Get Accounts Held By User
AccountAPI.oBPv510GetAccountsHeldByUserAtBank(userid: userid, bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **oBPv510GetAgent**
```swift
    open class func oBPv510GetAgent(bankid: String, agentid: String, completion: @escaping (_ data: OBPv510GetAgent200Response?, _ error: Error?) -> Void)
```
...
// Get Agent
AccountAPI.oBPv510GetAgent(bankid: bankid, agentid: agentid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **oBPv510GetAgents**
```swift
    open class func oBPv510GetAgents(bankid: String, completion: @escaping (_ data: OBPv510GetAgents200Response?, _ error: Error?) -> Void)
```
...
// Get Agents at Bank
AccountAPI.oBPv510GetAgents(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get All Bank Account Balances
AccountAPI.oBPv510GetAllBankAccountBalances(bankid: bankid, accountid: accountid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Bank Account Balance By ID
AccountAPI.oBPv510GetBankAccountBalanceById(bankid: bankid, accountid: accountid, balanceid: balanceid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Account Balances by BANK_ID and ACCOUNT_ID through the VIEW_ID
AccountAPI.oBPv510GetBankAccountBalances(bankid: bankid, accountid: accountid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Account Balances by BANK_ID
AccountAPI.oBPv510GetBankAccountsBalances(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Account Balances by BANK_ID through the VIEW_ID
AccountAPI.oBPv510GetBankAccountsBalancesThroughView(bankid: bankid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Account by Id (Core) through the VIEW_ID
AccountAPI.oBPv510GetCoreAccountByIdThroughView(bankid: bankid, accountid: accountid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Custom View
AccountAPI.oBPv510GetCustomView(bankid: bankid, accountid: accountid, viewid: viewid, targetviewid: targetviewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Grant User access to View
AccountAPI.oBPv510GrantUserAccessToViewById(bankid: bankid, accountid: accountid, viewid: viewid, oBPv510RevokeUserAccessToViewByIdRequest: oBPv510RevokeUserAccessToViewByIdRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Revoke User access to View
AccountAPI.oBPv510RevokeUserAccessToViewById(bankid: bankid, accountid: accountid, viewid: viewid, oBPv510RevokeUserAccessToViewByIdRequest: oBPv510RevokeUserAccessToViewByIdRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Update Bank Account Balance
AccountAPI.oBPv510UpdateBankAccountBalance(bankid: bankid, accountid: accountid, balanceid: balanceid, oBPv510CreateBankAccountBalanceRequest: oBPv510CreateBankAccountBalanceRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Update Custom View
AccountAPI.oBPv510UpdateCustomView(bankid: bankid, accountid: accountid, viewid: viewid, targetviewid: targetviewid, oBPv510UpdateCustomViewRequest: oBPv510UpdateCustomViewRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Custom View (Management)
AccountAPI.oBPv600CreateCustomViewManagement(bankid: bankid, accountid: accountid, oBPv600CreateCustomViewManagementRequest: oBPv600CreateCustomViewManagementRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv600GetAccountDirectory(bankid: String, completion: @escaping (_ data: OBPv600GetAccountDirectory200Response?, _ error: Error?) -> Void)
```
...
// Get Account Directory at Bank
AccountAPI.oBPv600GetAccountDirectory(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Accounts at Bank
AccountAPI.oBPv600GetAccountsAtBank(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Account by Id (Core)
AccountAPI.oBPv600GetCoreAccountByIdV600(bankid: bankid, accountid: accountid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv600GetHoldingAccountByReleaser(bankid: String, accountid: String, viewid: String, completion: @escaping (_ data: OBPv600GetHoldingAccountByReleaser200Response?, _ error: Error?) -> Void)
```
...
// Get Holding Accounts By Releaser
AccountAPI.oBPv600GetHoldingAccountByReleaser(bankid: bankid, accountid: accountid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Transactions for Account (Full)
AccountAPI.oBPv600GetTransactionsForBankAccount(bankid: bankid, accountid: accountid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Has Account Access
AccountAPI.oBPv600HasAccountAccess(bankid: bankid, accountid: accountid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
