...
```swift
    open class func oBPv121DeleteViewForBankAccount(bankid: String, accountid: String, viewid: String, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
// Delete Custom View
ViewCustomAPI.oBPv121DeleteViewForBankAccount(bankid: bankid, accountid: accountid, viewid: viewid) { (response, error) in
...
// Get access
ViewCustomAPI.oBPv200GetPermissionsForBankAccount(bankid: bankid, accountid: accountid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv300CreateViewForBankAccount(bankid: String, accountid: String, oBPv600CreateCustomViewManagementRequest: OBPv600CreateCustomViewManagementRequest, completion: @escaping (_ data: OBPv510CreateUserWithAccountAccessById200ResponsePropertiesHead?, _ error: Error?) -> Void)
```
...
let bankid = "bankid_example" // String | The BANKID identifier
let accountid = "accountid_example" // String | The ACCOUNTID identifier
let oBPv600CreateCustomViewManagementRequest = OBPv6_0_0_createCustomViewManagement_request(type: "type_example", properties: OBPv6_0_0_createCustomViewManagement_request_properties(name: OBPv4_0_0_updateSystemLevelEndpointTag_request_properties_tag_name(type: "type_example"), description: nil, isPublic: nil, hideMetadataIfAliasUsed: nil, whichAliasToUse: nil, metadataView: nil, allowedActions: OBPv6_0_0_getActiveRateLimitsAtDate_200_response_properties_considered_rate_limit_ids(type: "type_example", items: nil))) // OBPv600CreateCustomViewManagementRequest | Request body

// Create Custom View
ViewCustomAPI.oBPv300CreateViewForBankAccount(bankid: bankid, accountid: accountid, oBPv600CreateCustomViewManagementRequest: oBPv600CreateCustomViewManagementRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Accounts Held
ViewCustomAPI.oBPv300GetAccountsHeld(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Account access for User
ViewCustomAPI.oBPv300GetPermissionForUserForBankAccount(bankid: bankid, accountid: accountid, provider: provider, providerid: providerid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv300UpdateViewForBankAccount(bankid: String, accountid: String, viewid: String, oBPv300UpdateViewForBankAccountRequest: OBPv300UpdateViewForBankAccountRequest, completion: @escaping (_ data: OBPv510CreateUserWithAccountAccessById200ResponsePropertiesHead?, _ error: Error?) -> Void)
```
...
let accountid = "accountid_example" // String | The ACCOUNTID identifier
let viewid = "viewid_example" // String | The VIEWID identifier
let oBPv300UpdateViewForBankAccountRequest = OBPv3_0_0_updateViewForBankAccount_request(type: "type_example", properties: OBPv3_0_0_updateViewForBankAccount_request_properties(description: OBPv4_0_0_updateSystemLevelEndpointTag_request_properties_tag_name(type: "type_example"), isPublic: nil, hideMetadataIfAliasUsed: nil, whichAliasToUse: nil, metadataView: nil, allowedActions: OBPv6_0_0_getActiveRateLimitsAtDate_200_response_properties_considered_rate_limit_ids(type: "type_example", items: nil))) // OBPv300UpdateViewForBankAccountRequest | Request body

// Update Custom View
ViewCustomAPI.oBPv300UpdateViewForBankAccount(bankid: bankid, accountid: accountid, viewid: viewid, oBPv300UpdateViewForBankAccountRequest: oBPv300UpdateViewForBankAccountRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv500GetViewsForBankAccount(bankid: String, accountid: String, completion: @escaping (_ data: OBPv500GetViewsForBankAccount200Response?, _ error: Error?) -> Void)
```
...
// Get Views for Account
ViewCustomAPI.oBPv500GetViewsForBankAccount(bankid: bankid, accountid: accountid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv510CreateCustomView(bankid: String, accountid: String, viewid: String, oBPv510CreateCustomViewRequest: OBPv510CreateCustomViewRequest, completion: @escaping (_ data: OBPv510CreateCustomView200Response?, _ error: Error?) -> Void)
```
...
let accountid = "accountid_example" // String | The ACCOUNTID identifier
let viewid = "viewid_example" // String | The VIEWID identifier
let oBPv510CreateCustomViewRequest = OBPv5_1_0_createCustomView_request(type: "type_example", properties: OBPv5_1_0_createCustomView_request_properties(name: OBPv4_0_0_updateSystemLevelEndpointTag_request_properties_tag_name(type: "type_example"), description: nil, allowedPermissions: OBPv6_0_0_getActiveRateLimitsAtDate_200_response_properties_considered_rate_limit_ids(type: "type_example", items: nil), isPublic: nil, hideMetadataIfAliasUsed: nil, whichAliasToUse: nil, metadataView: nil)) // OBPv510CreateCustomViewRequest | Request body

// Create Custom View
ViewCustomAPI.oBPv510CreateCustomView(bankid: bankid, accountid: accountid, viewid: viewid, oBPv510CreateCustomViewRequest: oBPv510CreateCustomViewRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create (DAuth) User with Account Access
ViewCustomAPI.oBPv510CreateUserWithAccountAccessById(bankid: bankid, accountid: accountid, viewid: viewid, oBPv510CreateUserWithAccountAccessByIdRequest: oBPv510CreateUserWithAccountAccessByIdRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv510DeleteCustomView(bankid: String, accountid: String, viewid: String, targetviewid: String, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
// Delete Custom View
ViewCustomAPI.oBPv510DeleteCustomView(bankid: bankid, accountid: accountid, viewid: viewid, targetviewid: targetviewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv510GetCustomView(bankid: String, accountid: String, viewid: String, targetviewid: String, completion: @escaping (_ data: OBPv510CreateCustomView200Response?, _ error: Error?) -> Void)
```
...
// Get Custom View
ViewCustomAPI.oBPv510GetCustomView(bankid: bankid, accountid: accountid, viewid: viewid, targetviewid: targetviewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Grant User access to View
ViewCustomAPI.oBPv510GrantUserAccessToViewById(bankid: bankid, accountid: accountid, viewid: viewid, oBPv510RevokeUserAccessToViewByIdRequest: oBPv510RevokeUserAccessToViewByIdRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Revoke User access to View
ViewCustomAPI.oBPv510RevokeUserAccessToViewById(bankid: bankid, accountid: accountid, viewid: viewid, oBPv510RevokeUserAccessToViewByIdRequest: oBPv510RevokeUserAccessToViewByIdRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv510UpdateCustomView(bankid: String, accountid: String, viewid: String, targetviewid: String, oBPv510UpdateCustomViewRequest: OBPv510UpdateCustomViewRequest, completion: @escaping (_ data: OBPv510CreateCustomView200Response?, _ error: Error?) -> Void)
```
...
let viewid = "viewid_example" // String | The VIEWID identifier
let targetviewid = "targetviewid_example" // String | The TARGETVIEWID identifier
let oBPv510UpdateCustomViewRequest = OBPv5_1_0_updateCustomView_request(type: "type_example", properties: OBPv5_1_0_updateCustomView_request_properties(description: OBPv4_0_0_updateSystemLevelEndpointTag_request_properties_tag_name(type: "type_example"), allowedPermissions: OBPv6_0_0_getActiveRateLimitsAtDate_200_response_properties_considered_rate_limit_ids(type: "type_example", items: nil), isPublic: nil, hideMetadataIfAliasUsed: nil, whichAliasToUse: nil, metadataView: nil)) // OBPv510UpdateCustomViewRequest | Request body

// Update Custom View
ViewCustomAPI.oBPv510UpdateCustomView(bankid: bankid, accountid: accountid, viewid: viewid, targetviewid: targetviewid, oBPv510UpdateCustomViewRequest: oBPv510UpdateCustomViewRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv600CreateCustomViewManagement(bankid: String, accountid: String, oBPv600CreateCustomViewManagementRequest: OBPv600CreateCustomViewManagementRequest, completion: @escaping (_ data: OBPv510CreateUserWithAccountAccessById200ResponsePropertiesHead?, _ error: Error?) -> Void)
```
...
// Create Custom View (Management)
ViewCustomAPI.oBPv600CreateCustomViewManagement(bankid: bankid, accountid: accountid, oBPv600CreateCustomViewManagementRequest: oBPv600CreateCustomViewManagementRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv600GetCustomViews(completion: @escaping (_ data: OBPv600GetCustomViews200Response?, _ error: Error?) -> Void)
```
...
// Get Custom Views
ViewCustomAPI.oBPv600GetCustomViews() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv600GetSystemViewById(viewid: String, completion: @escaping (_ data: OBPv600GetSystemViewById200Response?, _ error: Error?) -> Void)
```
...
// Get System View
ViewCustomAPI.oBPv600GetSystemViewById(viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv600GetSystemViews(completion: @escaping (_ data: OBPv600GetSystemViews200Response?, _ error: Error?) -> Void)
```
...
// Get System Views
ViewCustomAPI.oBPv600GetSystemViews() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv600GetViewPermissions(completion: @escaping (_ data: OBPv600GetViewPermissions200Response?, _ error: Error?) -> Void)
```
...
// Get View Permissions
ViewCustomAPI.oBPv600GetViewPermissions() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv600HasAccountAccess(bankid: String, accountid: String, viewid: String, completion: @escaping (_ data: OBPv600HasAccountAccess200Response?, _ error: Error?) -> Void)
```
...
// Has Account Access
ViewCustomAPI.oBPv600HasAccountAccess(bankid: bankid, accountid: accountid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv600UpdateSystemView(viewid: String, oBPv600UpdateSystemViewRequest: OBPv600UpdateSystemViewRequest, completion: @escaping (_ data: OBPv600GetSystemViewById200Response?, _ error: Error?) -> Void)
```
...
let viewid = "viewid_example" // String | The VIEWID identifier
let oBPv600UpdateSystemViewRequest = OBPv6_0_0_updateSystemView_request(type: "type_example", properties: OBPv6_0_0_updateSystemView_request_properties(canGrantAccessToViews: OBPv6_0_0_getActiveRateLimitsAtDate_200_response_properties_considered_rate_limit_ids(type: "type_example", items: OBPv4_0_0_updateSystemLevelEndpointTag_request_properties_tag_name(type: "type_example")), description: nil, isPublic: nil, hideMetadataIfAliasUsed: nil, canRevokeAccessToViews: nil, whichAliasToUse: nil, isFirehose: nil, metadataView: nil, allowedActions: nil)) // OBPv600UpdateSystemViewRequest | Request body

// Update System View
ViewCustomAPI.oBPv600UpdateSystemView(viewid: viewid, oBPv600UpdateSystemViewRequest: oBPv600UpdateSystemViewRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
