...
// Delete Consumer Scope
ConsumerAPI.oBPv300DeleteScope(consumerid: consumerid, scopeid: scopeid) { (response, error) in
...
```swift
    open class func oBPv310EnableDisableConsumers(consumerid: String, oBPv310EnableDisableConsumersRequest: OBPv310EnableDisableConsumersRequest, completion: @escaping (_ data: OBPv310EnableDisableConsumersRequest?, _ error: Error?) -> Void)
```
...
let consumerid = "consumerid_example" // String | The CONSUMERID identifier
let oBPv310EnableDisableConsumersRequest = OBPv3_1_0_enableDisableConsumers_request(type: "type_example", properties: OBPv3_1_0_enableDisableConsumers_request_properties(enabled: OBPv4_0_0_updateSystemLevelEndpointTag_request_properties_tag_name(type: "type_example"))) // OBPv310EnableDisableConsumersRequest | Request body

// Enable or Disable Consumers
ConsumerAPI.oBPv310EnableDisableConsumers(consumerid: consumerid, oBPv310EnableDisableConsumersRequest: oBPv310EnableDisableConsumersRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv310GetCallsLimit(consumerid: String, completion: @escaping (_ data: OBPv310GetCallsLimit200Response?, _ error: Error?) -> Void)
```
...
// Get Rate Limits for a Consumer
ConsumerAPI.oBPv310GetCallsLimit(consumerid: consumerid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv310GetConsumersForCurrentUser(completion: @escaping (_ data: OBPv310GetConsumersForCurrentUser200Response?, _ error: Error?) -> Void)
```
...
// Get Consumers (logged in User)
ConsumerAPI.oBPv310GetConsumersForCurrentUser() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Scope for a Consumer
ConsumerAPI.oBPv400AddScope(consumerid: consumerid, oBPv510GetMyConsentsByBank200ResponsePropertiesConsentsItemsPropertiesJwtPayloadPropertiesEntitlementsItems: oBPv510GetMyConsentsByBank200ResponsePropertiesConsentsItemsPropertiesJwtPayloadPropertiesEntitlementsItems) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Set Rate Limits / Call Limits per Consumer
ConsumerAPI.oBPv400CallsLimit(consumerid: consumerid, oBPv600UpdateRateLimitsRequest: oBPv600UpdateRateLimitsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Scopes for Consumer
ConsumerAPI.oBPv400GetScopes(consumerid: consumerid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv510CreateConsumer(oBPv510CreateConsumerRequest: OBPv510CreateConsumerRequest, completion: @escaping (_ data: OBPv510CreateConsumer200Response?, _ error: Error?) -> Void)
```
...
let oBPv510CreateConsumerRequest = OBPv5_1_0_createConsumer_request(type: "type_example", properties: OBPv5_1_0_createConsumer_request_properties(appType: OBPv4_0_0_updateSystemLevelEndpointTag_request_properties_tag_name(type: "type_example"), description: nil, enabled: nil, clientCertificate: nil, redirectUrl: nil, logoUrl: nil, company: nil, developerEmail: nil, appName: nil)) // OBPv510CreateConsumerRequest | Request body

// Create a Consumer
ConsumerAPI.oBPv510CreateConsumer(oBPv510CreateConsumerRequest: oBPv510CreateConsumerRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create a Consumer(Dynamic Registration)
ConsumerAPI.oBPv510CreateConsumerDynamicRegistration(oBPv510CreateConsumerDynamicRegistrationRequest: oBPv510CreateConsumerDynamicRegistrationRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv510CreateMyConsumer(oBPv510CreateConsumerRequest: OBPv510CreateConsumerRequest, completion: @escaping (_ data: OBPv510UpdateConsumerName200Response?, _ error: Error?) -> Void)
```
...
// Create a Consumer
ConsumerAPI.oBPv510CreateMyConsumer(oBPv510CreateConsumerRequest: oBPv510CreateConsumerRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv510GetCallsLimit(consumerid: String, completion: @escaping (_ data: OBPv510GetCallsLimit200Response?, _ error: Error?) -> Void)
```
...
// Get Rate Limits for a Consumer
ConsumerAPI.oBPv510GetCallsLimit(consumerid: consumerid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **oBPv510GetConsumers**
```swift
    open class func oBPv510GetConsumers(completion: @escaping (_ data: OBPv510GetConsumers200Response?, _ error: Error?) -> Void)
```
...
// Get Consumers
ConsumerAPI.oBPv510GetConsumers() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv510UpdateConsumerCertificate(consumerid: String, oBPv510UpdateConsumerCertificateRequest: OBPv510UpdateConsumerCertificateRequest, completion: @escaping (_ data: OBPv510UpdateConsumerName200Response?, _ error: Error?) -> Void)
```
...
let consumerid = "consumerid_example" // String | The CONSUMERID identifier
let oBPv510UpdateConsumerCertificateRequest = OBPv5_1_0_updateConsumerCertificate_request(type: "type_example", properties: OBPv5_1_0_updateConsumerCertificate_request_properties(certificate: OBPv4_0_0_updateSystemLevelEndpointTag_request_properties_tag_name(type: "type_example"))) // OBPv510UpdateConsumerCertificateRequest | Request body

// Update Consumer Certificate
ConsumerAPI.oBPv510UpdateConsumerCertificate(consumerid: consumerid, oBPv510UpdateConsumerCertificateRequest: oBPv510UpdateConsumerCertificateRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv510UpdateConsumerLogoURL(consumerid: String, oBPv510UpdateConsumerLogoURLRequest: OBPv510UpdateConsumerLogoURLRequest, completion: @escaping (_ data: OBPv510UpdateConsumerName200Response?, _ error: Error?) -> Void)
```
...
let consumerid = "consumerid_example" // String | The CONSUMERID identifier
let oBPv510UpdateConsumerLogoURLRequest = OBPv5_1_0_updateConsumerLogoURL_request(type: "type_example", properties: OBPv5_1_0_updateConsumerLogoURL_request_properties(logoUrl: OBPv4_0_0_updateSystemLevelEndpointTag_request_properties_tag_name(type: "type_example"))) // OBPv510UpdateConsumerLogoURLRequest | Request body

// Update Consumer LogoURL
ConsumerAPI.oBPv510UpdateConsumerLogoURL(consumerid: consumerid, oBPv510UpdateConsumerLogoURLRequest: oBPv510UpdateConsumerLogoURLRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv510UpdateConsumerName(consumerid: String, oBPv510UpdateConsumerNameRequest: OBPv510UpdateConsumerNameRequest, completion: @escaping (_ data: OBPv510UpdateConsumerName200Response?, _ error: Error?) -> Void)
```
...
let consumerid = "consumerid_example" // String | The CONSUMERID identifier
let oBPv510UpdateConsumerNameRequest = OBPv5_1_0_updateConsumerName_request(type: "type_example", properties: OBPv5_1_0_updateConsumerName_request_properties(appName: OBPv4_0_0_updateSystemLevelEndpointTag_request_properties_tag_name(type: "type_example"))) // OBPv510UpdateConsumerNameRequest | Request body

// Update Consumer Name
ConsumerAPI.oBPv510UpdateConsumerName(consumerid: consumerid, oBPv510UpdateConsumerNameRequest: oBPv510UpdateConsumerNameRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv510UpdateConsumerRedirectURL(consumerid: String, oBPv510UpdateConsumerRedirectURLRequest: OBPv510UpdateConsumerRedirectURLRequest, completion: @escaping (_ data: OBPv510UpdateConsumerRedirectURL200Response?, _ error: Error?) -> Void)
```
...
let consumerid = "consumerid_example" // String | The CONSUMERID identifier
let oBPv510UpdateConsumerRedirectURLRequest = OBPv5_1_0_updateConsumerRedirectURL_request(type: "type_example", properties: OBPv5_1_0_updateConsumerRedirectURL_request_properties(redirectUrl: OBPv4_0_0_updateSystemLevelEndpointTag_request_properties_tag_name(type: "type_example"))) // OBPv510UpdateConsumerRedirectURLRequest | Request body

// Update Consumer RedirectURL
ConsumerAPI.oBPv510UpdateConsumerRedirectURL(consumerid: consumerid, oBPv510UpdateConsumerRedirectURLRequest: oBPv510UpdateConsumerRedirectURLRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv600CreateCallLimits(consumerid: String, oBPv600CreateCallLimitsRequest: OBPv600CreateCallLimitsRequest, completion: @escaping (_ data: OBPv600CreateCallLimits200Response?, _ error: Error?) -> Void)
```
...
let consumerid = "consumerid_example" // String | The CONSUMERID identifier
let oBPv600CreateCallLimitsRequest = OBPv6_0_0_createCallLimits_request(type: "type_example", properties: OBPv6_0_0_createCallLimits_request_properties(perMonthCallLimit: OBPv4_0_0_updateSystemLevelEndpointTag_request_properties_tag_name(type: "type_example"), perWeekCallLimit: nil, apiVersion: nil, perHourCallLimit: nil, perSecondCallLimit: nil, fromDate: OBPv6_0_0_updateRateLimits_request_properties_from_date(type: "type_example", format: "format_example"), apiName: nil, perMinuteCallLimit: nil, perDayCallLimit: nil, toDate: nil)) // OBPv600CreateCallLimitsRequest | Request body

// Create Rate Limits for a Consumer
ConsumerAPI.oBPv600CreateCallLimits(consumerid: consumerid, oBPv600CreateCallLimitsRequest: oBPv600CreateCallLimitsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv600DeleteCallLimits(consumerid: String, ratelimitingid: String, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
// Delete Rate Limit by Rate Limiting ID
ConsumerAPI.oBPv600DeleteCallLimits(consumerid: consumerid, ratelimitingid: ratelimitingid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv600GetActiveRateLimitsAtDate(consumerid: String, datewithhour: String, completion: @escaping (_ data: OBPv600GetActiveRateLimitsAtDate200Response?, _ error: Error?) -> Void)
```
...
// Get Active Rate Limits for Hour
ConsumerAPI.oBPv600GetActiveRateLimitsAtDate(consumerid: consumerid, datewithhour: datewithhour) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv600GetActiveRateLimitsNow(consumerid: String, completion: @escaping (_ data: OBPv600GetActiveRateLimitsAtDate200Response?, _ error: Error?) -> Void)
```
...
// Get Active Rate Limits (Current)
ConsumerAPI.oBPv600GetActiveRateLimitsNow(consumerid: consumerid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **oBPv600GetConsumer**
```swift
    open class func oBPv600GetConsumer(consumerid: String, completion: @escaping (_ data: OBPv600GetConsumer200Response?, _ error: Error?) -> Void)
```
...
// Get Consumer
ConsumerAPI.oBPv600GetConsumer(consumerid: consumerid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv600GetConsumerCallCounters(consumerid: String, completion: @escaping (_ data: OBPv600GetCurrentConsumer200ResponsePropertiesCallCounters?, _ error: Error?) -> Void)
```
...
// Get Call Counts for Consumer
ConsumerAPI.oBPv600GetConsumerCallCounters(consumerid: consumerid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Current Consumer
ConsumerAPI.oBPv600GetCurrentConsumer() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get OIDC Client
ConsumerAPI.oBPv600GetOidcClient(clientid: clientid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Set Rate Limits / Call Limits per Consumer
ConsumerAPI.oBPv600UpdateRateLimits(consumerid: consumerid, ratelimitingid: ratelimitingid, oBPv600UpdateRateLimitsRequest: oBPv600UpdateRateLimitsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Verify OIDC Client
ConsumerAPI.oBPv600VerifyOidcClient(oBPv600VerifyOidcClientRequest: oBPv600VerifyOidcClientRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
