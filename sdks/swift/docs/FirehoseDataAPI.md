...
// Get Firehose Transactions for Account
FirehoseDataAPI.oBPv300GetFirehoseTransactionsForBankAccount(bankid: bankid, accountid: accountid, viewid: viewid) { (response, error) in
...
// Get Firehose Customers
FirehoseDataAPI.oBPv310GetFirehoseCustomers(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv400GetFastFirehoseAccountsAtOneBank(bankid: String, completion: @escaping (_ data: OBPv400GetFastFirehoseAccountsAtOneBank200Response?, _ error: Error?) -> Void)
```
...
// Get Fast Firehose Accounts at Bank
FirehoseDataAPI.oBPv400GetFastFirehoseAccountsAtOneBank(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv400GetFirehoseAccountsAtOneBank(bankid: String, viewid: String, completion: @escaping (_ data: OBPv400GetFirehoseAccountsAtOneBank200Response?, _ error: Error?) -> Void)
```
...
// Get Firehose Accounts at Bank
FirehoseDataAPI.oBPv400GetFirehoseAccountsAtOneBank(bankid: bankid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
