...
```swift
    open class func oBPv400UpdateAtmAccessibilityFeatures(bankid: String, atmid: String, oBPv400UpdateAtmAccessibilityFeaturesRequest: OBPv400UpdateAtmAccessibilityFeaturesRequest, completion: @escaping (_ data: OBPv400UpdateAtmAccessibilityFeatures200Response?, _ error: Error?) -> Void)
```
...
let oBPv400UpdateAtmAccessibilityFeaturesRequest = OBPv4_0_0_updateAtmAccessibilityFeatures_request(type: "type_example", properties: OBPv4_0_0_updateAtmAccessibilityFeatures_request_properties(accessibilityFeatures: OBPv6_0_0_getActiveRateLimitsAtDate_200_response_properties_considered_rate_limit_ids(type: "type_example", items: OBPv4_0_0_updateSystemLevelEndpointTag_request_properties_tag_name(type: "type_example")))) // OBPv400UpdateAtmAccessibilityFeaturesRequest | Request body

// Update ATM Accessibility Features
ATMAPI.oBPv400UpdateAtmAccessibilityFeatures(bankid: bankid, atmid: atmid, oBPv400UpdateAtmAccessibilityFeaturesRequest: oBPv400UpdateAtmAccessibilityFeaturesRequest) { (response, error) in
...
```swift
    open class func oBPv400UpdateAtmLocationCategories(bankid: String, atmid: String, oBPv400UpdateAtmLocationCategoriesRequest: OBPv400UpdateAtmLocationCategoriesRequest, completion: @escaping (_ data: OBPv400UpdateAtmLocationCategories200Response?, _ error: Error?) -> Void)
```
...
let bankid = "bankid_example" // String | The BANKID identifier
let atmid = "atmid_example" // String | The ATMID identifier
let oBPv400UpdateAtmLocationCategoriesRequest = OBPv4_0_0_updateAtmLocationCategories_request(type: "type_example", properties: OBPv4_0_0_updateAtmLocationCategories_request_properties(locationCategories: OBPv6_0_0_getActiveRateLimitsAtDate_200_response_properties_considered_rate_limit_ids(type: "type_example", items: OBPv4_0_0_updateSystemLevelEndpointTag_request_properties_tag_name(type: "type_example")))) // OBPv400UpdateAtmLocationCategoriesRequest | Request body

// Update ATM Location Categories
ATMAPI.oBPv400UpdateAtmLocationCategories(bankid: bankid, atmid: atmid, oBPv400UpdateAtmLocationCategoriesRequest: oBPv400UpdateAtmLocationCategoriesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv400UpdateAtmNotes(bankid: String, atmid: String, oBPv400UpdateAtmNotesRequest: OBPv400UpdateAtmNotesRequest, completion: @escaping (_ data: OBPv400UpdateAtmNotes200Response?, _ error: Error?) -> Void)
```
...
let bankid = "bankid_example" // String | The BANKID identifier
let atmid = "atmid_example" // String | The ATMID identifier
let oBPv400UpdateAtmNotesRequest = OBPv4_0_0_updateAtmNotes_request(type: "type_example", properties: OBPv4_0_0_updateAtmNotes_request_properties(notes: OBPv6_0_0_getActiveRateLimitsAtDate_200_response_properties_considered_rate_limit_ids(type: "type_example", items: OBPv4_0_0_updateSystemLevelEndpointTag_request_properties_tag_name(type: "type_example")))) // OBPv400UpdateAtmNotesRequest | Request body

// Update ATM Notes
ATMAPI.oBPv400UpdateAtmNotes(bankid: bankid, atmid: atmid, oBPv400UpdateAtmNotesRequest: oBPv400UpdateAtmNotesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv400UpdateAtmServices(bankid: String, atmid: String, oBPv400UpdateAtmServicesRequest: OBPv400UpdateAtmServicesRequest, completion: @escaping (_ data: OBPv400UpdateAtmServices200Response?, _ error: Error?) -> Void)
```
...
let bankid = "bankid_example" // String | The BANKID identifier
let atmid = "atmid_example" // String | The ATMID identifier
let oBPv400UpdateAtmServicesRequest = OBPv4_0_0_updateAtmServices_request(type: "type_example", properties: OBPv4_0_0_updateAtmServices_request_properties(services: OBPv6_0_0_getActiveRateLimitsAtDate_200_response_properties_considered_rate_limit_ids(type: "type_example", items: OBPv4_0_0_updateSystemLevelEndpointTag_request_properties_tag_name(type: "type_example")))) // OBPv400UpdateAtmServicesRequest | Request body

// Update ATM Services
ATMAPI.oBPv400UpdateAtmServices(bankid: bankid, atmid: atmid, oBPv400UpdateAtmServicesRequest: oBPv400UpdateAtmServicesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv400UpdateAtmSupportedCurrencies(bankid: String, atmid: String, oBPv400UpdateAtmSupportedCurrenciesRequest: OBPv400UpdateAtmSupportedCurrenciesRequest, completion: @escaping (_ data: OBPv400UpdateAtmSupportedCurrencies200Response?, _ error: Error?) -> Void)
```
...
let bankid = "bankid_example" // String | The BANKID identifier
let atmid = "atmid_example" // String | The ATMID identifier
let oBPv400UpdateAtmSupportedCurrenciesRequest = OBPv4_0_0_updateAtmSupportedCurrencies_request(type: "type_example", properties: OBPv4_0_0_updateAtmSupportedCurrencies_request_properties(supportedCurrencies: OBPv6_0_0_getActiveRateLimitsAtDate_200_response_properties_considered_rate_limit_ids(type: "type_example", items: OBPv4_0_0_updateSystemLevelEndpointTag_request_properties_tag_name(type: "type_example")))) // OBPv400UpdateAtmSupportedCurrenciesRequest | Request body

// Update ATM Supported Currencies
ATMAPI.oBPv400UpdateAtmSupportedCurrencies(bankid: bankid, atmid: atmid, oBPv400UpdateAtmSupportedCurrenciesRequest: oBPv400UpdateAtmSupportedCurrenciesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv400UpdateAtmSupportedLanguages(bankid: String, atmid: String, oBPv400UpdateAtmSupportedLanguagesRequest: OBPv400UpdateAtmSupportedLanguagesRequest, completion: @escaping (_ data: OBPv400UpdateAtmSupportedLanguages200Response?, _ error: Error?) -> Void)
```
...
let bankid = "bankid_example" // String | The BANKID identifier
let atmid = "atmid_example" // String | The ATMID identifier
let oBPv400UpdateAtmSupportedLanguagesRequest = OBPv4_0_0_updateAtmSupportedLanguages_request(type: "type_example", properties: OBPv4_0_0_updateAtmSupportedLanguages_request_properties(supportedLanguages: OBPv6_0_0_getActiveRateLimitsAtDate_200_response_properties_considered_rate_limit_ids(type: "type_example", items: OBPv4_0_0_updateSystemLevelEndpointTag_request_properties_tag_name(type: "type_example")))) // OBPv400UpdateAtmSupportedLanguagesRequest | Request body

// Update ATM Supported Languages
ATMAPI.oBPv400UpdateAtmSupportedLanguages(bankid: bankid, atmid: atmid, oBPv400UpdateAtmSupportedLanguagesRequest: oBPv400UpdateAtmSupportedLanguagesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **oBPv500HeadAtms**
```swift
    open class func oBPv500HeadAtms(bankid: String, completion: @escaping (_ data: OBPv500HeadAtms200Response?, _ error: Error?) -> Void)
```
...
// Head Bank ATMS
ATMAPI.oBPv500HeadAtms(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **oBPv510CreateAtm**
```swift
    open class func oBPv510CreateAtm(bankid: String, oBPv510CreateAtmRequest: OBPv510CreateAtmRequest, completion: @escaping (_ data: OBPv510GetAtm200Response?, _ error: Error?) -> Void)
```
...
let bankid = "bankid_example" // String | The BANKID identifier
let oBPv510CreateAtmRequest = OBPv5_1_0_createAtm_request(type: "type_example", properties: OBPv5_1_0_createAtm_request_properties(sunday: OBPv3_0_0_getBranches_200_response_properties_branches_items_properties_drive_up_properties_sunday(type: "type_example", properties: OBPv3_0_0_getBranches_200_response_properties_branches_items_properties_drive_up_properties_sunday_properties(closingTime: OBPv4_0_0_updateSystemLevelEndpointTag_request_properties_tag_name(type: "type_example"), openingTime: nil)), services: OBPv6_0_0_getActiveRateLimitsAtDate_200_response_properties_considered_rate_limit_ids(type: "type_example", items: nil), name: nil, location: OBPv3_0_0_getBranches_200_response_properties_branches_items_properties_location(type: "type_example", properties: OBPv3_0_0_getBranches_200_response_properties_branches_items_properties_location_properties(latitude: nil, longitude: nil)), tuesday: nil, cashWithdrawalInternationalFee: nil, wednesday: nil, branchIdentification: nil, locationCategories: nil, siteIdentification: nil, monday: nil, hasDepositCapability: nil, balanceInquiryFee: nil, siteName: nil, moreInfo: nil, bankId: nil, id: nil, meta: OBPv3_1_0_getProductTree_200_response_properties_parent_product_properties_parent_product_properties_meta(type: "type_example", properties: OBPv3_1_0_getProductTree_200_response_properties_parent_product_properties_parent_product_properties_meta_properties(license: OBPv3_1_0_getProductTree_200_response_properties_parent_product_properties_parent_product_properties_meta_properties_license(type: "type_example", properties: OBPv3_1_0_getProductTree_200_response_properties_parent_product_properties_parent_product_properties_meta_properties_license_properties(name: nil, id: nil)))), supportedLanguages: nil, supportedCurrencies: nil, accessibilityFeatures: nil, address: OBPv3_0_0_getBranches_200_response_properties_branches_items_properties_address(type: "type_example", properties: OBPv3_0_0_getBranches_200_response_properties_branches_items_properties_address_properties(city: nil, line2: nil, state: nil, postcode: nil, county: nil, countryCode: nil, line3: nil, line1: nil)), cashWithdrawalNationalFee: nil, friday: nil, notes: nil, isAccessible: nil, atmType: nil, thursday: nil, saturday: nil, locatedAt: nil, minimumWithdrawal: nil, phone: nil)) // OBPv510CreateAtmRequest | Request body

// Create ATM
ATMAPI.oBPv510CreateAtm(bankid: bankid, oBPv510CreateAtmRequest: oBPv510CreateAtmRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create ATM Attribute
ATMAPI.oBPv510CreateAtmAttribute(bankid: bankid, atmid: atmid, oBPv510UpdateAtmAttributeRequest: oBPv510UpdateAtmAttributeRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **oBPv510DeleteAtm**
```swift
    open class func oBPv510DeleteAtm(bankid: String, atmid: String, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
// Delete ATM
ATMAPI.oBPv510DeleteAtm(bankid: bankid, atmid: atmid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Delete ATM Attribute
ATMAPI.oBPv510DeleteAtmAttribute(bankid: bankid, atmid: atmid, atmattributeid: atmattributeid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **oBPv510GetAtm**
```swift
    open class func oBPv510GetAtm(bankid: String, atmid: String, completion: @escaping (_ data: OBPv510GetAtm200Response?, _ error: Error?) -> Void)
```
...
// Get Bank ATM
ATMAPI.oBPv510GetAtm(bankid: bankid, atmid: atmid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get ATM Attribute By ATM_ATTRIBUTE_ID
ATMAPI.oBPv510GetAtmAttribute(bankid: bankid, atmid: atmid, atmattributeid: atmattributeid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get ATM Attributes
ATMAPI.oBPv510GetAtmAttributes(bankid: bankid, atmid: atmid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **oBPv510GetAtms**
```swift
    open class func oBPv510GetAtms(bankid: String, completion: @escaping (_ data: OBPv510GetAtms200Response?, _ error: Error?) -> Void)
```
...
// Get Bank ATMS
ATMAPI.oBPv510GetAtms(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **oBPv510UpdateAtm**
```swift
    open class func oBPv510UpdateAtm(bankid: String, atmid: String, oBPv510UpdateAtmRequest: OBPv510UpdateAtmRequest, completion: @escaping (_ data: OBPv510GetAtm200Response?, _ error: Error?) -> Void)
```
...
let bankid = "bankid_example" // String | The BANKID identifier
let atmid = "atmid_example" // String | The ATMID identifier
let oBPv510UpdateAtmRequest = OBPv5_1_0_updateAtm_request(type: "type_example", properties: OBPv5_1_0_updateAtm_request_properties(sunday: OBPv3_0_0_getBranches_200_response_properties_branches_items_properties_drive_up_properties_sunday(type: "type_example", properties: OBPv3_0_0_getBranches_200_response_properties_branches_items_properties_drive_up_properties_sunday_properties(closingTime: OBPv4_0_0_updateSystemLevelEndpointTag_request_properties_tag_name(type: "type_example"), openingTime: nil)), services: OBPv6_0_0_getActiveRateLimitsAtDate_200_response_properties_considered_rate_limit_ids(type: "type_example", items: nil), name: nil, location: OBPv3_0_0_getBranches_200_response_properties_branches_items_properties_location(type: "type_example", properties: OBPv3_0_0_getBranches_200_response_properties_branches_items_properties_location_properties(latitude: nil, longitude: nil)), tuesday: nil, cashWithdrawalInternationalFee: nil, wednesday: nil, branchIdentification: nil, locationCategories: nil, siteIdentification: nil, monday: nil, hasDepositCapability: nil, balanceInquiryFee: nil, siteName: nil, moreInfo: nil, bankId: nil, meta: OBPv3_1_0_getProductTree_200_response_properties_parent_product_properties_parent_product_properties_meta(type: "type_example", properties: OBPv3_1_0_getProductTree_200_response_properties_parent_product_properties_parent_product_properties_meta_properties(license: OBPv3_1_0_getProductTree_200_response_properties_parent_product_properties_parent_product_properties_meta_properties_license(type: "type_example", properties: OBPv3_1_0_getProductTree_200_response_properties_parent_product_properties_parent_product_properties_meta_properties_license_properties(name: nil, id: nil)))), supportedLanguages: nil, supportedCurrencies: nil, accessibilityFeatures: nil, address: OBPv3_0_0_getBranches_200_response_properties_branches_items_properties_address(type: "type_example", properties: OBPv3_0_0_getBranches_200_response_properties_branches_items_properties_address_properties(city: nil, line2: nil, state: nil, postcode: nil, county: nil, countryCode: nil, line3: nil, line1: nil)), cashWithdrawalNationalFee: nil, friday: nil, notes: nil, isAccessible: nil, atmType: nil, thursday: nil, saturday: nil, locatedAt: nil, minimumWithdrawal: nil, phone: nil)) // OBPv510UpdateAtmRequest | Request body

// UPDATE ATM
ATMAPI.oBPv510UpdateAtm(bankid: bankid, atmid: atmid, oBPv510UpdateAtmRequest: oBPv510UpdateAtmRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Update ATM Attribute
ATMAPI.oBPv510UpdateAtmAttribute(bankid: bankid, atmid: atmid, atmattributeid: atmattributeid, oBPv510UpdateAtmAttributeRequest: oBPv510UpdateAtmAttributeRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
