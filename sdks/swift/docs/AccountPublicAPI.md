...
// Get Public Accounts at all Banks
AccountPublicAPI.oBPv200PublicAccountsAllBanks() { (response, error) in
...
// Get Public Accounts at Bank
AccountPublicAPI.oBPv200PublicAccountsAtOneBank(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv300GetPublicAccountById(bankid: String, accountid: String, viewid: String, completion: @escaping (_ data: OBPv300GetPublicAccountById200Response?, _ error: Error?) -> Void)
```
...
// Get Public Account by Id
AccountPublicAPI.oBPv300GetPublicAccountById(bankid: bankid, accountid: accountid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
