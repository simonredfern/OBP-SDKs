...
// Add Entitlement for a User
EntitlementAPI.oBPv200AddEntitlement(userid: userid, oBPv510GetMyConsentsByBank200ResponsePropertiesConsentsItemsPropertiesJwtPayloadPropertiesEntitlementsItems: oBPv510GetMyConsentsByBank200ResponsePropertiesConsentsItemsPropertiesJwtPayloadPropertiesEntitlementsItems) { (response, error) in
...
// Delete Entitlement
EntitlementAPI.oBPv200DeleteEntitlement(userid: userid, entitlementid: entitlementid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get access
EntitlementAPI.oBPv200GetPermissionsForBankAccount(bankid: bankid, accountid: accountid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Entitlements for User at Bank
EntitlementAPI.oBPv210GetEntitlementsByBankAndUser(bankid: bankid, userid: userid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Entitlement Request for current User
EntitlementAPI.oBPv300AddEntitlementRequest(oBPv510GetMyConsentsByBank200ResponsePropertiesConsentsItemsPropertiesJwtPayloadPropertiesEntitlementsItems: oBPv510GetMyConsentsByBank200ResponsePropertiesConsentsItemsPropertiesJwtPayloadPropertiesEntitlementsItems) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Delete Entitlement Request
EntitlementAPI.oBPv300DeleteEntitlementRequest(entitlementrequestid: entitlementrequestid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get all Entitlement Requests
EntitlementAPI.oBPv300GetAllEntitlementRequests() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Entitlement Requests for a User
EntitlementAPI.oBPv300GetEntitlementRequests(userid: userid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Entitlement Requests for the current User
EntitlementAPI.oBPv300GetEntitlementRequestsForCurrentUser() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Entitlements for the current User
EntitlementAPI.oBPv300GetEntitlementsForCurrentUser() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get all Entitlements
EntitlementAPI.oBPv310GetAllEntitlements() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create (DAuth) User with Roles
EntitlementAPI.oBPv400CreateUserWithRoles(oBPv400CreateUserWithRolesRequest: oBPv400CreateUserWithRolesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Entitlements for User
EntitlementAPI.oBPv400GetEntitlements(userid: userid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Entitlements for One Bank
EntitlementAPI.oBPv400GetEntitlementsForBank(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Entitlements and Permissions for a User
EntitlementAPI.oBPv510GetEntitlementsAndPermissions(userid: userid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Grant User Membership to Group Entitlements
EntitlementAPI.oBPv600AddUserToGroup(userid: userid, oBPv600AddUserToGroupRequest: oBPv600AddUserToGroupRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Delete Entitlement
EntitlementAPI.oBPv600DeleteEntitlement(entitlementid: entitlementid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Group Entitlements
EntitlementAPI.oBPv600GetGroupEntitlements(groupid: groupid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Roles with Entitlement Counts
EntitlementAPI.oBPv600GetRolesWithEntitlementCountsAtAllBanks() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get User's Group Memberships
EntitlementAPI.oBPv600GetUserGroupMemberships(userid: userid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Remove User from Group
EntitlementAPI.oBPv600RemoveUserFromGroup(userid: userid, groupid: groupid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
