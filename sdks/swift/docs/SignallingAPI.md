...
// Delete Signal Channel
SignallingAPI.oBPv600DeleteSignalChannel(channelname: channelname) { (response, error) in
...
// Get Signal Channel Info
SignallingAPI.oBPv600GetSignalChannelInfo(channelname: channelname) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// List Signal Channels
SignallingAPI.oBPv600GetSignalChannels() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Signal Messages
SignallingAPI.oBPv600GetSignalMessages(channelname: channelname) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Signal Channel Stats
SignallingAPI.oBPv600GetSignalStats() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Publish Signal Message
SignallingAPI.oBPv600PublishSignalMessage(channelname: channelname, oBPv600PublishSignalMessageRequest: oBPv600PublishSignalMessageRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
