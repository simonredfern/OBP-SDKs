...
// Get Transaction Types at Bank
BankAPI.oBPv200GetTransactionTypes(bankid: bankid) { (response, error) in
...
```swift
    open class func oBPv210CreateTransactionType(bankid: String, oBPv200GetTransactionTypes200ResponsePropertiesTransactionTypesItems: OBPv200GetTransactionTypes200ResponsePropertiesTransactionTypesItems, completion: @escaping (_ data: OBPv210CreateTransactionType200Response?, _ error: Error?) -> Void)
```
...
let bankid = "bankid_example" // String | The BANKID identifier
let oBPv200GetTransactionTypes200ResponsePropertiesTransactionTypesItems = OBPv2_0_0_getTransactionTypes_200_response_properties_transaction_types_items(type: "type_example", properties: OBPv2_0_0_getTransactionTypes_200_response_properties_transaction_types_items_properties(description: OBPv4_0_0_updateSystemLevelEndpointTag_request_properties_tag_name(type: "type_example"), shortCode: nil, bankId: nil, id: OBPv4_0_0_deleteSystemLevelEndpointTag_200_response(type: "type_example", properties: OBPv4_0_0_deleteSystemLevelEndpointTag_200_response_properties(value: nil)), charge: OBPv5_0_0_getMyCustomersAtBank_200_response_properties_customers_items_properties_credit_limit(type: "type_example", properties: OBPv5_0_0_getMyCustomersAtBank_200_response_properties_customers_items_properties_credit_limit_properties(currency: nil, amount: nil)), summary: nil)) // OBPv200GetTransactionTypes200ResponsePropertiesTransactionTypesItems | Request body

// Create Transaction Type at bank
BankAPI.oBPv210CreateTransactionType(bankid: bankid, oBPv200GetTransactionTypes200ResponsePropertiesTransactionTypesItems: oBPv200GetTransactionTypes200ResponsePropertiesTransactionTypesItems) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Transaction Request Types at Bank
BankAPI.oBPv210GetTransactionRequestTypesSupportedByBank(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Branch
BankAPI.oBPv300GetBranch(bankid: bankid, branchid: branchid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Branches for a Bank
BankAPI.oBPv300GetBranches(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create an Account Webhook
BankAPI.oBPv310CreateAccountWebhook(bankid: bankid, oBPv310CreateAccountWebhookRequest: oBPv310CreateAccountWebhookRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Enable/Disable an Account Webhook
BankAPI.oBPv310EnableDisableAccountWebhook(bankid: bankid, oBPv310EnableDisableAccountWebhookRequest: oBPv310EnableDisableAccountWebhookRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Account Webhooks
BankAPI.oBPv310GetAccountWebhooks(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create bank level Account Notification Webhook
BankAPI.oBPv400CreateBankAccountNotificationWebhook(bankid: bankid, oBPv400CreateSystemAccountNotificationWebhookRequest: oBPv400CreateSystemAccountNotificationWebhookRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Bank Attribute
BankAPI.oBPv400CreateBankAttribute(bankid: bankid, oBPv510UpdateAtmAttributeRequest: oBPv510UpdateAtmAttributeRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create or Update Bank Attribute Definition
BankAPI.oBPv400CreateOrUpdateBankAttributeDefinition(bankid: bankid, oBPv400CreateOrUpdateTransactionRequestAttributeDefinitionRequest: oBPv400CreateOrUpdateTransactionRequestAttributeDefinitionRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv400CreateSettlementAccount(bankid: String, oBPv400CreateSettlementAccountRequest: OBPv400CreateSettlementAccountRequest, completion: @escaping (_ data: OBPv400CreateSettlementAccount200Response?, _ error: Error?) -> Void)
```
...
let bankid = "bankid_example" // String | The BANKID identifier
let oBPv400CreateSettlementAccountRequest = OBPv4_0_0_createSettlementAccount_request(type: "type_example", properties: OBPv4_0_0_createSettlementAccount_request_properties(branchId: OBPv4_0_0_updateSystemLevelEndpointTag_request_properties_tag_name(type: "type_example"), accountRoutings: OBPv3_1_0_getCheckbookOrders_200_response_properties_account_properties_account_routings(type: "type_example", items: OBPv3_1_0_getCheckbookOrders_200_response_properties_account_properties_account_routings_items(type: "type_example", properties: OBPv3_1_0_getCheckbookOrders_200_response_properties_account_properties_account_routings_items_properties(address: nil, scheme: nil))), label: nil, balance: OBPv5_0_0_getMyCustomersAtBank_200_response_properties_customers_items_properties_credit_limit(type: "type_example", properties: OBPv5_0_0_getMyCustomersAtBank_200_response_properties_customers_items_properties_credit_limit_properties(currency: nil, amount: nil)), paymentSystem: nil, userId: nil)) // OBPv400CreateSettlementAccountRequest | Request body

// Create Settlement Account
BankAPI.oBPv400CreateSettlementAccount(bankid: bankid, oBPv400CreateSettlementAccountRequest: oBPv400CreateSettlementAccountRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create system level Account Notification Webhook
BankAPI.oBPv400CreateSystemAccountNotificationWebhook(oBPv400CreateSystemAccountNotificationWebhookRequest: oBPv400CreateSystemAccountNotificationWebhookRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Delete Bank Attribute
BankAPI.oBPv400DeleteBankAttribute(bankid: bankid, bankattributeid: bankattributeid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv400DeleteBankCascade(bankid: String, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
// Delete Bank Cascade
BankAPI.oBPv400DeleteBankCascade(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Bank Attribute By BANK_ATTRIBUTE_ID
BankAPI.oBPv400GetBankAttribute(bankid: bankid, bankattributeid: bankattributeid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Bank Attributes
BankAPI.oBPv400GetBankAttributes(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Settlement accounts at Bank
BankAPI.oBPv400GetSettlementAccounts(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Update Bank Attribute
BankAPI.oBPv400UpdateBankAttribute(bankid: bankid, bankattributeid: bankattributeid, oBPv510UpdateAtmAttributeRequest: oBPv510UpdateAtmAttributeRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **oBPv500UpdateBank**
```swift
    open class func oBPv500UpdateBank(oBPv500UpdateBankRequest: OBPv500UpdateBankRequest, completion: @escaping (_ data: OBPv500UpdateBank200Response?, _ error: Error?) -> Void)
```
...
let oBPv500UpdateBankRequest = OBPv5_0_0_updateBank_request(type: "type_example", properties: OBPv5_0_0_updateBank_request_properties(bankRoutings: OBPv3_1_0_getCheckbookOrders_200_response_properties_account_properties_account_routings(type: "type_example", items: OBPv3_1_0_getCheckbookOrders_200_response_properties_account_properties_account_routings_items(type: "type_example", properties: OBPv3_1_0_getCheckbookOrders_200_response_properties_account_properties_account_routings_items_properties(address: OBPv4_0_0_updateSystemLevelEndpointTag_request_properties_tag_name(type: "type_example"), scheme: nil))), website: nil, fullName: nil, logo: nil, id: nil, bankCode: nil)) // OBPv500UpdateBankRequest | Request body

// Update Bank
BankAPI.oBPv500UpdateBank(oBPv500UpdateBankRequest: oBPv500UpdateBankRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **oBPv600CreateBank**
```swift
    open class func oBPv600CreateBank(oBPv600CreateBankRequest: OBPv600CreateBankRequest, completion: @escaping (_ data: OBPv600GetBank200Response?, _ error: Error?) -> Void)
```
...
let oBPv600CreateBankRequest = OBPv6_0_0_createBank_request(type: "type_example", properties: OBPv6_0_0_createBank_request_properties(bankRoutings: OBPv3_1_0_getCheckbookOrders_200_response_properties_account_properties_account_routings(type: "type_example", items: OBPv3_1_0_getCheckbookOrders_200_response_properties_account_properties_account_routings_items(type: "type_example", properties: OBPv3_1_0_getCheckbookOrders_200_response_properties_account_properties_account_routings_items_properties(address: OBPv4_0_0_updateSystemLevelEndpointTag_request_properties_tag_name(type: "type_example"), scheme: nil))), website: nil, fullName: nil, logo: nil, bankId: nil, bankCode: nil)) // OBPv600CreateBankRequest | Request body

// Create Bank
BankAPI.oBPv600CreateBank(oBPv600CreateBankRequest: oBPv600CreateBankRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Bank
BankAPI.oBPv600GetBank(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Banks
BankAPI.oBPv600GetBanks() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
