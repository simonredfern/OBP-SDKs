...
# **oBPv130GetCards**
```swift
    open class func oBPv130GetCards(completion: @escaping (_ data: OBPv130GetCards200Response?, _ error: Error?) -> Void)
```
...
// Get cards for the current user
CardAPI.oBPv130GetCards() { (response, error) in
...
// Create Card Attribute
CardAPI.oBPv310CreateCardAttribute(bankid: bankid, cardid: cardid, oBPv600CreatePersonalDataFieldRequest: oBPv600CreatePersonalDataFieldRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv310DeleteCardForBank(bankid: String, cardid: String, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
// Delete Card
CardAPI.oBPv310DeleteCardForBank(bankid: bankid, cardid: cardid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv310GetCardForBank(bankid: String, cardid: String, completion: @escaping (_ data: OBPv310GetCardForBank200Response?, _ error: Error?) -> Void)
```
...
// Get Card By Id
CardAPI.oBPv310GetCardForBank(bankid: bankid, cardid: cardid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv310GetCardsForBank(bankid: String, completion: @escaping (_ data: OBPv310GetCardsForBank200Response?, _ error: Error?) -> Void)
```
...
// Get Cards for the specified bank
CardAPI.oBPv310GetCardsForBank(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv310GetStatusOfCreditCardOrder(bankid: String, accountid: String, viewid: String, completion: @escaping (_ data: OBPv310GetStatusOfCreditCardOrder200Response?, _ error: Error?) -> Void)
```
...
// Get status of Credit Card order 
CardAPI.oBPv310GetStatusOfCreditCardOrder(bankid: bankid, accountid: accountid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Update Card Attribute
CardAPI.oBPv310UpdateCardAttribute(bankid: bankid, cardid: cardid, cardattributeid: cardattributeid, oBPv600CreatePersonalDataFieldRequest: oBPv600CreatePersonalDataFieldRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv310UpdatedCardForBank(bankid: String, cardid: String, oBPv310UpdatedCardForBankRequest: OBPv310UpdatedCardForBankRequest, completion: @escaping (_ data: OBPv310GetCardsForBank200ResponsePropertiesCardsItems?, _ error: Error?) -> Void)
```
...
let bankid = "bankid_example" // String | The BANKID identifier
let cardid = "cardid_example" // String | The CARDID identifier
let oBPv310UpdatedCardForBankRequest = OBPv3_1_0_updatedCardForBank_request(type: "type_example", properties: OBPv3_1_0_updatedCardForBank_request_properties(allows: OBPv6_0_0_getActiveRateLimitsAtDate_200_response_properties_considered_rate_limit_ids(type: "type_example", items: OBPv4_0_0_updateSystemLevelEndpointTag_request_properties_tag_name(type: "type_example")), expiresDate: OBPv6_0_0_updateRateLimits_request_properties_from_date(type: "type_example", format: "format_example"), networks: nil, customerId: nil, issueNumber: nil, replacement: OBPv3_1_0_getCardsForBank_200_response_properties_cards_items_properties_replacement(type: "type_example", properties: OBPv3_1_0_getCardsForBank_200_response_properties_cards_items_properties_replacement_properties(reasonRequested: nil, requestedDate: nil)), enabled: nil, collected: nil, technology: nil, accountId: nil, pinReset: OBPv3_1_0_getCardsForBank_200_response_properties_cards_items_properties_pin_reset(type: "type_example", items: nil), serialNumber: nil, validFromDate: nil, nameOnCard: nil, posted: nil, cardType: nil)) // OBPv310UpdatedCardForBankRequest | Request body

// Update Card
CardAPI.oBPv310UpdatedCardForBank(bankid: bankid, cardid: cardid, oBPv310UpdatedCardForBankRequest: oBPv310UpdatedCardForBankRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create or Update Card Attribute Definition
CardAPI.oBPv400CreateOrUpdateCardAttributeDefinition(bankid: bankid, oBPv400CreateOrUpdateTransactionRequestAttributeDefinitionRequest: oBPv400CreateOrUpdateTransactionRequestAttributeDefinitionRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Delete Card Attribute Definition
CardAPI.oBPv400DeleteCardAttributeDefinition(bankid: bankid, attributedefinitionid: attributedefinitionid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Card Attribute Definition
CardAPI.oBPv400GetCardAttributeDefinition(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func oBPv500AddCardForBank(bankid: String, oBPv500AddCardForBankRequest: OBPv500AddCardForBankRequest, completion: @escaping (_ data: OBPv500AddCardForBank200Response?, _ error: Error?) -> Void)
```
...
let bankid = "bankid_example" // String | The BANKID identifier
let oBPv500AddCardForBankRequest = OBPv5_0_0_addCardForBank_request(type: "type_example", properties: OBPv5_0_0_addCardForBank_request_properties(allows: OBPv6_0_0_getActiveRateLimitsAtDate_200_response_properties_considered_rate_limit_ids(type: "type_example", items: OBPv4_0_0_updateSystemLevelEndpointTag_request_properties_tag_name(type: "type_example")), expiresDate: OBPv6_0_0_updateRateLimits_request_properties_from_date(type: "type_example", format: "format_example"), networks: nil, customerId: nil, issueNumber: nil, replacement: OBPv3_1_0_getCardsForBank_200_response_properties_cards_items_properties_replacement(type: "type_example", properties: OBPv3_1_0_getCardsForBank_200_response_properties_cards_items_properties_replacement_properties(reasonRequested: nil, requestedDate: nil)), enabled: nil, collected: nil, brand: nil, cardNumber: nil, technology: nil, accountId: nil, pinReset: OBPv3_1_0_getCardsForBank_200_response_properties_cards_items_properties_pin_reset(type: "type_example", items: nil), serialNumber: nil, validFromDate: nil, nameOnCard: nil, posted: nil, cardType: nil)) // OBPv500AddCardForBankRequest | Request body

// Create Card
CardAPI.oBPv500AddCardForBank(bankid: bankid, oBPv500AddCardForBankRequest: oBPv500AddCardForBankRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
