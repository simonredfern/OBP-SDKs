...
// Get Transaction Types at Bank
AccountInformationServiceAISAPI.oBPv200GetTransactionTypes(bankid: bankid) { (response, error) in
...
// Get Accounts at all Banks (private)
AccountInformationServiceAISAPI.oBPv300CorePrivateAccountsAllBanks() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Accounts Held
AccountInformationServiceAISAPI.oBPv300GetAccountsHeld(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Transactions for Account (Core)
AccountInformationServiceAISAPI.oBPv300GetCoreTransactionsForBankAccount(bankid: bankid, accountid: accountid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Accounts at Bank (IDs only)
AccountInformationServiceAISAPI.oBPv300GetPrivateAccountIdsbyBankId(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Accounts at Bank (Minimal)
AccountInformationServiceAISAPI.oBPv300PrivateAccountsAtOneBank(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Answer Consent Challenge
AccountInformationServiceAISAPI.oBPv310AnswerConsentChallenge(bankid: bankid, consentid: consentid, oBPv310AnswerConsentChallengeRequest: oBPv310AnswerConsentChallengeRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Consent (EMAIL)
AccountInformationServiceAISAPI.oBPv310CreateConsentEmail(bankid: bankid, email: email, oBPv310CreateConsentEmailRequest: oBPv310CreateConsentEmailRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Consent (IMPLICIT)
AccountInformationServiceAISAPI.oBPv310CreateConsentImplicit(bankid: bankid, implicit: implicit, oBPv510CreateConsentImplicitRequest: oBPv510CreateConsentImplicitRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Consent (SMS)
AccountInformationServiceAISAPI.oBPv310CreateConsentSms(bankid: bankid, sms: sms, oBPv310CreateConsentSmsRequest: oBPv310CreateConsentSmsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get JSON Web Key (JWK)
AccountInformationServiceAISAPI.oBPv310GetServerJWK() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Add User to a Consent
AccountInformationServiceAISAPI.oBPv400AddConsentUser(bankid: bankid, consentid: consentid, oBPv400AddConsentUserRequest: oBPv400AddConsentUserRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get My Consents Info
AccountInformationServiceAISAPI.oBPv400GetConsentInfos() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get My Consents Info At Bank
AccountInformationServiceAISAPI.oBPv400GetConsentInfosByBank(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Update Consent Status
AccountInformationServiceAISAPI.oBPv400UpdateConsentStatus(bankid: bankid, consentid: consentid, oBPv510UpdateTransactionRequestStatusRequest: oBPv510UpdateTransactionRequestStatusRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Consent By CONSENT_REQUEST_ID (EMAIL)
AccountInformationServiceAISAPI.oBPv500CreateConsentByConsentRequestIdEmail(consentrequestid: consentrequestid, email: email) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Consent By CONSENT_REQUEST_ID (IMPLICIT)
AccountInformationServiceAISAPI.oBPv500CreateConsentByConsentRequestIdImplicit(consentrequestid: consentrequestid, implicit: implicit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Consent By CONSENT_REQUEST_ID (SMS)
AccountInformationServiceAISAPI.oBPv500CreateConsentByConsentRequestIdSms(consentrequestid: consentrequestid, sms: sms) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Consent Request
AccountInformationServiceAISAPI.oBPv500CreateConsentRequest(oBPv500CreateConsentRequestRequest: oBPv500CreateConsentRequestRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Consent By Consent Request Id via Consumer
AccountInformationServiceAISAPI.oBPv500GetConsentByConsentRequestId(consentrequestid: consentrequestid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Consent Request
AccountInformationServiceAISAPI.oBPv500GetConsentRequest(consentrequestid: consentrequestid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Consent (IMPLICIT)
AccountInformationServiceAISAPI.oBPv510CreateConsentImplicit(implicit: implicit, oBPv510CreateConsentImplicitRequest: oBPv510CreateConsentImplicitRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Account Balances by BANK_ID and ACCOUNT_ID through the VIEW_ID
AccountInformationServiceAISAPI.oBPv510GetBankAccountBalances(bankid: bankid, accountid: accountid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Account Balances by BANK_ID
AccountInformationServiceAISAPI.oBPv510GetBankAccountsBalances(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Account Balances by BANK_ID through the VIEW_ID
AccountInformationServiceAISAPI.oBPv510GetBankAccountsBalancesThroughView(bankid: bankid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Consent By Consent Id via User
AccountInformationServiceAISAPI.oBPv510GetConsentByConsentId(consentid: consentid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Consent By Consent Id via Consumer
AccountInformationServiceAISAPI.oBPv510GetConsentByConsentIdViaConsumer(consentid: consentid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Consents
AccountInformationServiceAISAPI.oBPv510GetConsents() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Consents at Bank
AccountInformationServiceAISAPI.oBPv510GetConsentsAtBank(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Account by Id (Core) through the VIEW_ID
AccountInformationServiceAISAPI.oBPv510GetCoreAccountByIdThroughView(bankid: bankid, accountid: accountid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get My Consents
AccountInformationServiceAISAPI.oBPv510GetMyConsents() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get My Consents at Bank
AccountInformationServiceAISAPI.oBPv510GetMyConsentsByBank(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Provide client's certificate info of a current call
AccountInformationServiceAISAPI.oBPv510MtlsClientCertificateInfo() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Revoke Consent at Bank
AccountInformationServiceAISAPI.oBPv510RevokeConsentAtBank(bankid: bankid, consentid: consentid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Revoke My Consent
AccountInformationServiceAISAPI.oBPv510RevokeMyConsent(consentid: consentid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Revoke Consent used in the Current Call
AccountInformationServiceAISAPI.oBPv510SelfRevokeConsent() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Update Consent Account Access by CONSENT_ID
AccountInformationServiceAISAPI.oBPv510UpdateConsentAccountAccessByConsentId(bankid: bankid, consentid: consentid, oBPv510UpdateConsentAccountAccessByConsentIdRequest: oBPv510UpdateConsentAccountAccessByConsentIdRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Update Consent Status by CONSENT_ID
AccountInformationServiceAISAPI.oBPv510UpdateConsentStatusByConsent(bankid: bankid, consentid: consentid, oBPv510UpdateTransactionRequestStatusRequest: oBPv510UpdateTransactionRequestStatusRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Update Created by User of Consent by CONSENT_ID
AccountInformationServiceAISAPI.oBPv510UpdateConsentUserIdByConsentId(bankid: bankid, consentid: consentid, oBPv400AddConsentUserRequest: oBPv400AddConsentUserRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Bank
AccountInformationServiceAISAPI.oBPv600GetBank(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Banks
AccountInformationServiceAISAPI.oBPv600GetBanks() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Account by Id (Core)
AccountInformationServiceAISAPI.oBPv600GetCoreAccountByIdV600(bankid: bankid, accountid: accountid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
