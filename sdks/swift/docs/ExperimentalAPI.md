...
// Create Meeting (video conference/call)
ExperimentalAPI.oBPv310CreateMeeting(bankid: bankid, oBPv310CreateMeetingRequest: oBPv310CreateMeetingRequest) { (response, error) in
...
// Get Meeting
ExperimentalAPI.oBPv310GetMeeting(bankid: bankid, meetingid: meetingid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Meetings
ExperimentalAPI.oBPv310GetMeetings(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
