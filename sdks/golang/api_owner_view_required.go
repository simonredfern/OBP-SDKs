...
// OwnerViewRequiredAPIService OwnerViewRequiredAPI service
type OwnerViewRequiredAPIService service

type ApiOBPv510CreateUserWithAccountAccessByIdRequest struct {
	ctx context.Context
	ApiService *OwnerViewRequiredAPIService
	bankid string
	accountid string
	viewid string
...
*/
func (a *OwnerViewRequiredAPIService) OBPv510CreateUserWithAccountAccessById(ctx context.Context, bankid string, accountid string, viewid string) ApiOBPv510CreateUserWithAccountAccessByIdRequest {
	return ApiOBPv510CreateUserWithAccountAccessByIdRequest{
		ApiService: a,
		ctx: ctx,
		bankid: bankid,
...
func (a *OwnerViewRequiredAPIService) OBPv510CreateUserWithAccountAccessByIdExecute(r ApiOBPv510CreateUserWithAccountAccessByIdRequest) (*OBPv510CreateUserWithAccountAccessById200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OwnerViewRequiredAPIService.OBPv510CreateUserWithAccountAccessById")
	if err != nil {
...
*/
func (a *OwnerViewRequiredAPIService) OBPv510GrantUserAccessToViewById(ctx context.Context, bankid string, accountid string, viewid string) ApiOBPv510GrantUserAccessToViewByIdRequest {
	return ApiOBPv510GrantUserAccessToViewByIdRequest{
		ApiService: a,
		ctx: ctx,
		bankid: bankid,
...
func (a *OwnerViewRequiredAPIService) OBPv510GrantUserAccessToViewByIdExecute(r ApiOBPv510GrantUserAccessToViewByIdRequest) (*OBPv510CreateUserWithAccountAccessById200ResponsePropertiesHead, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OwnerViewRequiredAPIService.OBPv510GrantUserAccessToViewById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *OwnerViewRequiredAPIService) OBPv510RevokeUserAccessToViewById(ctx context.Context, bankid string, accountid string, viewid string) ApiOBPv510RevokeUserAccessToViewByIdRequest {
	return ApiOBPv510RevokeUserAccessToViewByIdRequest{
		ApiService: a,
		ctx: ctx,
		bankid: bankid,
...
func (a *OwnerViewRequiredAPIService) OBPv510RevokeUserAccessToViewByIdExecute(r ApiOBPv510RevokeUserAccessToViewByIdRequest) (*OBPv510RevokeUserAccessToViewById200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OwnerViewRequiredAPIService.OBPv510RevokeUserAccessToViewById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
