...
*/
func (a *OAuthAPIService) OBPv310GetOAuth2ServerJWKsURIs(ctx context.Context) ApiOBPv310GetOAuth2ServerJWKsURIsRequest {
	return ApiOBPv310GetOAuth2ServerJWKsURIsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *OAuthAPIService) OBPv310GetOAuth2ServerJWKsURIsExecute(r ApiOBPv310GetOAuth2ServerJWKsURIsRequest) (*OBPv310GetOAuth2ServerJWKsURIs200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OAuthAPIService.OBPv310GetOAuth2ServerJWKsURIs")
	if err != nil {
...
*/
func (a *OAuthAPIService) OBPv310GetObpConnectorLoopback(ctx context.Context) ApiOBPv310GetObpConnectorLoopbackRequest {
	return ApiOBPv310GetObpConnectorLoopbackRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *OAuthAPIService) OBPv310GetObpConnectorLoopbackExecute(r ApiOBPv310GetObpConnectorLoopbackRequest) (*OBPv310GetObpConnectorLoopback200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OAuthAPIService.OBPv310GetObpConnectorLoopback")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *OAuthAPIService) OBPv600GetOidcClient(ctx context.Context, clientid string) ApiOBPv600GetOidcClientRequest {
	return ApiOBPv600GetOidcClientRequest{
		ApiService: a,
		ctx: ctx,
		clientid: clientid,
...
func (a *OAuthAPIService) OBPv600GetOidcClientExecute(r ApiOBPv600GetOidcClientRequest) (*OBPv600GetOidcClient200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OAuthAPIService.OBPv600GetOidcClient")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *OAuthAPIService) OBPv600VerifyOidcClient(ctx context.Context) ApiOBPv600VerifyOidcClientRequest {
	return ApiOBPv600VerifyOidcClientRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *OAuthAPIService) OBPv600VerifyOidcClientExecute(r ApiOBPv600VerifyOidcClientRequest) (*OBPv600VerifyOidcClient200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OAuthAPIService.OBPv600VerifyOidcClient")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
