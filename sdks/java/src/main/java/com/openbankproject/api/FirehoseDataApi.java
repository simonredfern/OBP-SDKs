...
public class FirehoseDataApi {
  ...
  public FirehoseDataApi() {
    this(Configuration.getDefaultApiClient());
  }

  public FirehoseDataApi(ApiClient apiClient) {
   ...
   * @throws ApiException if fails to make API call
   */
  public OBPv500GetMyCustomersAtBank200Response oBPv310GetFirehoseCustomers(@javax.annotation.Nonnull String bankid) throws ApiException {
    return oBPv310GetFirehoseCustomers(bankid, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public OBPv500GetMyCustomersAtBank200Response oBPv310GetFirehoseCustomers(@javax.annotation.Nonnull String bankid, Map<String, String> headers) throws ApiException {
    ApiResponse<OBPv500GetMyCustomersAtBank200Response> localVarResponse = oBPv310GetFirehoseCustomersWithHttpInfo(bankid, headers);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<OBPv500GetMyCustomersAtBank200Response> oBPv310GetFirehoseCustomersWithHttpInfo(@javax.annotation.Nonnull String bankid) throws ApiException {
    return oBPv310GetFirehoseCustomersWithHttpInfo(bankid, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<OBPv500GetMyCustomersAtBank200Response> oBPv310GetFirehoseCustomersWithHttpInfo(@javax.annotation.Nonnull String bankid, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = oBPv310GetFirehoseCustomersRequestBuilder(bankid, headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("oBPv310GetFirehoseCustomers", localVarResponse);
        }
        localVarResponseBody = ApiClient.getResponseBody(localVarResponse);
        if (localVarResponseBody == null) {
          return new ApiResponse<OBPv500GetMyCustomersAtBank200Response>(
              localVarResponse.statusCode(),
              localVarResponse.headers().map(),
              null
          );
        ...
        String responseBody = new String(localVarResponseBody.readAllBytes());
        OBPv500GetMyCustomersAtBank200Response responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<OBPv500GetMyCustomersAtBank200Response>() {});
  ...
  private HttpRequest.Builder oBPv310GetFirehoseCustomersRequestBuilder(@javax.annotation.Nonnull String bankid, Map<String, String> headers) throws ApiException {
    // verify the required parameter 'bankid' is set
    if (bankid == null) {
      throw new ApiException(400, "Missing the required parameter 'bankid' when calling oBPv310GetFirehoseCustomers");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/obp/v3.1.0/banks/{bankid}/firehose/customers"
        .replace("{bankid}", ApiClient.urlEncode(bankid.toString()));
