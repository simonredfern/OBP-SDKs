...
/**
 * API tests for AggregateMetricsApi
 */
@Disabled
public class AggregateMetricsApiTest {

    private final AggregateMetricsApi api = new AggregateMetricsApi();
     ...
     */
    @Test
    public void oBPv600GetAggregateMetricsTest() throws ApiException {
        OBPv600GetAggregateMetrics200Response response = 
        api.oBPv600GetAggregateMetrics();
