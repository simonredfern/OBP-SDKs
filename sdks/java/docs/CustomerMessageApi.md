...
| [**oBPv140AddCustomerMessageWithHttpInfo**](CustomerMessageApi.md#oBPv140AddCustomerMessageWithHttpInfo) | **POST** /obp/v1.4.0/banks/{bankid}/customer/{customerid}/messages | Create Customer Message |
...
| [**oBPv140GetCustomersMessagesWithHttpInfo**](CustomerMessageApi.md#oBPv140GetCustomersMessagesWithHttpInfo) | **GET** /obp/v1.4.0/banks/{bankid}/customer/messages | Get Customer Messages for all Customers |
...
| [**oBPv400CreateCustomerMessageWithHttpInfo**](CustomerMessageApi.md#oBPv400CreateCustomerMessageWithHttpInfo) | **POST** /obp/v4.0.0/banks/{bankid}/customers/{customerid}/messages | Create Customer Message |
...
| [**oBPv400GetCustomerMessagesWithHttpInfo**](CustomerMessageApi.md#oBPv400GetCustomerMessagesWithHttpInfo) | **GET** /obp/v4.0.0/banks/{bankid}/customers/{customerid}/messages | Get Customer Messages for a Customer |
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling CustomerMessageApi#oBPv140AddCustomerMessage");
...
public class Example {
    public static void main(String[] args) {
        ...
        String bankid = "bankid_example"; // String | The BANKID identifier
        try {
            OBPv140GetCustomersMessages200Response result = apiInstance.oBPv140GetCustomersMessages(bankid);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling CustomerMessageApi#oBPv140GetCustomersMessages");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## oBPv140GetCustomersMessagesWithHttpInfo

> ApiResponse<OBPv140GetCustomersMessages200Response> oBPv140GetCustomersMessages oBPv140GetCustomersMessagesWithHttpInfo(bankid)
...
public class Example {
    public static void main(String[] args) {
        ...
        String bankid = "bankid_example"; // String | The BANKID identifier
        try {
            ApiResponse<OBPv140GetCustomersMessages200Response> response = apiInstance.oBPv140GetCustomersMessagesWithHttpInfo(bankid);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
ApiResponse<[**OBPv140GetCustomersMessages200Response**](OBPv140GetCustomersMessages200Response.md)>
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling CustomerMessageApi#oBPv400CreateCustomerMessage");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        String customerid = "customerid_example"; // String | The CUSTOMERID identifier
        try {
            OBPv400GetCustomerMessages200Response result = apiInstance.oBPv400GetCustomerMessages(bankid, customerid);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling CustomerMessageApi#oBPv400GetCustomerMessages");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## oBPv400GetCustomerMessagesWithHttpInfo

> ApiResponse<OBPv400GetCustomerMessages200Response> oBPv400GetCustomerMessages oBPv400GetCustomerMessagesWithHttpInfo(bankid, customerid)
...
public class Example {
    public static void main(String[] args) {
        ...
        String customerid = "customerid_example"; // String | The CUSTOMERID identifier
        try {
            ApiResponse<OBPv400GetCustomerMessages200Response> response = apiInstance.oBPv400GetCustomerMessagesWithHttpInfo(bankid, customerid);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
ApiResponse<[**OBPv400GetCustomerMessages200Response**](OBPv400GetCustomerMessages200Response.md)>
