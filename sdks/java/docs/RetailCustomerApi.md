...
| [**oBPv600CreateRetailCustomerWithHttpInfo**](RetailCustomerApi.md#oBPv600CreateRetailCustomerWithHttpInfo) | **POST** /obp/v6.0.0/banks/{bankid}/retail-customers | Create Retail Customer |
...
| [**oBPv600GetRetailCustomerByCustomerIdWithHttpInfo**](RetailCustomerApi.md#oBPv600GetRetailCustomerByCustomerIdWithHttpInfo) | **GET** /obp/v6.0.0/banks/{bankid}/retail-customers/{customerid} | Get Retail Customer by CUSTOMER_ID |
...
| [**oBPv600GetRetailCustomersAtOneBankWithHttpInfo**](RetailCustomerApi.md#oBPv600GetRetailCustomersAtOneBankWithHttpInfo) | **GET** /obp/v6.0.0/banks/{bankid}/retail-customers | Get Retail Customers at Bank |
...
import com.openbankproject.api.RetailCustomerApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        RetailCustomerApi apiInstance = new RetailCustomerApi(defaultClient);
        String bankid = "bankid_example"; // String | The BANKID identifier
        OBPv600CreateRetailCustomerRequest obPv600CreateRetailCustomerRequest = new OBPv600CreateRetailCustomerRequest(); // OBPv600CreateRetailCustomerRequest | Request body
        try {
            OBPv600GetCustomerChildren200ResponsePropertiesCustomersItems result = apiInstance.oBPv600CreateRetailCustomer(bankid, obPv600CreateRetailCustomerRequest);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling RetailCustomerApi#oBPv600CreateRetailCustomer");
...
## oBPv600CreateRetailCustomerWithHttpInfo

> ApiResponse<OBPv600GetCustomerChildren200ResponsePropertiesCustomersItems> oBPv600CreateRetailCustomer oBPv600CreateRetailCustomerWithHttpInfo(bankid, obPv600CreateRetailCustomerRequest)
...
public class Example {
    public static void main(String[] args) {
        ...
        OBPv600CreateRetailCustomerRequest obPv600CreateRetailCustomerRequest = new OBPv600CreateRetailCustomerRequest(); // OBPv600CreateRetailCustomerRequest | Request body
        try {
            ApiResponse<OBPv600GetCustomerChildren200ResponsePropertiesCustomersItems> response = apiInstance.oBPv600CreateRetailCustomerWithHttpInfo(bankid, obPv600CreateRetailCustomerRequest);
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            OBPv600GetCustomerByCustomerNumber200Response result = apiInstance.oBPv600GetRetailCustomerByCustomerId(bankid, customerid);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling RetailCustomerApi#oBPv600GetRetailCustomerByCustomerId");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## oBPv600GetRetailCustomerByCustomerIdWithHttpInfo

> ApiResponse<OBPv600GetCustomerByCustomerNumber200Response> oBPv600GetRetailCustomerByCustomerId oBPv600GetRetailCustomerByCustomerIdWithHttpInfo(bankid, customerid)
...
public class Example {
    public static void main(String[] args) {
        ...
        String customerid = "customerid_example"; // String | The CUSTOMERID identifier
        try {
            ApiResponse<OBPv600GetCustomerByCustomerNumber200Response> response = apiInstance.oBPv600GetRetailCustomerByCustomerIdWithHttpInfo(bankid, customerid);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
ApiResponse<[**OBPv600GetCustomerByCustomerNumber200Response**](OBPv600GetCustomerByCustomerNumber200Response.md)>
...
public class Example {
    public static void main(String[] args) {
        ...
        String bankid = "bankid_example"; // String | The BANKID identifier
        try {
            OBPv600GetCustomerChildren200Response result = apiInstance.oBPv600GetRetailCustomersAtOneBank(bankid);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling RetailCustomerApi#oBPv600GetRetailCustomersAtOneBank");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## oBPv600GetRetailCustomersAtOneBankWithHttpInfo

> ApiResponse<OBPv600GetCustomerChildren200Response> oBPv600GetRetailCustomersAtOneBank oBPv600GetRetailCustomersAtOneBankWithHttpInfo(bankid)
...
public class Example {
    public static void main(String[] args) {
        ...
        String bankid = "bankid_example"; // String | The BANKID identifier
        try {
            ApiResponse<OBPv600GetCustomerChildren200Response> response = apiInstance.oBPv600GetRetailCustomersAtOneBankWithHttpInfo(bankid);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
