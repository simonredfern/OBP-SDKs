...
| [**oBPv300GetFirehoseTransactionsForBankAccountWithHttpInfo**](TransactionFirehoseApi.md#oBPv300GetFirehoseTransactionsForBankAccountWithHttpInfo) | **GET** /obp/v3.0.0/banks/{bankid}/firehose/accounts/{accountid}/views/{viewid}/transactions | Get Firehose Transactions for Account |
...
import com.openbankproject.api.TransactionFirehoseApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        TransactionFirehoseApi apiInstance = new TransactionFirehoseApi(defaultClient);
        ...
        try {
            ...
            System.err.println("Exception when calling TransactionFirehoseApi#oBPv300GetFirehoseTransactionsForBankAccount");
