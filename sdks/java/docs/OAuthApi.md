...
| [**oBPv310GetOAuth2ServerJWKsURIsWithHttpInfo**](OAuthApi.md#oBPv310GetOAuth2ServerJWKsURIsWithHttpInfo) | **GET** /obp/v3.1.0/jwks-uris | Get JSON Web Key (JWK) URIs |
...
| [**oBPv310GetObpConnectorLoopbackWithHttpInfo**](OAuthApi.md#oBPv310GetObpConnectorLoopbackWithHttpInfo) | **GET** /obp/v3.1.0/connector/loopback | Get Connector Status (Loopback) |
| [**oBPv600GetOidcClient**](OAuthApi.md#oBPv600GetOidcClient) | **GET** /obp/v6.0.0/oidc/clients/{clientid} | Get OIDC Client |
| [**oBPv600GetOidcClientWithHttpInfo**](OAuthApi.md#oBPv600GetOidcClientWithHttpInfo) | **GET** /obp/v6.0.0/oidc/clients/{clientid} | Get OIDC Client |
| [**oBPv600VerifyOidcClient**](OAuthApi.md#oBPv600VerifyOidcClient) | **POST** /obp/v6.0.0/oidc/clients/verify | Verify OIDC Client |
| [**oBPv600VerifyOidcClientWithHttpInfo**](OAuthApi.md#oBPv600VerifyOidcClientWithHttpInfo) | **POST** /obp/v6.0.0/oidc/clients/verify | Verify OIDC Client |
...
import com.openbankproject.api.OAuthApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling OAuthApi#oBPv310GetOAuth2ServerJWKsURIs");
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling OAuthApi#oBPv310GetObpConnectorLoopback");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling OAuthApi#oBPv600GetOidcClient");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling OAuthApi#oBPv600VerifyOidcClient");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
