...
import {
    ...
    OBPv210SandboxDataImportRequestFromJSON,
    OBPv210SandboxDataImportRequestToJSON,
} from '../models/index';

export interface OBPv210SandboxDataImportOperationRequest {
...
export class SandboxApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for oBPv210SandboxDataImport without sending the request
     */
    async oBPv210SandboxDataImportRequestOpts(requestParameters: OBPv210SandboxDataImportOperationRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['oBPv210SandboxDataImportRequest'] == null) {
            throw new runtime.RequiredError(
                'oBPv210SandboxDataImportRequest',
                'Required parameter "oBPv210SandboxDataImportRequest" was null or undefined when calling oBPv210SandboxDataImport().'
            );
        }
        ...
        let urlPath = `/obp/v2.1.0/sandbox/data-import`;
        ...
        return {
            ...
            body: OBPv210SandboxDataImportRequestToJSON(requestParameters['oBPv210SandboxDataImportRequest']),
        };
    }
     ...
     * Create sandbox
     */
    async oBPv210SandboxDataImportRaw(requestParameters: OBPv210SandboxDataImportOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OBPv121UpdateTransactionNarrative200Response>> {
        const requestOptions = await this.oBPv210SandboxDataImportRequestOpts(requestParameters);
     ...
     * Create sandbox
     */
    async oBPv210SandboxDataImport(requestParameters: OBPv210SandboxDataImportOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OBPv121UpdateTransactionNarrative200Response> {
        const response = await this.oBPv210SandboxDataImportRaw(requestParameters, initOverrides);
