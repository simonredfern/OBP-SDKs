...
```typescript
import type { OBPv600CreateOrUpdateApiProductRequestProperties } from 'obp-typescript'
...
} satisfies OBPv600CreateOrUpdateApiProductRequestProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv600CreateOrUpdateApiProductRequestProperties
