...
```typescript
import type { OBPv600CreatePersonalDataFieldRequestProperties } from 'obp-typescript'
...
const example = {
  ...
  "type": null,
  "value": null,
} satisfies OBPv600CreatePersonalDataFieldRequestProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv600CreatePersonalDataFieldRequestProperties
