...
```typescript
import type { OBPv600GetBankLevelDynamicEntities200ResponsePropertiesDynamicEntitiesItemsProperties } from 'obp-typescript'
...
} satisfies OBPv600GetBankLevelDynamicEntities200ResponsePropertiesDynamicEntitiesItemsProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv600GetBankLevelDynamicEntities200ResponsePropertiesDynamicEntitiesItemsProperties
