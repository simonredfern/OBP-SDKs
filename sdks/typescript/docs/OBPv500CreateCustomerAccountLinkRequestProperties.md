...
`relationshipType` | [OBPv400UpdateSystemLevelEndpointTagRequestPropertiesTagName](OBPv400UpdateSystemLevelEndpointTagRequestPropertiesTagName.md)

## Example

```typescript
import type { OBPv500CreateCustomerAccountLinkRequestProperties } from 'obp-typescript'
...
} satisfies OBPv500CreateCustomerAccountLinkRequestProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv500CreateCustomerAccountLinkRequestProperties
