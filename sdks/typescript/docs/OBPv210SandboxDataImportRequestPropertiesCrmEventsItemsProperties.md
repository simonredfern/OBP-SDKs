...
`actualDate` | [OBPv600UpdateRateLimitsRequestPropertiesFromDate](OBPv600UpdateRateLimitsRequestPropertiesFromDate.md)

## Example

```typescript
import type { OBPv210SandboxDataImportRequestPropertiesCrmEventsItemsProperties } from 'obp-typescript'
...
const example = {
  ...
  "detail": null,
  "actualDate": null,
} satisfies OBPv210SandboxDataImportRequestPropertiesCrmEventsItemsProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv210SandboxDataImportRequestPropertiesCrmEventsItemsProperties
