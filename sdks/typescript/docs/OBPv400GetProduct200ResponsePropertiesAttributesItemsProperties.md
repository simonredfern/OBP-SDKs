...
`productAttributeId` | [OBPv400UpdateSystemLevelEndpointTagRequestPropertiesTagName](OBPv400UpdateSystemLevelEndpointTagRequestPropertiesTagName.md)
...
```typescript
import type { OBPv400GetProduct200ResponsePropertiesAttributesItemsProperties } from 'obp-typescript'
...
const example = {
  ...
  "type": null,
  "value": null,
} satisfies OBPv400GetProduct200ResponsePropertiesAttributesItemsProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv400GetProduct200ResponsePropertiesAttributesItemsProperties
