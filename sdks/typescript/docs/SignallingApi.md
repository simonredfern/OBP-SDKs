...
| [**oBPv600PublishSignalMessage**](SignallingApi.md#obpv600publishsignalmessageoperation) | **POST** /obp/v6.0.0/signal/channels/{channelname}/messages | Publish Signal Message |
...
async function example() {
  ...
  const api = new SignallingApi(config);
