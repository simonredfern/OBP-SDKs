...
import type { OBPv310CreateWebUiPropsRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    oBPv400CreateTransactionRequestCounterparty200ResponsePropertiesAttributesItems: {"type":"object","properties":{"name":{"type":"string"},"value":{"type":"string"}}},
  } satisfies OBPv310CreateWebUiPropsRequest;

  try {
    const data = await api.oBPv310CreateWebUiProps(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv310DeleteWebUiPropsRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    // string | The WEBUIPROPSID identifier
    webuipropsid: webuipropsid_example,
  } satisfies OBPv310DeleteWebUiPropsRequest;

  try {
    const data = await api.oBPv310DeleteWebUiProps(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **webuipropsid** | `string` | The WEBUIPROPSID identifier | [Defaults to `undefined`] |
...
import type { OBPv310GetWebUiPropsRequest } from 'obp-typescript';
...
async function example() {
  ...
  try {
    const data = await api.oBPv310GetWebUiProps();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv600CreateOrUpdateWebUiPropsRequest } from 'obp-typescript';
...
async function example() {
  ...
  } satisfies OBPv600CreateOrUpdateWebUiPropsRequest;

  try {
    const data = await api.oBPv600CreateOrUpdateWebUiProps(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv600DeleteWebUiPropsRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    // string | The WEBUIPROPNAME identifier
    webuipropname: webuipropname_example,
  } satisfies OBPv600DeleteWebUiPropsRequest;

  try {
    const data = await api.oBPv600DeleteWebUiProps(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv600GetWebUiPropRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    // string | The WEBUIPROPNAME identifier
    webuipropname: webuipropname_example,
  } satisfies OBPv600GetWebUiPropRequest;

  try {
    const data = await api.oBPv600GetWebUiProp(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv600GetWebUiPropsRequest } from 'obp-typescript';
...
async function example() {
  ...
  try {
    const data = await api.oBPv600GetWebUiProps();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
