...
```typescript
import type { OBPv500GetMetricsAtBank200ResponsePropertiesMetricsItemsProperties } from 'obp-typescript'
...
const example = {
  ...
  "appName": null,
  "userName": null,
} satisfies OBPv500GetMetricsAtBank200ResponsePropertiesMetricsItemsProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv500GetMetricsAtBank200ResponsePropertiesMetricsItemsProperties
