...
```typescript
import type { OBPv510CreateUserWithAccountAccessById200ResponseProperties } from 'obp-typescript'

// TODO: Update the object below with actual values
const example = {
  "head": null,
  "tl": null,
} satisfies OBPv510CreateUserWithAccountAccessById200ResponseProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv510CreateUserWithAccountAccessById200ResponseProperties
