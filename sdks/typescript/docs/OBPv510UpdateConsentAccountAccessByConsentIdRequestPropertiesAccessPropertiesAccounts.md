...
```typescript
import type { OBPv510UpdateConsentAccountAccessByConsentIdRequestPropertiesAccessPropertiesAccounts } from 'obp-typescript'

// TODO: Update the object below with actual values
const example = {
  "type": null,
  "items": null,
} satisfies OBPv510UpdateConsentAccountAccessByConsentIdRequestPropertiesAccessPropertiesAccounts
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv510UpdateConsentAccountAccessByConsentIdRequestPropertiesAccessPropertiesAccounts
