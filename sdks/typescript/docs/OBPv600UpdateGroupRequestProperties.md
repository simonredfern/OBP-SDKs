...
```typescript
import type { OBPv600UpdateGroupRequestProperties } from 'obp-typescript'
...
const example = {
  ...
  "listOfRoles": null,
  "isEnabled": null,
} satisfies OBPv600UpdateGroupRequestProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv600UpdateGroupRequestProperties
