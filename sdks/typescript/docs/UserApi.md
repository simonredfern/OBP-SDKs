...
| [**oBPv400CreateUserCustomerLinks**](UserApi.md#obpv400createusercustomerlinksoperation) | **POST** /obp/v4.0.0/banks/{bankid}/user_customer_links | Create User Customer Link |
| [**oBPv400CreateUserWithRoles**](UserApi.md#obpv400createuserwithrolesoperation) | **POST** /obp/v4.0.0/user-entitlements | Create (DAuth) User with Roles |
...
| [**oBPv510CreateUserWithAccountAccessById**](UserApi.md#obpv510createuserwithaccountaccessbyidoperation) | **POST** /obp/v5.1.0/banks/{bankid}/accounts/{accountid}/views/{viewid}/user-account-access | Create (DAuth) User with Account Access |
...
| [**oBPv510RevokeUserAccessToViewById**](UserApi.md#obpv510revokeuseraccesstoviewbyidoperation) | **POST** /obp/v5.1.0/banks/{bankid}/accounts/{accountid}/views/{viewid}/account-access/revoke | Revoke User access to View |
...
| [**oBPv600AddUserToGroup**](UserApi.md#obpv600addusertogroupoperation) | **POST** /obp/v6.0.0/users/{userid}/group-entitlements | Grant User Membership to Group Entitlements |
| [**oBPv600CreatePersonalDataField**](UserApi.md#obpv600createpersonaldatafieldoperation) | **POST** /obp/v6.0.0/my/personal-data-fields | Create Personal Data Field |
| [**oBPv600CreateUser**](UserApi.md#obpv600createuseroperation) | **POST** /obp/v6.0.0/users | Create User (v6.0.0) |
...
| [**oBPv600ResetPasswordComplete**](UserApi.md#obpv600resetpasswordcompleteoperation) | **POST** /obp/v6.0.0/users/password | Complete Password Reset |
| [**oBPv600ResetPasswordUrl**](UserApi.md#obpv600resetpasswordurloperation) | **POST** /obp/v6.0.0/management/user/reset-password-url | Create Password Reset URL and Send Email |
| [**oBPv600ResetPasswordUrlAnonymous**](UserApi.md#obpv600resetpasswordurlanonymousoperation) | **POST** /obp/v6.0.0/users/password-reset-url | Request Password Reset Email |
...
| [**oBPv600ValidateUserEmail**](UserApi.md#obpv600validateuseremailoperation) | **POST** /obp/v6.0.0/users/email-validation | Validate User Email |
| [**oBPv600VerifyUserCredentials**](UserApi.md#obpv600verifyusercredentialsoperation) | **POST** /obp/v6.0.0/users/verify-credentials | Verify User Credentials |
...
import type { OBPv200AddEntitlementRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    oBPv510GetMyConsentsByBank200ResponsePropertiesConsentsItemsPropertiesJwtPayloadPropertiesEntitlementsItems: {"type":"object","properties":{"bank_id":{"type":"string"},"role_name":{"type":"string"}}},
  } satisfies OBPv200AddEntitlementRequest;

  try {
    const data = await api.oBPv200AddEntitlement(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv200DeleteEntitlementRequest } from 'obp-typescript';
...
async function example() {
  ...
  } satisfies OBPv200DeleteEntitlementRequest;

  try {
    const data = await api.oBPv200DeleteEntitlement(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv210GetEntitlementsByBankAndUserRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // string | The USERID identifier
    userid: userid_example,
  } satisfies OBPv210GetEntitlementsByBankAndUserRequest;

  try {
    const data = await api.oBPv210GetEntitlementsByBankAndUser(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv300AddEntitlementRequestRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    // OBPv510GetMyConsentsByBank200ResponsePropertiesConsentsItemsPropertiesJwtPayloadPropertiesEntitlementsItems | Request body
    oBPv510GetMyConsentsByBank200ResponsePropertiesConsentsItemsPropertiesJwtPayloadPropertiesEntitlementsItems: {type=object, properties={bank_id={type=string}, role_name={type=string}}},
  } satisfies OBPv300AddEntitlementRequestRequest;

  try {
    const data = await api.oBPv300AddEntitlementRequest(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv300DeleteEntitlementRequestRequest } from 'obp-typescript';
...
async function example() {
  ...
  } satisfies OBPv300DeleteEntitlementRequestRequest;

  try {
    const data = await api.oBPv300DeleteEntitlementRequest(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv300GetAllEntitlementRequestsRequest } from 'obp-typescript';
...
async function example() {
  ...
  try {
    const data = await api.oBPv300GetAllEntitlementRequests();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv300GetEntitlementRequestsRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    // string | The USERID identifier
    userid: userid_example,
  } satisfies OBPv300GetEntitlementRequestsRequest;

  try {
    const data = await api.oBPv300GetEntitlementRequests(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv300GetEntitlementRequestsForCurrentUserRequest } from 'obp-typescript';
...
async function example() {
  ...
  try {
    const data = await api.oBPv300GetEntitlementRequestsForCurrentUser();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv300GetEntitlementsForCurrentUserRequest } from 'obp-typescript';
...
async function example() {
  ...
  try {
    const data = await api.oBPv300GetEntitlementsForCurrentUser();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv310DeleteUserAuthContextByIdRequest } from 'obp-typescript';
...
async function example() {
  ...
  } satisfies OBPv310DeleteUserAuthContextByIdRequest;

  try {
    const data = await api.oBPv310DeleteUserAuthContextById(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv310DeleteUserAuthContextsRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    // string | The USERID identifier
    userid: userid_example,
  } satisfies OBPv310DeleteUserAuthContextsRequest;

  try {
    const data = await api.oBPv310DeleteUserAuthContexts(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv310RefreshUserRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    // string | The USERID identifier
    userid: userid_example,
  } satisfies OBPv310RefreshUserRequest;

  try {
    const data = await api.oBPv310RefreshUser(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv400CreateUserWithRolesOperationRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    oBPv400CreateUserWithRolesRequest: {"type":"object","properties":{"roles":{"type":"array","items":{"type":"object","properties":{"bank_id":{"type":"string"},"role_name":{"type":"string"}}}},"provider":{"type":"string"},"username":{"type":"string"}}},
  } satisfies OBPv400CreateUserWithRolesOperationRequest;

  try {
    const data = await api.oBPv400CreateUserWithRoles(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv400DeleteUserRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    // string | The USERID identifier
    userid: userid_example,
  } satisfies OBPv400DeleteUserRequest;

  try {
    const data = await api.oBPv400DeleteUser(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv400GetCurrentUserIdRequest } from 'obp-typescript';
...
async function example() {
  ...
  try {
    const data = await api.oBPv400GetCurrentUserId();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv400GetEntitlementsRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    // string | The USERID identifier
    userid: userid_example,
  } satisfies OBPv400GetEntitlementsRequest;

  try {
    const data = await api.oBPv400GetEntitlements(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv400GetEntitlementsForBankRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    // string | The BANKID identifier
    bankid: bankid_example,
  } satisfies OBPv400GetEntitlementsForBankRequest;

  try {
    const data = await api.oBPv400GetEntitlementsForBank(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv400GetLogoutLinkRequest } from 'obp-typescript';
...
async function example() {
  ...
  try {
    const data = await api.oBPv400GetLogoutLink();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv400GetMySpacesRequest } from 'obp-typescript';
...
async function example() {
  ...
  try {
    const data = await api.oBPv400GetMySpaces();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv400GetUserByUserIdRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    // string | The USERID identifier
    userid: userid_example,
  } satisfies OBPv400GetUserByUserIdRequest;

  try {
    const data = await api.oBPv400GetUserByUserId(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv400GetUsersByEmailRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    email: email_example,
  } satisfies OBPv400GetUsersByEmailRequest;

  try {
    const data = await api.oBPv400GetUsersByEmail(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv500AnswerUserAuthContextUpdateChallengeRequest } from 'obp-typescript';
...
async function example() {
  ...
  } satisfies OBPv500AnswerUserAuthContextUpdateChallengeRequest;

  try {
    const data = await api.oBPv500AnswerUserAuthContextUpdateChallenge(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv500CreateUserAuthContextRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    oBPv400GetExplicitCounterpartyById200ResponsePropertiesBespokeItems: {type=object, properties={key={type=string}, value={type=string}}},
  } satisfies OBPv500CreateUserAuthContextRequest;

  try {
    const data = await api.oBPv500CreateUserAuthContext(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv500CreateUserAuthContextUpdateRequestRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // OBPv400GetExplicitCounterpartyById200ResponsePropertiesBespokeItems | Request body
    oBPv400GetExplicitCounterpartyById200ResponsePropertiesBespokeItems: {"type":"object","properties":{"key":{"type":"string"},"value":{"type":"string"}}},
  } satisfies OBPv500CreateUserAuthContextUpdateRequestRequest;

  try {
    const data = await api.oBPv500CreateUserAuthContextUpdateRequest(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv500GetUserAuthContextsRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    // string | The USERID identifier
    userid: userid_example,
  } satisfies OBPv500GetUserAuthContextsRequest;

  try {
    const data = await api.oBPv500GetUserAuthContexts(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv510GetEntitlementsAndPermissionsRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    // string | The USERID identifier
    userid: userid_example,
  } satisfies OBPv510GetEntitlementsAndPermissionsRequest;

  try {
    const data = await api.oBPv510GetEntitlementsAndPermissions(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv510GetUserByProviderAndUsernameRequest } from 'obp-typescript';
...
async function example() {
  ...
  } satisfies OBPv510GetUserByProviderAndUsernameRequest;

  try {
    const data = await api.oBPv510GetUserByProviderAndUsername(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv510GetUserLockStatusRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // string | The USERNAME identifier
    username: username_example,
  } satisfies OBPv510GetUserLockStatusRequest;

  try {
    const data = await api.oBPv510GetUserLockStatus(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv510LockUserByProviderAndUsernameRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // string | The USERNAME identifier
    username: username_example,
  } satisfies OBPv510LockUserByProviderAndUsernameRequest;

  try {
    const data = await api.oBPv510LockUserByProviderAndUsername(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv510SyncExternalUserRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // string | The PROVIDERID identifier
    providerid: providerid_example,
  } satisfies OBPv510SyncExternalUserRequest;

  try {
    const data = await api.oBPv510SyncExternalUser(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv510UnlockUserByProviderAndUsernameRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // string | The USERNAME identifier
    username: username_example,
  } satisfies OBPv510UnlockUserByProviderAndUsernameRequest;

  try {
    const data = await api.oBPv510UnlockUserByProviderAndUsername(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv510ValidateUserByUserIdRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    // string | The USERID identifier
    userid: userid_example,
  } satisfies OBPv510ValidateUserByUserIdRequest;

  try {
    const data = await api.oBPv510ValidateUserByUserId(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv600DeleteEntitlementRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    // string | The ENTITLEMENTID identifier
    entitlementid: entitlementid_example,
  } satisfies OBPv600DeleteEntitlementRequest;

  try {
    const data = await api.oBPv600DeleteEntitlement(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv600DirectLoginEndpointRequest } from 'obp-typescript';
...
async function example() {
  ...
  try {
    const data = await api.oBPv600DirectLoginEndpoint();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv600GetCurrentUserRequest } from 'obp-typescript';
...
async function example() {
  ...
  try {
    const data = await api.oBPv600GetCurrentUser();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv600GetProvidersRequest } from 'obp-typescript';
...
async function example() {
  ...
  try {
    const data = await api.oBPv600GetProviders();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv600GetUserByUserIdRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    // string | The USERID identifier
    userid: userid_example,
  } satisfies OBPv600GetUserByUserIdRequest;

  try {
    const data = await api.oBPv600GetUserByUserId(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv600GetUsersRequest } from 'obp-typescript';
...
async function example() {
  ...
  try {
    const data = await api.oBPv600GetUsers();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv600ResetPasswordCompleteOperationRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    oBPv600ResetPasswordCompleteRequest: {"type":"object","properties":{"new_password":{"type":"string"},"token":{"type":"string"}}},
  } satisfies OBPv600ResetPasswordCompleteOperationRequest;

  try {
    const data = await api.oBPv600ResetPasswordComplete(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv600ResetPasswordUrlOperationRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    oBPv600ResetPasswordUrlRequest: {"type":"object","properties":{"email":{"type":"string"},"username":{"type":"string"},"user_id":{"type":"string"}}},
  } satisfies OBPv600ResetPasswordUrlOperationRequest;

  try {
    const data = await api.oBPv600ResetPasswordUrl(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv600ResetPasswordUrlAnonymousOperationRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    oBPv600ResetPasswordUrlAnonymousRequest: {"type":"object","properties":{"email":{"type":"string"},"username":{"type":"string"}}},
  } satisfies OBPv600ResetPasswordUrlAnonymousOperationRequest;

  try {
    const data = await api.oBPv600ResetPasswordUrlAnonymous(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv600ValidateUserEmailOperationRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    oBPv600ValidateUserEmailRequest: {"type":"object","properties":{"token":{"type":"string"}}},
  } satisfies OBPv600ValidateUserEmailOperationRequest;

  try {
    const data = await api.oBPv600ValidateUserEmail(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv600VerifyUserCredentialsOperationRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    oBPv600VerifyUserCredentialsRequest: {"type":"object","properties":{"username":{"type":"string"},"password":{"type":"string"},"provider":{"type":"string"}}},
  } satisfies OBPv600VerifyUserCredentialsOperationRequest;

  try {
    const data = await api.oBPv600VerifyUserCredentials(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
