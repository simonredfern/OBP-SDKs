...
```typescript
import type { OBPv600CreateRetailCustomerRequestProperties } from 'obp-typescript'
...
const example = {
  ...
  "kycStatus": null,
} satisfies OBPv600CreateRetailCustomerRequestProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv600CreateRetailCustomerRequestProperties
