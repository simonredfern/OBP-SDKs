...
```typescript
import type { OBPv400CreateTransactionRequestAgentCashWithDrawalRequestProperties } from 'obp-typescript'
...
const example = {
  ...
  "chargePolicy": null,
  "value": null,
} satisfies OBPv400CreateTransactionRequestAgentCashWithDrawalRequestProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv400CreateTransactionRequestAgentCashWithDrawalRequestProperties
