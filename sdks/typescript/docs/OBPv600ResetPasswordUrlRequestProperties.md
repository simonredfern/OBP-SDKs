...
```typescript
import type { OBPv600ResetPasswordUrlRequestProperties } from 'obp-typescript'
...
const example = {
  ...
  "username": null,
  "userId": null,
} satisfies OBPv600ResetPasswordUrlRequestProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv600ResetPasswordUrlRequestProperties
