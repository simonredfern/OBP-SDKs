...
```typescript
import type { OBPv310GetCardsForBank200ResponsePropertiesCardsItemsProperties } from 'obp-typescript'
...
const example = {
  ...
  "cardType": null,
  "onHotList": null,
} satisfies OBPv310GetCardsForBank200ResponsePropertiesCardsItemsProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv310GetCardsForBank200ResponsePropertiesCardsItemsProperties
