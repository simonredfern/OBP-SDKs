...
```typescript
import type { OBPv600UpdateBankLevelDynamicEntity200ResponseProperties } from 'obp-typescript'
...
} satisfies OBPv600UpdateBankLevelDynamicEntity200ResponseProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv600UpdateBankLevelDynamicEntity200ResponseProperties
