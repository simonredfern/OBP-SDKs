...
|------------- | ------------- | -------------|
| [**oBPv500CreateSystemView**](ViewSystemApi.md#obpv500createsystemviewoperation) | **POST** /obp/v5.0.0/system-views | Create System View |
...
| [**oBPv510AddSystemViewPermission**](ViewSystemApi.md#obpv510addsystemviewpermissionoperation) | **POST** /obp/v5.1.0/system-views/{viewid}/permissions | Add Permission to a System View |
...
| [**oBPv600UpdateSystemView**](ViewSystemApi.md#obpv600updatesystemviewoperation) | **PUT** /obp/v6.0.0/system-views/{viewid} | Update System View |
...
import type { OBPv500CreateSystemViewOperationRequest } from 'obp-typescript';
...
async function example() {
  ...
  const api = new ViewSystemApi(config);

  const body = {
    // OBPv500CreateSystemViewRequest | Request body
    oBPv500CreateSystemViewRequest: {"type":"object","properties":{"hide_metadata_if_alias_used":{"type":"boolean"},"description":{"type":"string"},"is_public":{"type":"boolean"},"which_alias_to_use":{"type":"string"},"can_revoke_access_to_views":{"type":"array","items":{"type":"string"}},"can_grant_access_to_views":{"type":"array","items":{"type":"string"}},"name":{"type":"string"},"allowed_actions":{"type":"array","items":{"type":"string"}},"metadata_view":{"type":"string"}}},
  } satisfies OBPv500CreateSystemViewOperationRequest;

  try {
    const data = await api.oBPv500CreateSystemView(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> oBPv500DeleteSystemView(viewid)
...
import type { OBPv500DeleteSystemViewRequest } from 'obp-typescript';
...
async function example() {
  ...
  } satisfies OBPv500DeleteSystemViewRequest;

  try {
    const data = await api.oBPv500DeleteSystemView(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv500GetSystemViewRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    // string | The VIEWID identifier
    viewid: viewid_example,
  } satisfies OBPv500GetSystemViewRequest;

  try {
    const data = await api.oBPv500GetSystemView(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv500GetSystemViewsIdsRequest } from 'obp-typescript';
...
async function example() {
  ...
  try {
    const data = await api.oBPv500GetSystemViewsIds();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv510AddSystemViewPermissionOperationRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    oBPv510AddSystemViewPermissionRequest: {"type":"object","properties":{"extra_data":{"type":"array","items":{"type":"string"}},"permission_name":{"type":"string"}}},
  } satisfies OBPv510AddSystemViewPermissionOperationRequest;

  try {
    const data = await api.oBPv510AddSystemViewPermission(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> oBPv510DeleteSystemViewPermission(viewid, permissionname)
...
import type { OBPv510DeleteSystemViewPermissionRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    // string | The VIEWID identifier
    viewid: viewid_example,
    // string | The PERMISSIONNAME identifier
    permissionname: permissionname_example,
  } satisfies OBPv510DeleteSystemViewPermissionRequest;

  try {
    const data = await api.oBPv510DeleteSystemViewPermission(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
|------------- | ------------- | ------------- | -------------|
| **viewid** | `string` | The VIEWID identifier | [Defaults to `undefined`] |
| **permissionname** | `string` | The PERMISSIONNAME identifier | [Defaults to `undefined`] |
...
import type { OBPv600GetCustomViewsRequest } from 'obp-typescript';
...
async function example() {
  ...
  try {
    const data = await api.oBPv600GetCustomViews();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv600GetSystemViewByIdRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    // string | The VIEWID identifier
    viewid: viewid_example,
  } satisfies OBPv600GetSystemViewByIdRequest;

  try {
    const data = await api.oBPv600GetSystemViewById(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv600GetSystemViewsRequest } from 'obp-typescript';
...
async function example() {
  ...
  try {
    const data = await api.oBPv600GetSystemViews();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv600GetViewPermissionsRequest } from 'obp-typescript';
...
async function example() {
  ...
  try {
    const data = await api.oBPv600GetViewPermissions();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv600UpdateSystemViewOperationRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    oBPv600UpdateSystemViewRequest: {"type":"object","properties":{"is_firehose":{"type":"boolean"},"which_alias_to_use":{"type":"string"},"hide_metadata_if_alias_used":{"type":"boolean"},"allowed_actions":{"type":"array","items":{"type":"string"}},"can_grant_access_to_views":{"type":"array","items":{"type":"string"}},"is_public":{"type":"boolean"},"metadata_view":{"type":"string"},"description":{"type":"string"},"can_revoke_access_to_views":{"type":"array","items":{"type":"string"}}}},
  } satisfies OBPv600UpdateSystemViewOperationRequest;

  try {
    const data = await api.oBPv600UpdateSystemView(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
