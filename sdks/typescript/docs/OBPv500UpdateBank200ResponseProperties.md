...
```typescript
import type { OBPv500UpdateBank200ResponseProperties } from 'obp-typescript'
...
const example = {
  ...
  "id": null,
  "bankCode": null,
} satisfies OBPv500UpdateBank200ResponseProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv500UpdateBank200ResponseProperties
