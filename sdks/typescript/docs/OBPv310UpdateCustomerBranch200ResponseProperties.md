...
`dobOfDependants` | [OBPv500GetMyCustomersAtBank200ResponsePropertiesCustomersItemsPropertiesDobOfDependants](OBPv500GetMyCustomersAtBank200ResponsePropertiesCustomersItemsPropertiesDobOfDependants.md)
...
```typescript
import type { OBPv310UpdateCustomerBranch200ResponseProperties } from 'obp-typescript'
...
const example = {
  ...
  "kycStatus": null,
} satisfies OBPv310UpdateCustomerBranch200ResponseProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv310UpdateCustomerBranch200ResponseProperties
