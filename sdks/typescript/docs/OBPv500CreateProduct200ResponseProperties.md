...
```typescript
import type { OBPv500CreateProduct200ResponseProperties } from 'obp-typescript'
...
} satisfies OBPv500CreateProduct200ResponseProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv500CreateProduct200ResponseProperties
