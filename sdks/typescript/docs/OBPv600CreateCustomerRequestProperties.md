...
```typescript
import type { OBPv600CreateCustomerRequestProperties } from 'obp-typescript'
...
const example = {
  ...
  "kycStatus": null,
} satisfies OBPv600CreateCustomerRequestProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv600CreateCustomerRequestProperties
