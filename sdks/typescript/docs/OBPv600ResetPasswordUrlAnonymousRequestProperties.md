...
```typescript
import type { OBPv600ResetPasswordUrlAnonymousRequestProperties } from 'obp-typescript'

// TODO: Update the object below with actual values
const example = {
  "email": null,
  "username": null,
} satisfies OBPv600ResetPasswordUrlAnonymousRequestProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv600ResetPasswordUrlAnonymousRequestProperties
