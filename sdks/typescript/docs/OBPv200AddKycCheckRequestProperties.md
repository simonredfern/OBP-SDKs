...
`staffName` | [OBPv400UpdateSystemLevelEndpointTagRequestPropertiesTagName](OBPv400UpdateSystemLevelEndpointTagRequestPropertiesTagName.md)
...
```typescript
import type { OBPv200AddKycCheckRequestProperties } from 'obp-typescript'
...
const example = {
  ...
  "staffName": null,
  "comments": null,
} satisfies OBPv200AddKycCheckRequestProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv200AddKycCheckRequestProperties
