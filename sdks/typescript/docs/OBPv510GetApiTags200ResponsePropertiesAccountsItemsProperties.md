...
```typescript
import type { OBPv510GetApiTags200ResponsePropertiesAccountsItemsProperties } from 'obp-typescript'
...
const example = {
  ...
  "viewId": null,
  "accountId": null,
} satisfies OBPv510GetApiTags200ResponsePropertiesAccountsItemsProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv510GetApiTags200ResponsePropertiesAccountsItemsProperties
