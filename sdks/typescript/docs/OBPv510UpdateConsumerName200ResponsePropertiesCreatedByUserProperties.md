...
```typescript
import type { OBPv510UpdateConsumerName200ResponsePropertiesCreatedByUserProperties } from 'obp-typescript'
...
const example = {
  ...
  "providerId": null,
  "userId": null,
} satisfies OBPv510UpdateConsumerName200ResponsePropertiesCreatedByUserProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv510UpdateConsumerName200ResponsePropertiesCreatedByUserProperties
