...
```typescript
import type { OBPv600CreateSystemDynamicEntityRequestProperties } from 'obp-typescript'
...
} satisfies OBPv600CreateSystemDynamicEntityRequestProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv600CreateSystemDynamicEntityRequestProperties
