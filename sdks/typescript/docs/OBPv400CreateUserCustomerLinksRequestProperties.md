...
```typescript
import type { OBPv400CreateUserCustomerLinksRequestProperties } from 'obp-typescript'

// TODO: Update the object below with actual values
const example = {
  "customerId": null,
  "userId": null,
} satisfies OBPv400CreateUserCustomerLinksRequestProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv400CreateUserCustomerLinksRequestProperties
