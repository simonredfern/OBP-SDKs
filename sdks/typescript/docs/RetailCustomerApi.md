...
|------------- | ------------- | -------------|
| [**oBPv600CreateRetailCustomer**](RetailCustomerApi.md#obpv600createretailcustomeroperation) | **POST** /obp/v6.0.0/banks/{bankid}/retail-customers | Create Retail Customer |
...
async function example() {
  ...
  const api = new RetailCustomerApi(config);
