...
```typescript
import type { OBPv400CreateTransactionRequestCounterparty200ResponsePropertiesFromProperties } from 'obp-typescript'

// TODO: Update the object below with actual values
const example = {
  "bankId": null,
  "accountId": null,
} satisfies OBPv400CreateTransactionRequestCounterparty200ResponsePropertiesFromProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv400CreateTransactionRequestCounterparty200ResponsePropertiesFromProperties
