...
`consumerSecret` | [OBPv400UpdateSystemLevelEndpointTagRequestPropertiesTagName](OBPv400UpdateSystemLevelEndpointTagRequestPropertiesTagName.md)
...
```typescript
import type { OBPv510CreateConsumer200ResponseProperties } from 'obp-typescript'
...
const example = {
  ...
  "appName": null,
  "created": null,
} satisfies OBPv510CreateConsumer200ResponseProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv510CreateConsumer200ResponseProperties
