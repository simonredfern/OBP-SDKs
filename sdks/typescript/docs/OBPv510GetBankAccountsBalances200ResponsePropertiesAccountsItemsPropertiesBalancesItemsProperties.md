...
```typescript
import type { OBPv510GetBankAccountsBalances200ResponsePropertiesAccountsItemsPropertiesBalancesItemsProperties } from 'obp-typescript'
...
const example = {
  ...
  "amount": null,
  "currency": null,
} satisfies OBPv510GetBankAccountsBalances200ResponsePropertiesAccountsItemsPropertiesBalancesItemsProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv510GetBankAccountsBalances200ResponsePropertiesAccountsItemsPropertiesBalancesItemsProperties
