...
```typescript
import type { OBPv500CreateConsentRequestRequestProperties } from 'obp-typescript'
...
const example = {
  ...
  "validFrom": null,
  "entitlements": null,
} satisfies OBPv500CreateConsentRequestRequestProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv500CreateConsentRequestRequestProperties
