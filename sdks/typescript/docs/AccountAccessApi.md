...
|------------- | ------------- | -------------|
| [**oBPv510CreateUserWithAccountAccessById**](AccountAccessApi.md#obpv510createuserwithaccountaccessbyidoperation) | **POST** /obp/v5.1.0/banks/{bankid}/accounts/{accountid}/views/{viewid}/user-account-access | Create (DAuth) User with Account Access |
...
| [**oBPv510RevokeUserAccessToViewById**](AccountAccessApi.md#obpv510revokeuseraccesstoviewbyidoperation) | **POST** /obp/v5.1.0/banks/{bankid}/accounts/{accountid}/views/{viewid}/account-access/revoke | Revoke User access to View |
...
async function example() {
  ...
  const api = new AccountAccessApi(config);
