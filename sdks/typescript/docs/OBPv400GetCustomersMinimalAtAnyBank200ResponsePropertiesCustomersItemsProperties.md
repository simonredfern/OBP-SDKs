...
```typescript
import type { OBPv400GetCustomersMinimalAtAnyBank200ResponsePropertiesCustomersItemsProperties } from 'obp-typescript'

// TODO: Update the object below with actual values
const example = {
  "customerId": null,
  "bankId": null,
} satisfies OBPv400GetCustomersMinimalAtAnyBank200ResponsePropertiesCustomersItemsProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv400GetCustomersMinimalAtAnyBank200ResponsePropertiesCustomersItemsProperties
