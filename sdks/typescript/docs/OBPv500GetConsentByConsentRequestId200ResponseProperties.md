...
`accountAccess` | [OBPv510GetMyConsentsByBank200ResponsePropertiesConsentsItemsPropertiesJwtPayloadPropertiesViewsItems](OBPv510GetMyConsentsByBank200ResponsePropertiesConsentsItemsPropertiesJwtPayloadPropertiesViewsItems.md)
...
```typescript
import type { OBPv500GetConsentByConsentRequestId200ResponseProperties } from 'obp-typescript'
...
const example = {
  ...
  "status": null,
  "consentId": null,
} satisfies OBPv500GetConsentByConsentRequestId200ResponseProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv500GetConsentByConsentRequestId200ResponseProperties
