...
```typescript
import type { OBPv310UpdatedCardForBankRequestProperties } from 'obp-typescript'
...
const example = {
  ...
  "posted": null,
  "cardType": null,
} satisfies OBPv310UpdatedCardForBankRequestProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv310UpdatedCardForBankRequestProperties
