...
```typescript
import type { OBPv400GetExplicitCounterpartyById200ResponsePropertiesMetadataPropertiesPhysicalLocationPropertiesUserProperties } from 'obp-typescript'
...
const example = {
  ...
  "id": null,
  "username": null,
} satisfies OBPv400GetExplicitCounterpartyById200ResponsePropertiesMetadataPropertiesPhysicalLocationPropertiesUserProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv400GetExplicitCounterpartyById200ResponsePropertiesMetadataPropertiesPhysicalLocationPropertiesUserProperties
