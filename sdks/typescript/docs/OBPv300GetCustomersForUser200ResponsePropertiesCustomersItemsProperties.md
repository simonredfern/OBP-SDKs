...
`dateOfBirth` | [OBPv400UpdateSystemLevelEndpointTagRequestPropertiesTagName](OBPv400UpdateSystemLevelEndpointTagRequestPropertiesTagName.md)
...
```typescript
import type { OBPv300GetCustomersForUser200ResponsePropertiesCustomersItemsProperties } from 'obp-typescript'
...
const example = {
  ...
  "kycStatus": null,
} satisfies OBPv300GetCustomersForUser200ResponsePropertiesCustomersItemsProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv300GetCustomersForUser200ResponsePropertiesCustomersItemsProperties
