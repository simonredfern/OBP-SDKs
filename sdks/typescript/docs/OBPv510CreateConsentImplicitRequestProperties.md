...
```typescript
import type { OBPv510CreateConsentImplicitRequestProperties } from 'obp-typescript'
...
const example = {
  ...
  "views": null,
  "entitlements": null,
} satisfies OBPv510CreateConsentImplicitRequestProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv510CreateConsentImplicitRequestProperties
