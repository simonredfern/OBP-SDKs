...
|------------- | ------------- | -------------|
| [**oBPv400UpdateAtmAccessibilityFeatures**](ATMApi.md#obpv400updateatmaccessibilityfeaturesoperation) | **PUT** /obp/v4.0.0/banks/{bankid}/atms/{atmid}/accessibility-features | Update ATM Accessibility Features |
| [**oBPv400UpdateAtmLocationCategories**](ATMApi.md#obpv400updateatmlocationcategoriesoperation) | **PUT** /obp/v4.0.0/banks/{bankid}/atms/{atmid}/location-categories | Update ATM Location Categories |
| [**oBPv400UpdateAtmNotes**](ATMApi.md#obpv400updateatmnotesoperation) | **PUT** /obp/v4.0.0/banks/{bankid}/atms/{atmid}/notes | Update ATM Notes |
| [**oBPv400UpdateAtmServices**](ATMApi.md#obpv400updateatmservicesoperation) | **PUT** /obp/v4.0.0/banks/{bankid}/atms/{atmid}/services | Update ATM Services |
| [**oBPv400UpdateAtmSupportedCurrencies**](ATMApi.md#obpv400updateatmsupportedcurrenciesoperation) | **PUT** /obp/v4.0.0/banks/{bankid}/atms/{atmid}/supported-currencies | Update ATM Supported Currencies |
| [**oBPv400UpdateAtmSupportedLanguages**](ATMApi.md#obpv400updateatmsupportedlanguagesoperation) | **PUT** /obp/v4.0.0/banks/{bankid}/atms/{atmid}/supported-languages | Update ATM Supported Languages |
| [**oBPv500HeadAtms**](ATMApi.md#obpv500headatms) | **HEAD** /obp/v5.0.0/banks/{bankid}/atms | Head Bank ATMS |
| [**oBPv510CreateAtm**](ATMApi.md#obpv510createatmoperation) | **POST** /obp/v5.1.0/banks/{bankid}/atms | Create ATM |
...
| [**oBPv510UpdateAtm**](ATMApi.md#obpv510updateatmoperation) | **PUT** /obp/v5.1.0/banks/{bankid}/atms/{atmid} | UPDATE ATM |
| [**oBPv510UpdateAtmAttribute**](ATMApi.md#obpv510updateatmattributeoperation) | **PUT** /obp/v5.1.0/banks/{bankid}/atms/{atmid}/attributes/{atmattributeid} | Update ATM Attribute |
...
import type { OBPv400UpdateAtmAccessibilityFeaturesOperationRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    oBPv400UpdateAtmAccessibilityFeaturesRequest: {"type":"object","properties":{"accessibility_features":{"type":"array","items":{"type":"string"}}}},
  } satisfies OBPv400UpdateAtmAccessibilityFeaturesOperationRequest;

  try {
    const data = await api.oBPv400UpdateAtmAccessibilityFeatures(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv400UpdateAtmLocationCategoriesOperationRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    oBPv400UpdateAtmLocationCategoriesRequest: {"type":"object","properties":{"location_categories":{"type":"array","items":{"type":"string"}}}},
  } satisfies OBPv400UpdateAtmLocationCategoriesOperationRequest;

  try {
    const data = await api.oBPv400UpdateAtmLocationCategories(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv400UpdateAtmNotesOperationRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    oBPv400UpdateAtmNotesRequest: {"type":"object","properties":{"notes":{"type":"array","items":{"type":"string"}}}},
  } satisfies OBPv400UpdateAtmNotesOperationRequest;

  try {
    const data = await api.oBPv400UpdateAtmNotes(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv400UpdateAtmServicesOperationRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    oBPv400UpdateAtmServicesRequest: {"type":"object","properties":{"services":{"type":"array","items":{"type":"string"}}}},
  } satisfies OBPv400UpdateAtmServicesOperationRequest;

  try {
    const data = await api.oBPv400UpdateAtmServices(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv400UpdateAtmSupportedCurrenciesOperationRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    oBPv400UpdateAtmSupportedCurrenciesRequest: {"type":"object","properties":{"supported_currencies":{"type":"array","items":{"type":"string"}}}},
  } satisfies OBPv400UpdateAtmSupportedCurrenciesOperationRequest;

  try {
    const data = await api.oBPv400UpdateAtmSupportedCurrencies(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv400UpdateAtmSupportedLanguagesOperationRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    oBPv400UpdateAtmSupportedLanguagesRequest: {"type":"object","properties":{"supported_languages":{"type":"array","items":{"type":"string"}}}},
  } satisfies OBPv400UpdateAtmSupportedLanguagesOperationRequest;

  try {
    const data = await api.oBPv400UpdateAtmSupportedLanguages(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv500HeadAtmsRequest } from 'obp-typescript';

async function example() {
  console.log("🚀 Testing obp-typescript SDK...");
  const api = new ATMApi();

  const body = {
    // string | The BANKID identifier
    bankid: bankid_example,
  } satisfies OBPv500HeadAtmsRequest;

  try {
    const data = await api.oBPv500HeadAtms(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv510CreateAtmOperationRequest } from 'obp-typescript';
...
async function example() {
  ...
  } satisfies OBPv510CreateAtmOperationRequest;

  try {
    const data = await api.oBPv510CreateAtm(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv510DeleteAtmRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // string | The ATMID identifier
    atmid: atmid_example,
  } satisfies OBPv510DeleteAtmRequest;

  try {
    const data = await api.oBPv510DeleteAtm(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv510GetAtmRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // string | The ATMID identifier
    atmid: atmid_example,
  } satisfies OBPv510GetAtmRequest;

  try {
    const data = await api.oBPv510GetAtm(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv510GetAtmsRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    // string | The BANKID identifier
    bankid: bankid_example,
  } satisfies OBPv510GetAtmsRequest;

  try {
    const data = await api.oBPv510GetAtms(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OBPv510UpdateAtmOperationRequest } from 'obp-typescript';
...
async function example() {
  ...
  } satisfies OBPv510UpdateAtmOperationRequest;

  try {
    const data = await api.oBPv510UpdateAtm(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
