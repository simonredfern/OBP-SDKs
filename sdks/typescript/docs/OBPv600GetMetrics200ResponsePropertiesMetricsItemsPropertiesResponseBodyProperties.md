...
```typescript
import type { OBPv600GetMetrics200ResponsePropertiesMetricsItemsPropertiesResponseBodyProperties } from 'obp-typescript'

// TODO: Update the object below with actual values
const example = {
  "code": null,
  "message": null,
} satisfies OBPv600GetMetrics200ResponsePropertiesMetricsItemsPropertiesResponseBodyProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv600GetMetrics200ResponsePropertiesMetricsItemsPropertiesResponseBodyProperties
