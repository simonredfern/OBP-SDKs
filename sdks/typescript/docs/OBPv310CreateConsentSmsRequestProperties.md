...
```typescript
import type { OBPv310CreateConsentSmsRequestProperties } from 'obp-typescript'
...
const example = {
  ...
  "views": null,
  "entitlements": null,
} satisfies OBPv310CreateConsentSmsRequestProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv310CreateConsentSmsRequestProperties
