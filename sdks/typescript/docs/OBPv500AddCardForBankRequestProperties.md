...
```typescript
import type { OBPv500AddCardForBankRequestProperties } from 'obp-typescript'
...
const example = {
  ...
  "posted": null,
  "cardType": null,
} satisfies OBPv500AddCardForBankRequestProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv500AddCardForBankRequestProperties
