...
```typescript
import type { OBPv510CreateUserWithAccountAccessById200ResponsePropertiesHeadProperties } from 'obp-typescript'
...
} satisfies OBPv510CreateUserWithAccountAccessById200ResponsePropertiesHeadProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv510CreateUserWithAccountAccessById200ResponsePropertiesHeadProperties
