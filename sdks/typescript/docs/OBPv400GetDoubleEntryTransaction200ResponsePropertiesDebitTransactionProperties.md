...
```typescript
import type { OBPv400GetDoubleEntryTransaction200ResponsePropertiesDebitTransactionProperties } from 'obp-typescript'
...
const example = {
  ...
  "transactionId": null,
  "accountId": null,
} satisfies OBPv400GetDoubleEntryTransaction200ResponsePropertiesDebitTransactionProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv400GetDoubleEntryTransaction200ResponsePropertiesDebitTransactionProperties
