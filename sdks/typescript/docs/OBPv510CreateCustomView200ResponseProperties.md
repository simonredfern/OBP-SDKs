...
```typescript
import type { OBPv510CreateCustomView200ResponseProperties } from 'obp-typescript'
...
const example = {
  ...
  "id": null,
  "metadataView": null,
} satisfies OBPv510CreateCustomView200ResponseProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv510CreateCustomView200ResponseProperties
