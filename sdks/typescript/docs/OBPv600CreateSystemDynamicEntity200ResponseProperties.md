...
```typescript
import type { OBPv600CreateSystemDynamicEntity200ResponseProperties } from 'obp-typescript'
...
} satisfies OBPv600CreateSystemDynamicEntity200ResponseProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv600CreateSystemDynamicEntity200ResponseProperties
