...
async function example() {
  ...
  const body = {
    // string | The BANKID identifier
    bankid: bankid_example,
    // string | The FROMCURRENCYCODE identifier
...
|------------- | ------------- | ------------- | -------------|
| **bankid** | `string` | The BANKID identifier | [Defaults to `undefined`] |
| **fromcurrencycode** | `string` | The FROMCURRENCYCODE identifier | [Defaults to `undefined`] |
| **tocurrencycode** | `string` | The TOCURRENCYCODE identifier | [Defaults to `undefined`] |
