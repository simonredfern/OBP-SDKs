...
```typescript
import type { OBPv400GetTransactionAttributes200ResponseProperties } from 'obp-typescript'

// TODO: Update the object below with actual values
const example = {
  "transactionAttributes": null,
} satisfies OBPv400GetTransactionAttributes200ResponseProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv400GetTransactionAttributes200ResponseProperties
