...
Name | Type
------------ | -------------
`customerAttributeId` | [OBPv400UpdateSystemLevelEndpointTagRequestPropertiesTagName](OBPv400UpdateSystemLevelEndpointTagRequestPropertiesTagName.md)
...
```typescript
import type { OBPv400GetCustomerAttributes200ResponsePropertiesCustomerAttributesItemsProperties } from 'obp-typescript'
...
const example = {
  ...
  "type": null,
  "value": null,
} satisfies OBPv400GetCustomerAttributes200ResponsePropertiesCustomerAttributesItemsProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv400GetCustomerAttributes200ResponsePropertiesCustomerAttributesItemsProperties
