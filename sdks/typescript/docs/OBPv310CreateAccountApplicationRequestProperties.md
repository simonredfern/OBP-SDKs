...
```typescript
import type { OBPv310CreateAccountApplicationRequestProperties } from 'obp-typescript'
...
const example = {
  ...
  "productCode": null,
  "customerId": null,
} satisfies OBPv310CreateAccountApplicationRequestProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv310CreateAccountApplicationRequestProperties
