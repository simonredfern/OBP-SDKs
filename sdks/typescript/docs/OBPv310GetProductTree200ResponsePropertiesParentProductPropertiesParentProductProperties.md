...
```typescript
import type { OBPv310GetProductTree200ResponsePropertiesParentProductPropertiesParentProductProperties } from 'obp-typescript'
...
const example = {
  ...
  "category": null,
  "family": null,
} satisfies OBPv310GetProductTree200ResponsePropertiesParentProductPropertiesParentProductProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv310GetProductTree200ResponsePropertiesParentProductPropertiesParentProductProperties
