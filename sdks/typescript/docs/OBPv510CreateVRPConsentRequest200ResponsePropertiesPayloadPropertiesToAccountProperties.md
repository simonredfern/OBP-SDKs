...
```typescript
import type { OBPv510CreateVRPConsentRequest200ResponsePropertiesPayloadPropertiesToAccountProperties } from 'obp-typescript'
...
const example = {
  ...
  "branchRouting": null,
  "limit": null,
} satisfies OBPv510CreateVRPConsentRequest200ResponsePropertiesPayloadPropertiesToAccountProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv510CreateVRPConsentRequest200ResponsePropertiesPayloadPropertiesToAccountProperties
