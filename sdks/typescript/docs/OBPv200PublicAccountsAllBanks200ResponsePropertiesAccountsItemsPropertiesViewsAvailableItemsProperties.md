...
```typescript
import type { OBPv200PublicAccountsAllBanks200ResponsePropertiesAccountsItemsPropertiesViewsAvailableItemsProperties } from 'obp-typescript'
...
const example = {
  ...
  "id": null,
  "isPublic": null,
} satisfies OBPv200PublicAccountsAllBanks200ResponsePropertiesAccountsItemsPropertiesViewsAvailableItemsProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv200PublicAccountsAllBanks200ResponsePropertiesAccountsItemsPropertiesViewsAvailableItemsProperties
