...
`parentCustomerId` | [OBPv400UpdateSystemLevelEndpointTagRequestPropertiesTagName](OBPv400UpdateSystemLevelEndpointTagRequestPropertiesTagName.md)
...
```typescript
import type { OBPv600GetCustomerByCustomerNumber200ResponseProperties } from 'obp-typescript'
...
const example = {
  ...
  "kycStatus": null,
} satisfies OBPv600GetCustomerByCustomerNumber200ResponseProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv600GetCustomerByCustomerNumber200ResponseProperties
