...
```typescript
import type { OBPv600BackupBankLevelDynamicEntity200ResponseProperties } from 'obp-typescript'
...
} satisfies OBPv600BackupBankLevelDynamicEntity200ResponseProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv600BackupBankLevelDynamicEntity200ResponseProperties
