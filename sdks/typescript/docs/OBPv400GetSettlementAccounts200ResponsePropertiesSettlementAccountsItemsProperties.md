...
```typescript
import type { OBPv400GetSettlementAccounts200ResponsePropertiesSettlementAccountsItemsProperties } from 'obp-typescript'
...
const example = {
  ...
  "paymentSystem": null,
  "accountId": null,
} satisfies OBPv400GetSettlementAccounts200ResponsePropertiesSettlementAccountsItemsProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv400GetSettlementAccounts200ResponsePropertiesSettlementAccountsItemsProperties
