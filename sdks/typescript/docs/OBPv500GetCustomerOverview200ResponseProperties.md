...
```typescript
import type { OBPv500GetCustomerOverview200ResponseProperties } from 'obp-typescript'
...
const example = {
  ...
  "kycStatus": null,
  "accounts": null,
} satisfies OBPv500GetCustomerOverview200ResponseProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv500GetCustomerOverview200ResponseProperties
