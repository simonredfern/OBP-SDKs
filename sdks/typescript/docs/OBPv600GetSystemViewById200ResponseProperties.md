...
```typescript
import type { OBPv600GetSystemViewById200ResponseProperties } from 'obp-typescript'
...
const example = {
  ...
  "metadataView": null,
  "allowedActions": null,
} satisfies OBPv600GetSystemViewById200ResponseProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv600GetSystemViewById200ResponseProperties
