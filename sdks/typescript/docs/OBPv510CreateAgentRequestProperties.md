...
`agentNumber` | [OBPv400UpdateSystemLevelEndpointTagRequestPropertiesTagName](OBPv400UpdateSystemLevelEndpointTagRequestPropertiesTagName.md)
...
```typescript
import type { OBPv510CreateAgentRequestProperties } from 'obp-typescript'
...
} satisfies OBPv510CreateAgentRequestProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv510CreateAgentRequestProperties
