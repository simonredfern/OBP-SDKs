...
`serviceAvailable` | [OBPv400UpdateSystemLevelEndpointTagRequestPropertiesTagName](OBPv400UpdateSystemLevelEndpointTagRequestPropertiesTagName.md)

## Example

```typescript
import type { OBPv310GetRateLimitingInfo200ResponseProperties } from 'obp-typescript'
...
} satisfies OBPv310GetRateLimitingInfo200ResponseProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv310GetRateLimitingInfo200ResponseProperties
