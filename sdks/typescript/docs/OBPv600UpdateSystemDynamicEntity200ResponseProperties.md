...
```typescript
import type { OBPv600UpdateSystemDynamicEntity200ResponseProperties } from 'obp-typescript'
...
} satisfies OBPv600UpdateSystemDynamicEntity200ResponseProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv600UpdateSystemDynamicEntity200ResponseProperties
