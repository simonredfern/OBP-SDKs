...
```typescript
import type { OBPv510UpdateAtmAttributeRequestProperties } from 'obp-typescript'
...
const example = {
  ...
  "isActive": null,
  "type": null,
} satisfies OBPv510UpdateAtmAttributeRequestProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv510UpdateAtmAttributeRequestProperties
