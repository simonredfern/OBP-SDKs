...
```typescript
import type { OBPv600CreateCallLimitsRequestProperties } from 'obp-typescript'
...
const example = {
  ...
  "toDate": null,
} satisfies OBPv600CreateCallLimitsRequestProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv600CreateCallLimitsRequestProperties
