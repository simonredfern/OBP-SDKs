...
```typescript
import type { OBPv600CreateBankLevelDynamicEntity200ResponseProperties } from 'obp-typescript'
...
} satisfies OBPv600CreateBankLevelDynamicEntity200ResponseProperties
...
const exampleParsed = JSON.parse(exampleJSON) as OBPv600CreateBankLevelDynamicEntity200ResponseProperties
