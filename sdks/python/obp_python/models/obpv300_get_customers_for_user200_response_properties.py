...
class OBPv300GetCustomersForUser200ResponseProperties(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customers": OBPv300GetCustomersForUser200ResponsePropertiesCustomers.from_dict(obj["customers"]) if obj.get("customers") is not None else None
        })
        return _obj
