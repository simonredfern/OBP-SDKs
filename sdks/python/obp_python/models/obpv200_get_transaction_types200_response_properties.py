...
class OBPv200GetTransactionTypes200ResponseProperties(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.transaction_types:
            _dict['transaction_types'] = self.transaction_types.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "transaction_types": OBPv200GetTransactionTypes200ResponsePropertiesTransactionTypes.from_dict(obj["transaction_types"]) if obj.get("transaction_types") is not None else None
        })
        return _obj
