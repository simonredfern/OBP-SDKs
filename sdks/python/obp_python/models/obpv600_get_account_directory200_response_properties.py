...
class OBPv600GetAccountDirectory200ResponseProperties(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accounts": OBPv600GetAccountDirectory200ResponsePropertiesAccounts.from_dict(obj["accounts"]) if obj.get("accounts") is not None else None
        })
        return _obj
