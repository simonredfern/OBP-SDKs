...
class OBPv400GetBankLevelEndpointTags200ResponseProperties(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "head": OBPv400UpdateSystemLevelEndpointTag200Response.from_dict(obj["head"]) if obj.get("head") is not None else None,
