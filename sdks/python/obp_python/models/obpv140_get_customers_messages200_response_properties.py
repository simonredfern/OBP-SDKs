...
class OBPv140GetCustomersMessages200ResponseProperties(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "messages": OBPv140GetCustomersMessages200ResponsePropertiesMessages.from_dict(obj["messages"]) if obj.get("messages") is not None else None
        })
        return _obj
