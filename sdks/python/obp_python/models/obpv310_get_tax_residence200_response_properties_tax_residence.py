...
class OBPv310GetTaxResidence200ResponsePropertiesTaxResidence(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "items": OBPv310CreateTaxResidence200Response.from_dict(obj["items"]) if obj.get("items") is not None else None
        })
        return _obj
