...
class OBPv200GetKycStatuses200ResponseProperties(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "statuses": OBPv200GetKycStatuses200ResponsePropertiesStatuses.from_dict(obj["statuses"]) if obj.get("statuses") is not None else None
        })
        return _obj
