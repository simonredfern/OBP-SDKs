...
class OBPv200GetKycDocuments200ResponsePropertiesDocuments(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "items": OBPv200AddKycDocument200Response.from_dict(obj["items"]) if obj.get("items") is not None else None
        })
        return _obj
