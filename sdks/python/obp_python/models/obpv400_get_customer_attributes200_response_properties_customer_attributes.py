...
class OBPv400GetCustomerAttributes200ResponsePropertiesCustomerAttributes(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "items": OBPv400GetCustomerAttributes200ResponsePropertiesCustomerAttributesItems.from_dict(obj["items"]) if obj.get("items") is not None else None
        })
        return _obj
