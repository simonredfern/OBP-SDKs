...
class OBPv510CreateUserWithAccountAccessById200ResponseProperties(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["head", "tl"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "head": OBPv510CreateUserWithAccountAccessById200ResponsePropertiesHead.from_dict(obj["head"]) if obj.get("head") is not None else None,
            "tl": OBPv400GetDynamicMessageDoc200ResponsePropertiesExampleInboundMessage.from_dict(obj["tl"]) if obj.get("tl") is not None else None
        })
        return _obj
