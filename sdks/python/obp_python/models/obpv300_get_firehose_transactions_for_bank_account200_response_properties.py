...
class OBPv300GetFirehoseTransactionsForBankAccount200ResponseProperties(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "transactions": OBPv300GetFirehoseTransactionsForBankAccount200ResponsePropertiesTransactions.from_dict(obj["transactions"]) if obj.get("transactions") is not None else None
        })
        return _obj
