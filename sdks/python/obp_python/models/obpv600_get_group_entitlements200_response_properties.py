...
class OBPv600GetGroupEntitlements200ResponseProperties(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entitlements": OBPv600GetGroupEntitlements200ResponsePropertiesEntitlements.from_dict(obj["entitlements"]) if obj.get("entitlements") is not None else None
        })
        return _obj
