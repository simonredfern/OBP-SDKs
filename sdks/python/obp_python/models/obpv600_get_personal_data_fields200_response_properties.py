...
class OBPv600GetPersonalDataFields200ResponseProperties(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["user_attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "user_attributes": OBPv600GetPersonalDataFields200ResponsePropertiesUserAttributes.from_dict(obj["user_attributes"]) if obj.get("user_attributes") is not None else None
        })
        return _obj
