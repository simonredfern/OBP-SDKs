...
class OBPv220GetConnectorMetrics200ResponseProperties(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metrics": OBPv220GetConnectorMetrics200ResponsePropertiesMetrics.from_dict(obj["metrics"]) if obj.get("metrics") is not None else None
        })
        return _obj
