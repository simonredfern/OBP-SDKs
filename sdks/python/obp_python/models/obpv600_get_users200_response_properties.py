...
class OBPv600GetUsers200ResponseProperties(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "users": OBPv600GetUsers200ResponsePropertiesUsers.from_dict(obj["users"]) if obj.get("users") is not None else None
        })
        return _obj
