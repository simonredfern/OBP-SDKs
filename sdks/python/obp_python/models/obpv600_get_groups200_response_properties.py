...
class OBPv600GetGroups200ResponseProperties(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groups": OBPv600GetGroups200ResponsePropertiesGroups.from_dict(obj["groups"]) if obj.get("groups") is not None else None
        })
        return _obj
