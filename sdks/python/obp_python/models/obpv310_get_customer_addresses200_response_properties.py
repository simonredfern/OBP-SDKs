...
class OBPv310GetCustomerAddresses200ResponseProperties(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "addresses": OBPv310GetCustomerAddresses200ResponsePropertiesAddresses.from_dict(obj["addresses"]) if obj.get("addresses") is not None else None
        })
        return _obj
