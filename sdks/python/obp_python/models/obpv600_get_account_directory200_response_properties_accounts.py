...
class OBPv600GetAccountDirectory200ResponsePropertiesAccounts(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "items": OBPv600GetAccountDirectory200ResponsePropertiesAccountsItems.from_dict(obj["items"]) if obj.get("items") is not None else None
        })
        return _obj
