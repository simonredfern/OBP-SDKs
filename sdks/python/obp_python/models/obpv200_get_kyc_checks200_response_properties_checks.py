...
class OBPv200GetKycChecks200ResponsePropertiesChecks(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "items": OBPv200GetKycChecks200ResponsePropertiesChecksItems.from_dict(obj["items"]) if obj.get("items") is not None else None
        })
        return _obj
