...
class OBPv400GetUserCustomerLinksByCustomerId200ResponseProperties(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of user_customer_links
        if self.user_customer_links:
            _dict['user_customer_links'] = self.user_customer_links.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "user_customer_links": OBPv400GetUserCustomerLinksByCustomerId200ResponsePropertiesUserCustomerLinks.from_dict(obj["user_customer_links"]) if obj.get("user_customer_links") is not None else None
        })
        return _obj
