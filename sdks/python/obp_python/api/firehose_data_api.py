...
class FirehoseDataApi:
    ...
    @validate_call
    def o_bpv3_1_0_get_firehose_customers(
        self,
        bankid: Annotated[StrictStr, Field(description="The BANKID identifier")],
        _request_timeout: Union[
            None,
        ...
        _param = self._o_bpv3_1_0_get_firehose_customers_serialize(
            bankid=bankid,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OBPv500GetMyCustomersAtBank200Response",
            '500': None,
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def o_bpv3_1_0_get_firehose_customers_with_http_info(
        self,
        bankid: Annotated[StrictStr, Field(description="The BANKID identifier")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OBPv500GetMyCustomersAtBank200Response]:
        """Get Firehose Customers
    ...
    @validate_call
    def o_bpv3_1_0_get_firehose_customers_without_preload_content(
        self,
        bankid: Annotated[StrictStr, Field(description="The BANKID identifier")],
        _request_timeout: Union[
            None,
    ...
    def _o_bpv3_1_0_get_firehose_customers_serialize(
        self,
        bankid,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/obp/v3.1.0/banks/{bankid}/firehose/customers',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
