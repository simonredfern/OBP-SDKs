...
class AuthenticationTypeValidationApi:
    ...
    def _o_bpv4_0_0_create_authentication_type_validation_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/obp/v4.0.0/management/authentication-type-validations/{operationid}',
    ...
    def _o_bpv4_0_0_get_all_authentication_type_validations_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/obp/v4.0.0/management/authentication-type-validations',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _o_bpv4_0_0_get_all_authentication_type_validations_public_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/obp/v4.0.0/endpoints/authentication-type-validations',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
