...
with obp_python.ApiClient(configuration) as api_client:
    ...
    api_instance = obp_python.AIAgentApi(api_client)
    ...
    try:
        ...
        print("The response of AIAgentApi->o_bpv6_0_0_delete_signal_channel:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AIAgentApi->o_bpv6_0_0_delete_signal_channel: %s\n" % e)
```
...
with obp_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AIAgentApi->o_bpv6_0_0_get_signal_channel_info:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AIAgentApi->o_bpv6_0_0_get_signal_channel_info: %s\n" % e)
```
...
with obp_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AIAgentApi->o_bpv6_0_0_get_signal_channels:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AIAgentApi->o_bpv6_0_0_get_signal_channels: %s\n" % e)
```
...
with obp_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AIAgentApi->o_bpv6_0_0_get_signal_messages:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AIAgentApi->o_bpv6_0_0_get_signal_messages: %s\n" % e)
```
...
with obp_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AIAgentApi->o_bpv6_0_0_get_signal_stats:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AIAgentApi->o_bpv6_0_0_get_signal_stats: %s\n" % e)
```
...
with obp_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AIAgentApi->o_bpv6_0_0_publish_signal_message:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AIAgentApi->o_bpv6_0_0_publish_signal_message: %s\n" % e)
```
