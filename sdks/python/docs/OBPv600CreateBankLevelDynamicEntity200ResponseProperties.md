...
obpv600_create_bank_level_dynamic_entity200_response_properties_instance = OBPv600CreateBankLevelDynamicEntity200ResponseProperties.from_json(json)
# print the JSON string representation of the object
print(OBPv600CreateBankLevelDynamicEntity200ResponseProperties.to_json())

# convert the object into a dict
obpv600_create_bank_level_dynamic_entity200_response_properties_dict = obpv600_create_bank_level_dynamic_entity200_response_properties_instance.to_dict()
# create an instance of OBPv600CreateBankLevelDynamicEntity200ResponseProperties from a dict
obpv600_create_bank_level_dynamic_entity200_response_properties_from_dict = OBPv600CreateBankLevelDynamicEntity200ResponseProperties.from_dict(obpv600_create_bank_level_dynamic_entity200_response_properties_dict)
```
