...
obpv500_create_product_request_properties_instance = OBPv500CreateProductRequestProperties.from_json(json)
# print the JSON string representation of the object
print(OBPv500CreateProductRequestProperties.to_json())

# convert the object into a dict
obpv500_create_product_request_properties_dict = obpv500_create_product_request_properties_instance.to_dict()
# create an instance of OBPv500CreateProductRequestProperties from a dict
obpv500_create_product_request_properties_from_dict = OBPv500CreateProductRequestProperties.from_dict(obpv500_create_product_request_properties_dict)
```
