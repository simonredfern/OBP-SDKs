...
with obp_python.ApiClient(configuration) as api_client:
    ...
    api_instance = obp_python.OAuthApi(api_client)

    try:
        # Get JSON Web Key (JWK) URIs
        api_response = api_instance.o_bpv3_1_0_get_o_auth2_server_jwks_uris()
        print("The response of OAuthApi->o_bpv3_1_0_get_o_auth2_server_jwks_uris:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OAuthApi->o_bpv3_1_0_get_o_auth2_server_jwks_uris: %s\n" % e)
```
...
with obp_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of OAuthApi->o_bpv3_1_0_get_obp_connector_loopback:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OAuthApi->o_bpv3_1_0_get_obp_connector_loopback: %s\n" % e)
```
...
with obp_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of OAuthApi->o_bpv6_0_0_get_oidc_client:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OAuthApi->o_bpv6_0_0_get_oidc_client: %s\n" % e)
```
...
with obp_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of OAuthApi->o_bpv6_0_0_verify_oidc_client:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OAuthApi->o_bpv6_0_0_verify_oidc_client: %s\n" % e)
```
