...
json = "{}"
# create an instance of OBPv600CreateBankRequestProperties from a JSON string
obpv600_create_bank_request_properties_instance = OBPv600CreateBankRequestProperties.from_json(json)
# print the JSON string representation of the object
print(OBPv600CreateBankRequestProperties.to_json())

# convert the object into a dict
obpv600_create_bank_request_properties_dict = obpv600_create_bank_request_properties_instance.to_dict()
# create an instance of OBPv600CreateBankRequestProperties from a dict
obpv600_create_bank_request_properties_from_dict = OBPv600CreateBankRequestProperties.from_dict(obpv600_create_bank_request_properties_dict)
```
