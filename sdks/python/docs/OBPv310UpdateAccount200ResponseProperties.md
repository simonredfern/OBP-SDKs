...
obpv310_update_account200_response_properties_instance = OBPv310UpdateAccount200ResponseProperties.from_json(json)
# print the JSON string representation of the object
print(OBPv310UpdateAccount200ResponseProperties.to_json())

# convert the object into a dict
obpv310_update_account200_response_properties_dict = obpv310_update_account200_response_properties_instance.to_dict()
# create an instance of OBPv310UpdateAccount200ResponseProperties from a dict
obpv310_update_account200_response_properties_from_dict = OBPv310UpdateAccount200ResponseProperties.from_dict(obpv310_update_account200_response_properties_dict)
```
