...
with obp_python.ApiClient(configuration) as api_client:
    ...
    api_instance = obp_python.AccountAccessApi(api_client)
    ...
    try:
        ...
        print("The response of AccountAccessApi->o_bpv5_1_0_create_user_with_account_access_by_id:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AccountAccessApi->o_bpv5_1_0_create_user_with_account_access_by_id: %s\n" % e)
```
...
with obp_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AccountAccessApi->o_bpv5_1_0_grant_user_access_to_view_by_id:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AccountAccessApi->o_bpv5_1_0_grant_user_access_to_view_by_id: %s\n" % e)
```
...
with obp_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AccountAccessApi->o_bpv5_1_0_revoke_user_access_to_view_by_id:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AccountAccessApi->o_bpv5_1_0_revoke_user_access_to_view_by_id: %s\n" % e)
```
