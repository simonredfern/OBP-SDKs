...
obpv600_create_or_update_api_product_request_properties_instance = OBPv600CreateOrUpdateApiProductRequestProperties.from_json(json)
# print the JSON string representation of the object
print(OBPv600CreateOrUpdateApiProductRequestProperties.to_json())

# convert the object into a dict
obpv600_create_or_update_api_product_request_properties_dict = obpv600_create_or_update_api_product_request_properties_instance.to_dict()
# create an instance of OBPv600CreateOrUpdateApiProductRequestProperties from a dict
obpv600_create_or_update_api_product_request_properties_from_dict = OBPv600CreateOrUpdateApiProductRequestProperties.from_dict(obpv600_create_or_update_api_product_request_properties_dict)
```
