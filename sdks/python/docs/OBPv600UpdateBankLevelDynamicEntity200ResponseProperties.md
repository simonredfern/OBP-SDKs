...
json = "{}"
# create an instance of OBPv600UpdateBankLevelDynamicEntity200ResponseProperties from a JSON string
obpv600_update_bank_level_dynamic_entity200_response_properties_instance = OBPv600UpdateBankLevelDynamicEntity200ResponseProperties.from_json(json)
# print the JSON string representation of the object
print(OBPv600UpdateBankLevelDynamicEntity200ResponseProperties.to_json())

# convert the object into a dict
obpv600_update_bank_level_dynamic_entity200_response_properties_dict = obpv600_update_bank_level_dynamic_entity200_response_properties_instance.to_dict()
# create an instance of OBPv600UpdateBankLevelDynamicEntity200ResponseProperties from a dict
obpv600_update_bank_level_dynamic_entity200_response_properties_from_dict = OBPv600UpdateBankLevelDynamicEntity200ResponseProperties.from_dict(obpv600_update_bank_level_dynamic_entity200_response_properties_dict)
```
