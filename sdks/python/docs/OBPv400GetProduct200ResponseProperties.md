...
json = "{}"
# create an instance of OBPv400GetProduct200ResponseProperties from a JSON string
obpv400_get_product200_response_properties_instance = OBPv400GetProduct200ResponseProperties.from_json(json)
# print the JSON string representation of the object
print(OBPv400GetProduct200ResponseProperties.to_json())

# convert the object into a dict
obpv400_get_product200_response_properties_dict = obpv400_get_product200_response_properties_instance.to_dict()
# create an instance of OBPv400GetProduct200ResponseProperties from a dict
obpv400_get_product200_response_properties_from_dict = OBPv400GetProduct200ResponseProperties.from_dict(obpv400_get_product200_response_properties_dict)
```
