...
obpv600_create_customer_request_properties_instance = OBPv600CreateCustomerRequestProperties.from_json(json)
# print the JSON string representation of the object
print(OBPv600CreateCustomerRequestProperties.to_json())

# convert the object into a dict
obpv600_create_customer_request_properties_dict = obpv600_create_customer_request_properties_instance.to_dict()
# create an instance of OBPv600CreateCustomerRequestProperties from a dict
obpv600_create_customer_request_properties_from_dict = OBPv600CreateCustomerRequestProperties.from_dict(obpv600_create_customer_request_properties_dict)
```
