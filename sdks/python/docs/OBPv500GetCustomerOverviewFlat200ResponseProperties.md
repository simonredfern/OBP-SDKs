...
obpv500_get_customer_overview_flat200_response_properties_instance = OBPv500GetCustomerOverviewFlat200ResponseProperties.from_json(json)
# print the JSON string representation of the object
print(OBPv500GetCustomerOverviewFlat200ResponseProperties.to_json())

# convert the object into a dict
obpv500_get_customer_overview_flat200_response_properties_dict = obpv500_get_customer_overview_flat200_response_properties_instance.to_dict()
# create an instance of OBPv500GetCustomerOverviewFlat200ResponseProperties from a dict
obpv500_get_customer_overview_flat200_response_properties_from_dict = OBPv500GetCustomerOverviewFlat200ResponseProperties.from_dict(obpv500_get_customer_overview_flat200_response_properties_dict)
```
