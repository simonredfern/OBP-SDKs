...
json = "{}"
# create an instance of OBPv600GetCustomerChildren200ResponsePropertiesCustomersItemsProperties from a JSON string
obpv600_get_customer_children200_response_properties_customers_items_properties_instance = OBPv600GetCustomerChildren200ResponsePropertiesCustomersItemsProperties.from_json(json)
# print the JSON string representation of the object
print(OBPv600GetCustomerChildren200ResponsePropertiesCustomersItemsProperties.to_json())

# convert the object into a dict
obpv600_get_customer_children200_response_properties_customers_items_properties_dict = obpv600_get_customer_children200_response_properties_customers_items_properties_instance.to_dict()
# create an instance of OBPv600GetCustomerChildren200ResponsePropertiesCustomersItemsProperties from a dict
obpv600_get_customer_children200_response_properties_customers_items_properties_from_dict = OBPv600GetCustomerChildren200ResponsePropertiesCustomersItemsProperties.from_dict(obpv600_get_customer_children200_response_properties_customers_items_properties_dict)
```
