...
namespace OpenBankProject.Api
{
    ...
    /// </summary>
    public interface ISignallingApi : IApi
    {
        /// <summary>
        /// The class containing the events
        /// </summary>
        SignallingApiEvents Events { get; }
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class SignallingApiEvents
    {
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public sealed partial class SignallingApi : ISignallingApi
    {
        ...
        /// The logger
        /// </summary>
        public ILogger<SignallingApi> Logger { get; }
        ...
        /// The class containing the events
        /// </summary>
        public SignallingApiEvents Events { get; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SignallingApi"/> class.
        /// </summary>
        /// <returns></returns>
        public SignallingApi(ILogger<SignallingApi> logger, ILoggerFactory loggerFactory, HttpClient httpClient, JsonSerializerOptionsProvider jsonSerializerOptionsProvider, SignallingApiEvents signallingApiEvents,
            TokenProvider<ApiKeyToken> apiKeyProvider,
            TokenProvider<OAuthToken> oauthTokenProvider)
        {
            _jsonSerializerOptions = jsonSerializerOptionsProvider.Options;
            LoggerFactory = loggerFactory;
            Logger = LoggerFactory.CreateLogger<SignallingApi>();
            HttpClient = httpClient;
            Events = signallingApiEvents;
