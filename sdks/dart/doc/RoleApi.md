...
try {
    ...
    print('Exception when calling RoleApi->oBPv200AddEntitlement: $e\n');
}
```
...
try {
    ...
    print('Exception when calling RoleApi->oBPv200DeleteEntitlement: $e\n');
}
```
...
try {
    ...
    print('Exception when calling RoleApi->oBPv210GetEntitlementsByBankAndUser: $e\n');
}
```
...
try {
    final response = api.oBPv210GetRoles();
    print(response);
} on DioException catch (e) {
    print('Exception when calling RoleApi->oBPv210GetRoles: $e\n');
}
```
...
try {
    ...
    print('Exception when calling RoleApi->oBPv300AddEntitlementRequest: $e\n');
}
```
...
try {
    ...
    print('Exception when calling RoleApi->oBPv300DeleteEntitlementRequest: $e\n');
}
```
...
try {
    ...
    print('Exception when calling RoleApi->oBPv300GetAllEntitlementRequests: $e\n');
}
```
...
try {
    ...
    print('Exception when calling RoleApi->oBPv300GetEntitlementRequests: $e\n');
}
```
...
try {
    ...
    print('Exception when calling RoleApi->oBPv300GetEntitlementRequestsForCurrentUser: $e\n');
}
```
...
try {
    ...
    print('Exception when calling RoleApi->oBPv300GetEntitlementsForCurrentUser: $e\n');
}
```
...
try {
    ...
    print('Exception when calling RoleApi->oBPv310GetAllEntitlements: $e\n');
}
```
...
try {
    ...
    print('Exception when calling RoleApi->oBPv400CreateUserWithRoles: $e\n');
}
```
...
try {
    ...
    print('Exception when calling RoleApi->oBPv400GetEntitlements: $e\n');
}
```
...
try {
    ...
    print('Exception when calling RoleApi->oBPv400GetEntitlementsForBank: $e\n');
}
```
...
try {
    ...
    print('Exception when calling RoleApi->oBPv510GetEntitlementsAndPermissions: $e\n');
}
```
...
try {
    ...
    print('Exception when calling RoleApi->oBPv600DeleteEntitlement: $e\n');
}
```
...
try {
    ...
    print('Exception when calling RoleApi->oBPv600GetRolesWithEntitlementCountsAtAllBanks: $e\n');
}
```
