...
final api = ObpDart().getDocumentationApi();
...
try {
    ...
    print('Exception when calling DocumentationApi->oBPv140GetBankLevelDynamicResourceDocsObp: $e\n');
}
```
...
try {
    ...
    print('Exception when calling DocumentationApi->oBPv140GetResourceDocsObp: $e\n');
}
```
...
try {
    ...
    print('Exception when calling DocumentationApi->oBPv140GetResourceDocsOpenAPI31: $e\n');
}
```
...
try {
    ...
    print('Exception when calling DocumentationApi->oBPv140GetResourceDocsSwagger: $e\n');
}
```
...
try {
    ...
    print('Exception when calling DocumentationApi->oBPv220GetMessageDocs: $e\n');
}
```
...
try {
    final response = api.oBPv300GetApiGlossary();
    print(response);
} on DioException catch (e) {
    print('Exception when calling DocumentationApi->oBPv300GetApiGlossary: $e\n');
}
```
...
try {
    ...
    print('Exception when calling DocumentationApi->oBPv310GetMessageDocsSwagger: $e\n');
}
```
...
try {
    ...
    print('Exception when calling DocumentationApi->oBPv600GetMessageDocsJsonSchema: $e\n');
}
```
...
try {
    ...
    print('Exception when calling DocumentationApi->oBPv600GetScannedApiVersions: $e\n');
}
```
