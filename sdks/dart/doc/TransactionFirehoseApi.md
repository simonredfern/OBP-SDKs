# obp_dart.api.TransactionFirehoseApi
...
final api = ObpDart().getTransactionFirehoseApi();
...
try {
    ...
    print('Exception when calling TransactionFirehoseApi->oBPv300GetFirehoseTransactionsForBankAccount: $e\n');
}
```
