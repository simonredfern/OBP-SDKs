...
final api = ObpDart().getConnectorApi();

try {
    final response = api.oBPv600GetConnectors();
    print(response);
} on DioException catch (e) {
    print('Exception when calling ConnectorApi->oBPv600GetConnectors: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ConnectorApi->oBPv600GetStoredProcedureConnectorHealth: $e\n');
}
```
