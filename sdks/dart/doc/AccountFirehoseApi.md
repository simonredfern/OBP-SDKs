# obp_dart.api.AccountFirehoseApi
...
final api = ObpDart().getAccountFirehoseApi();
...
try {
    ...
    print('Exception when calling AccountFirehoseApi->oBPv300GetFirehoseTransactionsForBankAccount: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountFirehoseApi->oBPv400GetFastFirehoseAccountsAtOneBank: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountFirehoseApi->oBPv400GetFirehoseAccountsAtOneBank: $e\n');
}
```
