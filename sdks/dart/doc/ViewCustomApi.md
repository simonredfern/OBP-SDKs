...
final api = ObpDart().getViewCustomApi();
...
try {
    api.oBPv121DeleteViewForBankAccount(bankid, accountid, viewid);
} on DioException catch (e) {
    print('Exception when calling ViewCustomApi->oBPv121DeleteViewForBankAccount: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ViewCustomApi->oBPv200GetPermissionsForBankAccount: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ViewCustomApi->oBPv300GetAccountsHeld: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ViewCustomApi->oBPv300GetPermissionForUserForBankAccount: $e\n');
}
```
...
final String accountid = accountid_example; // String | The ACCOUNTID identifier
final String viewid = viewid_example; // String | The VIEWID identifier
final OBPv300UpdateViewForBankAccountRequest oBPv300UpdateViewForBankAccountRequest = {"type":"object","properties":{"allowed_actions":{"type":"array","items":{"type":"string"}},"description":{"type":"string"},"hide_metadata_if_alias_used":{"type":"boolean"},"metadata_view":{"type":"string"},"is_public":{"type":"boolean"},"which_alias_to_use":{"type":"string"}}}; // OBPv300UpdateViewForBankAccountRequest | Request body

try {
    final response = api.oBPv300UpdateViewForBankAccount(bankid, accountid, viewid, oBPv300UpdateViewForBankAccountRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling ViewCustomApi->oBPv300UpdateViewForBankAccount: $e\n');
}
```
...
try {
    final response = api.oBPv500GetViewsForBankAccount(bankid, accountid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling ViewCustomApi->oBPv500GetViewsForBankAccount: $e\n');
}
```
...
final String accountid = accountid_example; // String | The ACCOUNTID identifier
final String viewid = viewid_example; // String | The VIEWID identifier
final OBPv510CreateCustomViewRequest oBPv510CreateCustomViewRequest = {"type":"object","properties":{"allowed_permissions":{"type":"array","items":{"type":"string"}},"hide_metadata_if_alias_used":{"type":"boolean"},"description":{"type":"string"},"is_public":{"type":"boolean"},"metadata_view":{"type":"string"},"which_alias_to_use":{"type":"string"},"name":{"type":"string"}}}; // OBPv510CreateCustomViewRequest | Request body

try {
    final response = api.oBPv510CreateCustomView(bankid, accountid, viewid, oBPv510CreateCustomViewRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling ViewCustomApi->oBPv510CreateCustomView: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ViewCustomApi->oBPv510CreateUserWithAccountAccessById: $e\n');
}
```
...
final String accountid = accountid_example; // String | The ACCOUNTID identifier
final String viewid = viewid_example; // String | The VIEWID identifier
final String targetviewid = targetviewid_example; // String | The TARGETVIEWID identifier

try {
    api.oBPv510DeleteCustomView(bankid, accountid, viewid, targetviewid);
} on DioException catch (e) {
    print('Exception when calling ViewCustomApi->oBPv510DeleteCustomView: $e\n');
}
```
...
try {
    final response = api.oBPv510GetCustomView(bankid, accountid, viewid, targetviewid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling ViewCustomApi->oBPv510GetCustomView: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ViewCustomApi->oBPv510GrantUserAccessToViewById: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ViewCustomApi->oBPv510RevokeUserAccessToViewById: $e\n');
}
```
...
final String viewid = viewid_example; // String | The VIEWID identifier
final String targetviewid = targetviewid_example; // String | The TARGETVIEWID identifier
final OBPv510UpdateCustomViewRequest oBPv510UpdateCustomViewRequest = {"type":"object","properties":{"allowed_permissions":{"type":"array","items":{"type":"string"}},"hide_metadata_if_alias_used":{"type":"boolean"},"description":{"type":"string"},"is_public":{"type":"boolean"},"metadata_view":{"type":"string"},"which_alias_to_use":{"type":"string"}}}; // OBPv510UpdateCustomViewRequest | Request body

try {
    final response = api.oBPv510UpdateCustomView(bankid, accountid, viewid, targetviewid, oBPv510UpdateCustomViewRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling ViewCustomApi->oBPv510UpdateCustomView: $e\n');
}
```
...
try {
    final response = api.oBPv600CreateCustomViewManagement(bankid, accountid, oBPv600CreateCustomViewManagementRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling ViewCustomApi->oBPv600CreateCustomViewManagement: $e\n');
}
```
...
try {
    final response = api.oBPv600GetCustomViews();
    print(response);
} on DioException catch (e) {
    print('Exception when calling ViewCustomApi->oBPv600GetCustomViews: $e\n');
}
```
...
try {
    final response = api.oBPv600GetSystemViewById(viewid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling ViewCustomApi->oBPv600GetSystemViewById: $e\n');
}
```
...
try {
    final response = api.oBPv600GetSystemViews();
    print(response);
} on DioException catch (e) {
    print('Exception when calling ViewCustomApi->oBPv600GetSystemViews: $e\n');
}
```
...
try {
    final response = api.oBPv600GetViewPermissions();
    print(response);
} on DioException catch (e) {
    print('Exception when calling ViewCustomApi->oBPv600GetViewPermissions: $e\n');
}
```
...
try {
    final response = api.oBPv600HasAccountAccess(bankid, accountid, viewid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling ViewCustomApi->oBPv600HasAccountAccess: $e\n');
}
```
...
final api = ObpDart().getViewCustomApi();
final String viewid = viewid_example; // String | The VIEWID identifier
final OBPv600UpdateSystemViewRequest oBPv600UpdateSystemViewRequest = {"type":"object","properties":{"is_firehose":{"type":"boolean"},"which_alias_to_use":{"type":"string"},"hide_metadata_if_alias_used":{"type":"boolean"},"allowed_actions":{"type":"array","items":{"type":"string"}},"can_grant_access_to_views":{"type":"array","items":{"type":"string"}},"is_public":{"type":"boolean"},"metadata_view":{"type":"string"},"description":{"type":"string"},"can_revoke_access_to_views":{"type":"array","items":{"type":"string"}}}}; // OBPv600UpdateSystemViewRequest | Request body

try {
    final response = api.oBPv600UpdateSystemView(viewid, oBPv600UpdateSystemViewRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling ViewCustomApi->oBPv600UpdateSystemView: $e\n');
}
```
