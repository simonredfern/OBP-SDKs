...
final api = ObpDart().getMetricApi();

try {
    final response = api.oBPv200ElasticSearchMetrics();
    print(response);
} on DioException catch (e) {
    print('Exception when calling MetricApi->oBPv200ElasticSearchMetrics: $e\n');
}
```
...
try {
    ...
    print('Exception when calling MetricApi->oBPv220GetConnectorMetrics: $e\n');
}
```
...
try {
    final response = api.oBPv310GetMetricsTopConsumers();
    print(response);
} on DioException catch (e) {
    print('Exception when calling MetricApi->oBPv310GetMetricsTopConsumers: $e\n');
}
```
...
try {
    ...
    print('Exception when calling MetricApi->oBPv500GetMetricsAtBank: $e\n');
}
```
...
try {
    ...
    print('Exception when calling MetricApi->oBPv600GetAggregateMetrics: $e\n');
}
```
...
try {
    ...
    print('Exception when calling MetricApi->oBPv600GetConnectorCallCounts: $e\n');
}
```
...
try {
    ...
    print('Exception when calling MetricApi->oBPv600GetConnectorTraces: $e\n');
}
```
...
try {
    ...
    print('Exception when calling MetricApi->oBPv600GetMetrics: $e\n');
}
```
...
try {
    ...
    print('Exception when calling MetricApi->oBPv600GetPopularApis: $e\n');
}
```
...
try {
    ...
    print('Exception when calling MetricApi->oBPv600GetTopAPIs: $e\n');
}
```
