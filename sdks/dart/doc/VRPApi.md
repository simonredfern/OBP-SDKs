...
try {
    ...
    print('Exception when calling VRPApi->oBPv500CreateConsentByConsentRequestIdEmail: $e\n');
}
```
...
try {
    ...
    print('Exception when calling VRPApi->oBPv510CreateVRPConsentRequest: $e\n');
}
```
