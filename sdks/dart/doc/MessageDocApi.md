...
final api = ObpDart().getMessageDocApi();
...
try {
    ...
    print('Exception when calling MessageDocApi->oBPv220GetMessageDocs: $e\n');
}
```
...
try {
    ...
    print('Exception when calling MessageDocApi->oBPv310GetMessageDocsSwagger: $e\n');
}
```
...
try {
    ...
    print('Exception when calling MessageDocApi->oBPv600GetMessageDocsJsonSchema: $e\n');
}
```
