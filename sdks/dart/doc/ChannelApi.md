...
final api = ObpDart().getChannelApi();
...
try {
    ...
    print('Exception when calling ChannelApi->oBPv600DeleteSignalChannel: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ChannelApi->oBPv600GetSignalChannelInfo: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ChannelApi->oBPv600GetSignalChannels: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ChannelApi->oBPv600GetSignalMessages: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ChannelApi->oBPv600GetSignalStats: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ChannelApi->oBPv600PublishSignalMessage: $e\n');
}
```
