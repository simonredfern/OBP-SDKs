...
final api = ObpDart().getFirehoseDataApi();
...
try {
    ...
    print('Exception when calling FirehoseDataApi->oBPv300GetFirehoseTransactionsForBankAccount: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FirehoseDataApi->oBPv310GetFirehoseCustomers: $e\n');
}
```
...
try {
    final response = api.oBPv400GetFastFirehoseAccountsAtOneBank(bankid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling FirehoseDataApi->oBPv400GetFastFirehoseAccountsAtOneBank: $e\n');
}
```
...
try {
    final response = api.oBPv400GetFirehoseAccountsAtOneBank(bankid, viewid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling FirehoseDataApi->oBPv400GetFirehoseAccountsAtOneBank: $e\n');
}
```
