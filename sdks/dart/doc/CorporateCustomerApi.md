# obp_dart.api.CorporateCustomerApi
...
final api = ObpDart().getCorporateCustomerApi();
...
try {
    ...
    print('Exception when calling CorporateCustomerApi->oBPv600CreateCorporateCustomer: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CorporateCustomerApi->oBPv600GetCorporateCustomerByCustomerId: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CorporateCustomerApi->oBPv600GetCorporateCustomerSubsidiaries: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CorporateCustomerApi->oBPv600GetCorporateCustomersAtOneBank: $e\n');
}
```
