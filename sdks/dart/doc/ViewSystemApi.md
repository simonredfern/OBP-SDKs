...
final api = ObpDart().getViewSystemApi();
final OBPv500CreateSystemViewRequest oBPv500CreateSystemViewRequest = {"type":"object","properties":{"hide_metadata_if_alias_used":{"type":"boolean"},"description":{"type":"string"},"is_public":{"type":"boolean"},"which_alias_to_use":{"type":"string"},"can_revoke_access_to_views":{"type":"array","items":{"type":"string"}},"can_grant_access_to_views":{"type":"array","items":{"type":"string"}},"name":{"type":"string"},"allowed_actions":{"type":"array","items":{"type":"string"}},"metadata_view":{"type":"string"}}}; // OBPv500CreateSystemViewRequest | Request body

try {
    final response = api.oBPv500CreateSystemView(oBPv500CreateSystemViewRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling ViewSystemApi->oBPv500CreateSystemView: $e\n');
}
```
...
try {
    api.oBPv500DeleteSystemView(viewid);
} on DioException catch (e) {
    print('Exception when calling ViewSystemApi->oBPv500DeleteSystemView: $e\n');
}
```
...
try {
    final response = api.oBPv500GetSystemView(viewid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling ViewSystemApi->oBPv500GetSystemView: $e\n');
}
```
...
try {
    final response = api.oBPv500GetSystemViewsIds();
    print(response);
} on DioException catch (e) {
    print('Exception when calling ViewSystemApi->oBPv500GetSystemViewsIds: $e\n');
}
```
...
final api = ObpDart().getViewSystemApi();
final String viewid = viewid_example; // String | The VIEWID identifier
final OBPv510AddSystemViewPermissionRequest oBPv510AddSystemViewPermissionRequest = {"type":"object","properties":{"extra_data":{"type":"array","items":{"type":"string"}},"permission_name":{"type":"string"}}}; // OBPv510AddSystemViewPermissionRequest | Request body

try {
    final response = api.oBPv510AddSystemViewPermission(viewid, oBPv510AddSystemViewPermissionRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling ViewSystemApi->oBPv510AddSystemViewPermission: $e\n');
}
```
...
final api = ObpDart().getViewSystemApi();
final String viewid = viewid_example; // String | The VIEWID identifier
final String permissionname = permissionname_example; // String | The PERMISSIONNAME identifier

try {
    api.oBPv510DeleteSystemViewPermission(viewid, permissionname);
} on DioException catch (e) {
    print('Exception when calling ViewSystemApi->oBPv510DeleteSystemViewPermission: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ViewSystemApi->oBPv600GetCustomViews: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ViewSystemApi->oBPv600GetSystemViewById: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ViewSystemApi->oBPv600GetSystemViews: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ViewSystemApi->oBPv600GetViewPermissions: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ViewSystemApi->oBPv600UpdateSystemView: $e\n');
}
```
