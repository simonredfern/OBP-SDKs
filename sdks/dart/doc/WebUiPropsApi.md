...
final OBPv400CreateTransactionRequestCounterparty200ResponsePropertiesAttributesItems oBPv400CreateTransactionRequestCounterparty200ResponsePropertiesAttributesItems = {"type":"object","properties":{"name":{"type":"string"},"value":{"type":"string"}}}; // OBPv400CreateTransactionRequestCounterparty200ResponsePropertiesAttributesItems | Request body

try {
    final response = api.oBPv310CreateWebUiProps(oBPv400CreateTransactionRequestCounterparty200ResponsePropertiesAttributesItems);
    print(response);
} on DioException catch (e) {
    print('Exception when calling WebUiPropsApi->oBPv310CreateWebUiProps: $e\n');
}
```
...
final api = ObpDart().getWebUiPropsApi();
final String webuipropsid = webuipropsid_example; // String | The WEBUIPROPSID identifier

try {
    api.oBPv310DeleteWebUiProps(webuipropsid);
} on DioException catch (e) {
    print('Exception when calling WebUiPropsApi->oBPv310DeleteWebUiProps: $e\n');
}
```
...
try {
    final response = api.oBPv310GetWebUiProps();
    print(response);
} on DioException catch (e) {
    print('Exception when calling WebUiPropsApi->oBPv310GetWebUiProps: $e\n');
}
```
...
try {
    final response = api.oBPv600CreateOrUpdateWebUiProps(webuipropname, oBPv400DeleteSystemLevelEndpointTag200Response);
    print(response);
} on DioException catch (e) {
    print('Exception when calling WebUiPropsApi->oBPv600CreateOrUpdateWebUiProps: $e\n');
}
```
...
try {
    ...
    print('Exception when calling WebUiPropsApi->oBPv600DeleteWebUiProps: $e\n');
}
```
...
try {
    final response = api.oBPv600GetWebUiProp(webuipropname);
    print(response);
} on DioException catch (e) {
    print('Exception when calling WebUiPropsApi->oBPv600GetWebUiProp: $e\n');
}
```
...
try {
    final response = api.oBPv600GetWebUiProps();
    print(response);
} on DioException catch (e) {
    print('Exception when calling WebUiPropsApi->oBPv600GetWebUiProps: $e\n');
}
```
