...
final OBPv310CreateAccountApplicationRequest oBPv310CreateAccountApplicationRequest = {"type":"object","properties":{"user_id":{"type":"string"},"product_code":{"type":"string"},"customer_id":{"type":"string"}}}; // OBPv310CreateAccountApplicationRequest | Request body

try {
    final response = api.oBPv310CreateAccountApplication(bankid, oBPv310CreateAccountApplicationRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApplicationApi->oBPv310CreateAccountApplication: $e\n');
}
```
...
try {
    final response = api.oBPv310GetAccountApplication(bankid, accountapplicationid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApplicationApi->oBPv310GetAccountApplication: $e\n');
}
```
...
try {
    final response = api.oBPv310GetAccountApplications(bankid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApplicationApi->oBPv310GetAccountApplications: $e\n');
}
```
...
try {
    final response = api.oBPv310UpdateAccountApplicationStatus(bankid, accountapplicationid, oBPv510UpdateTransactionRequestStatusRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApplicationApi->oBPv310UpdateAccountApplicationStatus: $e\n');
}
```
