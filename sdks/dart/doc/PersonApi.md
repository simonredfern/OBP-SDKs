...
final api = ObpDart().getPersonApi();
...
try {
    ...
    print('Exception when calling PersonApi->oBPv140AddCustomerMessage: $e\n');
}
```
...
try {
    ...
    print('Exception when calling PersonApi->oBPv400CreateCustomerMessage: $e\n');
}
```
...
try {
    ...
    print('Exception when calling PersonApi->oBPv510CreateAgent: $e\n');
}
```
...
try {
    ...
    print('Exception when calling PersonApi->oBPv510UpdateAgentStatus: $e\n');
}
```
...
try {
    ...
    print('Exception when calling PersonApi->oBPv600CreateCustomer: $e\n');
}
```
