...
final api = ObpDart().getCardApi();

try {
    final response = api.oBPv130GetCards();
    print(response);
} on DioException catch (e) {
    print('Exception when calling CardApi->oBPv130GetCards: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CardApi->oBPv310CreateCardAttribute: $e\n');
}
```
...
try {
    api.oBPv310DeleteCardForBank(bankid, cardid);
} on DioException catch (e) {
    print('Exception when calling CardApi->oBPv310DeleteCardForBank: $e\n');
}
```
...
try {
    final response = api.oBPv310GetCardForBank(bankid, cardid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling CardApi->oBPv310GetCardForBank: $e\n');
}
```
...
try {
    final response = api.oBPv310GetCardsForBank(bankid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling CardApi->oBPv310GetCardsForBank: $e\n');
}
```
...
try {
    final response = api.oBPv310GetStatusOfCreditCardOrder(bankid, accountid, viewid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling CardApi->oBPv310GetStatusOfCreditCardOrder: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CardApi->oBPv310UpdateCardAttribute: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CardApi->oBPv400CreateOrUpdateCardAttributeDefinition: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CardApi->oBPv400DeleteCardAttributeDefinition: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CardApi->oBPv400GetCardAttributeDefinition: $e\n');
}
```
...
final api = ObpDart().getCardApi();
final String bankid = bankid_example; // String | The BANKID identifier
final OBPv500AddCardForBankRequest oBPv500AddCardForBankRequest = {"type":"object","properties":{"posted":{"type":"string","format":"date-time"},"card_number":{"type":"string"},"enabled":{"type":"boolean"},"allows":{"type":"array","items":{"type":"string"}},"technology":{"type":"string"},"pin_reset":{"type":"array","items":{"type":"object","properties":{"reason_requested":{"type":"string"},"requested_date":{"type":"string","format":"date-time"}}}},"card_type":{"type":"string"},"name_on_card":{"type":"string"},"expires_date":{"type":"string","format":"date-time"},"customer_id":{"type":"string"},"collected":{"type":"string","format":"date-time"},"replacement":{"type":"object","properties":{"reason_requested":{"type":"string"},"requested_date":{"type":"string","format":"date-time"}}},"brand":{"type":"string"},"issue_number":{"type":"string"},"serial_number":{"type":"string"},"networks":{"type":"array","items":{"type":"string"}},"account_id":{"type":"string"},"valid_from_date":{"type":"string","format":"date-time"}}}; // OBPv500AddCardForBankRequest | Request body

try {
    final response = api.oBPv500AddCardForBank(bankid, oBPv500AddCardForBankRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling CardApi->oBPv500AddCardForBank: $e\n');
}
```
