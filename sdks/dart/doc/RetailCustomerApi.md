# obp_dart.api.RetailCustomerApi
...
final api = ObpDart().getRetailCustomerApi();
...
try {
    ...
    print('Exception when calling RetailCustomerApi->oBPv600CreateRetailCustomer: $e\n');
}
```
...
try {
    ...
    print('Exception when calling RetailCustomerApi->oBPv600GetRetailCustomerByCustomerId: $e\n');
}
```
...
try {
    ...
    print('Exception when calling RetailCustomerApi->oBPv600GetRetailCustomersAtOneBank: $e\n');
}
```
