...
final api = ObpDart().getOIDCApi();

try {
    final response = api.oBPv310GetOAuth2ServerJWKsURIs();
    print(response);
} on DioException catch (e) {
    print('Exception when calling OIDCApi->oBPv310GetOAuth2ServerJWKsURIs: $e\n');
}
```
...
try {
    ...
    print('Exception when calling OIDCApi->oBPv310GetObpConnectorLoopback: $e\n');
}
```
...
try {
    ...
    print('Exception when calling OIDCApi->oBPv600GetOidcClient: $e\n');
}
```
...
try {
    ...
    print('Exception when calling OIDCApi->oBPv600VerifyOidcClient: $e\n');
}
```
