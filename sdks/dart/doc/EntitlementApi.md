...
final api = ObpDart().getEntitlementApi();
...
try {
    ...
    print('Exception when calling EntitlementApi->oBPv200AddEntitlement: $e\n');
}
```
...
try {
    ...
    print('Exception when calling EntitlementApi->oBPv200DeleteEntitlement: $e\n');
}
```
...
try {
    ...
    print('Exception when calling EntitlementApi->oBPv200GetPermissionsForBankAccount: $e\n');
}
```
...
try {
    ...
    print('Exception when calling EntitlementApi->oBPv210GetEntitlementsByBankAndUser: $e\n');
}
```
...
try {
    ...
    print('Exception when calling EntitlementApi->oBPv300AddEntitlementRequest: $e\n');
}
```
...
try {
    ...
    print('Exception when calling EntitlementApi->oBPv300DeleteEntitlementRequest: $e\n');
}
```
...
try {
    ...
    print('Exception when calling EntitlementApi->oBPv300GetAllEntitlementRequests: $e\n');
}
```
...
try {
    ...
    print('Exception when calling EntitlementApi->oBPv300GetEntitlementRequests: $e\n');
}
```
...
try {
    ...
    print('Exception when calling EntitlementApi->oBPv300GetEntitlementRequestsForCurrentUser: $e\n');
}
```
...
try {
    ...
    print('Exception when calling EntitlementApi->oBPv300GetEntitlementsForCurrentUser: $e\n');
}
```
...
try {
    final response = api.oBPv310GetAllEntitlements();
    print(response);
} on DioException catch (e) {
    print('Exception when calling EntitlementApi->oBPv310GetAllEntitlements: $e\n');
}
```
...
try {
    ...
    print('Exception when calling EntitlementApi->oBPv400CreateUserWithRoles: $e\n');
}
```
...
try {
    ...
    print('Exception when calling EntitlementApi->oBPv400GetEntitlements: $e\n');
}
```
...
try {
    ...
    print('Exception when calling EntitlementApi->oBPv400GetEntitlementsForBank: $e\n');
}
```
...
try {
    ...
    print('Exception when calling EntitlementApi->oBPv510GetEntitlementsAndPermissions: $e\n');
}
```
...
try {
    ...
    print('Exception when calling EntitlementApi->oBPv600AddUserToGroup: $e\n');
}
```
...
try {
    ...
    print('Exception when calling EntitlementApi->oBPv600DeleteEntitlement: $e\n');
}
```
...
try {
    ...
    print('Exception when calling EntitlementApi->oBPv600GetGroupEntitlements: $e\n');
}
```
...
try {
    final response = api.oBPv600GetRolesWithEntitlementCountsAtAllBanks();
    print(response);
} on DioException catch (e) {
    print('Exception when calling EntitlementApi->oBPv600GetRolesWithEntitlementCountsAtAllBanks: $e\n');
}
```
...
try {
    ...
    print('Exception when calling EntitlementApi->oBPv600GetUserGroupMemberships: $e\n');
}
```
...
try {
    ...
    print('Exception when calling EntitlementApi->oBPv600RemoveUserFromGroup: $e\n');
}
```
