...
try {
    ...
    print('Exception when calling UserInvitationApi->oBPv400CreateUserInvitation: $e\n');
}
```
...
try {
    final response = api.oBPv400GetUserInvitation(bankid, secretlink);
    print(response);
} on DioException catch (e) {
    print('Exception when calling UserInvitationApi->oBPv400GetUserInvitation: $e\n');
}
```
...
try {
    ...
    print('Exception when calling UserInvitationApi->oBPv400GetUserInvitationAnonymous: $e\n');
}
```
...
try {
    final response = api.oBPv400GetUserInvitations(bankid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling UserInvitationApi->oBPv400GetUserInvitations: $e\n');
}
```
