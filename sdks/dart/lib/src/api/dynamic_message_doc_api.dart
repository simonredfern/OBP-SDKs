...
class DynamicMessageDocApi {
  ...
  const DynamicMessageDocApi(this._dio, this._serializers);
  ...
  Future<Response<OBPv400GetDynamicMessageDoc200Response>> oBPv400CreateBankLevelDynamicMessageDoc({ 
    ...
    final _path = r'/obp/v4.0.0/management/banks/{bankid}/dynamic-message-docs'.replaceAll('{' r'bankid' '}', encodeQueryParameter(_serializers, bankid, const FullType(String)).toString());
  ...
  Future<Response<OBPv400GetDynamicMessageDoc200Response>> oBPv400CreateDynamicMessageDoc({ 
    ...
    final _path = r'/obp/v4.0.0/management/dynamic-message-docs';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> oBPv400DeleteBankLevelDynamicMessageDoc({ 
    ...
    final _path = r'/obp/v4.0.0/management/banks/{bankid}/dynamic-message-docs/{dynamicmessagedocid}'.replaceAll('{' r'bankid' '}', encodeQueryParameter(_serializers, bankid, const FullType(String)).toString()).replaceAll('{' r'dynamicmessagedocid' '}', encodeQueryParameter(_serializers, dynamicmessagedocid, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> oBPv400DeleteDynamicMessageDoc({ 
    ...
    final _path = r'/obp/v4.0.0/management/dynamic-message-docs/{dynamicmessagedocid}'.replaceAll('{' r'dynamicmessagedocid' '}', encodeQueryParameter(_serializers, dynamicmessagedocid, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
