...
class BankApi {
  ...
  const BankApi(this._dio, this._serializers);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [OBPv210CreateTransactionType200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OBPv210CreateTransactionType200Response>> oBPv210CreateTransactionType({ 
    required String bankid,
    required OBPv200GetTransactionTypes200ResponsePropertiesTransactionTypesItems oBPv200GetTransactionTypes200ResponsePropertiesTransactionTypesItems,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/obp/v2.1.0/banks/{bankid}/transaction-types'.replaceAll('{' r'bankid' '}', encodeQueryParameter(_serializers, bankid, const FullType(String)).toString());
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(OBPv200GetTransactionTypes200ResponsePropertiesTransactionTypesItems);
      _bodyData = _serializers.serialize(oBPv200GetTransactionTypes200ResponsePropertiesTransactionTypesItems, specifiedType: _type);
    ...
    OBPv210CreateTransactionType200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(OBPv210CreateTransactionType200Response),
      ) as OBPv210CreateTransactionType200Response;
    ...
    return Response<OBPv210CreateTransactionType200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<OBPv300GetBranches200ResponsePropertiesBranchesItems>> oBPv300GetBranch({ 
    ...
    final _path = r'/obp/v3.0.0/banks/{bankid}/branches/{branchid}'.replaceAll('{' r'bankid' '}', encodeQueryParameter(_serializers, bankid, const FullType(String)).toString()).replaceAll('{' r'branchid' '}', encodeQueryParameter(_serializers, branchid, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<OBPv300GetBranches200Response>> oBPv300GetBranches({ 
    ...
    final _path = r'/obp/v3.0.0/banks/{bankid}/branches'.replaceAll('{' r'bankid' '}', encodeQueryParameter(_serializers, bankid, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [OBPv400CreateSettlementAccount200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OBPv400CreateSettlementAccount200Response>> oBPv400CreateSettlementAccount({ 
    required String bankid,
    required OBPv400CreateSettlementAccountRequest oBPv400CreateSettlementAccountRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(OBPv400CreateSettlementAccountRequest);
      _bodyData = _serializers.serialize(oBPv400CreateSettlementAccountRequest, specifiedType: _type);
    ...
    OBPv400CreateSettlementAccount200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(OBPv400CreateSettlementAccount200Response),
      ) as OBPv400CreateSettlementAccount200Response;
    ...
    return Response<OBPv400CreateSettlementAccount200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> oBPv400DeleteBankCascade({ 
    required String bankid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/obp/v4.0.0/management/cascading/banks/{bankid}'.replaceAll('{' r'bankid' '}', encodeQueryParameter(_serializers, bankid, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [OBPv500UpdateBank200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OBPv500UpdateBank200Response>> oBPv500UpdateBank({ 
    required OBPv500UpdateBankRequest oBPv500UpdateBankRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/obp/v5.0.0/banks';
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(OBPv500UpdateBankRequest);
      _bodyData = _serializers.serialize(oBPv500UpdateBankRequest, specifiedType: _type);
    ...
    OBPv500UpdateBank200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(OBPv500UpdateBank200Response),
      ) as OBPv500UpdateBank200Response;
    ...
    return Response<OBPv500UpdateBank200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OBPv600GetBank200Response>> oBPv600CreateBank({ 
    required OBPv600CreateBankRequest oBPv600CreateBankRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(OBPv600CreateBankRequest);
      _bodyData = _serializers.serialize(oBPv600CreateBankRequest, specifiedType: _type);
