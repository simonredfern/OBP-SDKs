...
class SystemIntegrityApi {
  ...
  const SystemIntegrityApi(this._dio, this._serializers);
  ...
  Future<Response<OBPv121UpdateTransactionNarrative200Response>> oBPv510AccountAccessUniqueIndexCheck({ 
    ...
    final _path = r'/obp/v5.1.0/management/system/integrity/account-access-unique-index-1-check';
  ...
  Future<Response<OBPv121UpdateTransactionNarrative200Response>> oBPv510AccountCurrencyCheck({ 
    ...
    final _path = r'/obp/v5.1.0/management/system/integrity/banks/{bankid}/account-currency-check'.replaceAll('{' r'bankid' '}', encodeQueryParameter(_serializers, bankid, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<OBPv121UpdateTransactionNarrative200Response>> oBPv510CustomViewNamesCheck({ 
    ...
    final _path = r'/obp/v5.1.0/management/system/integrity/custom-view-names-check';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<OBPv121UpdateTransactionNarrative200Response>> oBPv510OrphanedAccountCheck({ 
    ...
    final _path = r'/obp/v5.1.0/management/system/integrity/banks/{bankid}/orphaned-account-check'.replaceAll('{' r'bankid' '}', encodeQueryParameter(_serializers, bankid, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<OBPv121UpdateTransactionNarrative200Response>> oBPv510SystemViewNamesCheck({ 
    ...
    final _path = r'/obp/v5.1.0/management/system/integrity/system-view-names-check';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
