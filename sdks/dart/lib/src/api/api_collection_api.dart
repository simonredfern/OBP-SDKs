...
class ApiCollectionApi {
  ...
  Future<Response<OBPv400GetApiCollectionsForUser200ResponsePropertiesApiCollectionsItems>> oBPv400CreateMyApiCollection({ 
    ...
    final _path = r'/obp/v4.0.0/my/api-collections';
  ...
  Future<Response<OBPv400GetMyApiCollectionEndpoints200ResponsePropertiesApiCollectionEndpointsItems>> oBPv400CreateMyApiCollectionEndpoint({ 
    ...
    final _path = r'/obp/v4.0.0/my/api-collections/{apicollectionname}/api-collection-endpoints'.replaceAll('{' r'apicollectionname' '}', encodeQueryParameter(_serializers, apicollectionname, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<OBPv400GetMyApiCollectionEndpoints200ResponsePropertiesApiCollectionEndpointsItems>> oBPv400CreateMyApiCollectionEndpointById({ 
    ...
    final _path = r'/obp/v4.0.0/my/api-collection-ids/{apicollectionid}/api-collection-endpoints'.replaceAll('{' r'apicollectionid' '}', encodeQueryParameter(_serializers, apicollectionid, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<OBPv400DeleteSystemLevelEndpointTag200Response>> oBPv400DeleteMyApiCollection({ 
    ...
    final _path = r'/obp/v4.0.0/my/api-collections/{apicollectionid}'.replaceAll('{' r'apicollectionid' '}', encodeQueryParameter(_serializers, apicollectionid, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<OBPv400DeleteSystemLevelEndpointTag200Response>> oBPv400DeleteMyApiCollectionEndpoint({ 
    ...
    final _path = r'/obp/v4.0.0/my/api-collections/{apicollectionname}/api-collection-endpoints/{operationid}'.replaceAll('{' r'apicollectionname' '}', encodeQueryParameter(_serializers, apicollectionname, const FullType(String)).toString()).replaceAll('{' r'operationid' '}', encodeQueryParameter(_serializers, operationid, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Parameters:
  /// * [apicollectionid] - The APICOLLECTIONID identifier
  /// * [apicollectionendpointid] - The APICOLLECTIONENDPOINTID identifier
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<OBPv400DeleteSystemLevelEndpointTag200Response>> oBPv400DeleteMyApiCollectionEndpointById({ 
    ...
    final _path = r'/obp/v4.0.0/my/api-collection-ids/{apicollectionid}/api-collection-endpoint-ids/{apicollectionendpointid}'.replaceAll('{' r'apicollectionid' '}', encodeQueryParameter(_serializers, apicollectionid, const FullType(String)).toString()).replaceAll('{' r'apicollectionendpointid' '}', encodeQueryParameter(_serializers, apicollectionendpointid, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<OBPv400DeleteSystemLevelEndpointTag200Response>> oBPv400DeleteMyApiCollectionEndpointByOperationId({ 
    ...
    final _path = r'/obp/v4.0.0/my/api-collection-ids/{apicollectionid}/api-collection-endpoints/{operationid}'.replaceAll('{' r'apicollectionid' '}', encodeQueryParameter(_serializers, apicollectionid, const FullType(String)).toString()).replaceAll('{' r'operationid' '}', encodeQueryParameter(_serializers, operationid, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<OBPv400GetMyApiCollectionEndpoints200Response>> oBPv400GetApiCollectionEndpoints({ 
    ...
    final _path = r'/obp/v4.0.0/api-collections/{apicollectionid}/api-collection-endpoints'.replaceAll('{' r'apicollectionid' '}', encodeQueryParameter(_serializers, apicollectionid, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<OBPv400GetApiCollectionsForUser200Response>> oBPv400GetApiCollectionsForUser({ 
    ...
    final _path = r'/obp/v4.0.0/users/{userid}/api-collections'.replaceAll('{' r'userid' '}', encodeQueryParameter(_serializers, userid, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<OBPv400GetApiCollectionsForUser200Response>> oBPv400GetFeaturedApiCollections({ 
    ...
    final _path = r'/obp/v4.0.0/api-collections/featured';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<OBPv400GetApiCollectionsForUser200ResponsePropertiesApiCollectionsItems>> oBPv400GetMyApiCollectionByName({ 
    ...
    final _path = r'/obp/v4.0.0/my/api-collections/name/{apicollectionname}'.replaceAll('{' r'apicollectionname' '}', encodeQueryParameter(_serializers, apicollectionname, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<OBPv400GetApiCollectionsForUser200ResponsePropertiesApiCollectionsItems>> oBPv400GetSharableApiCollectionById({ 
    ...
    final _path = r'/obp/v4.0.0/api-collections/sharable/{apicollectionid}'.replaceAll('{' r'apicollectionid' '}', encodeQueryParameter(_serializers, apicollectionid, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<OBPv400GetApiCollectionsForUser200ResponsePropertiesApiCollectionsItems>> oBPv510UpdateMyApiCollection({ 
    ...
    final _path = r'/obp/v5.1.0/my/api-collections/{apicollectionid}'.replaceAll('{' r'apicollectionid' '}', encodeQueryParameter(_serializers, apicollectionid, const FullType(String)).toString());
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
