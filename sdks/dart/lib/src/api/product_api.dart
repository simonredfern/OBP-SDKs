...
class ProductApi {
  ...
  Future<Response<OBPv310CreateProductCollection200Response>> oBPv310CreateProductCollection({ 
    ...
    final _path = r'/obp/v3.1.0/banks/{bankid}/product-collections/{collectioncode}'.replaceAll('{' r'bankid' '}', encodeQueryParameter(_serializers, bankid, const FullType(String)).toString()).replaceAll('{' r'collectioncode' '}', encodeQueryParameter(_serializers, collectioncode, const FullType(String)).toString());
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [OBPv310GetProductTree200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OBPv310GetProductTree200Response>> oBPv310GetProductTree({ 
    required String bankid,
    required String productcode,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/obp/v3.1.0/banks/{bankid}/product-tree/{productcode}'.replaceAll('{' r'bankid' '}', encodeQueryParameter(_serializers, bankid, const FullType(String)).toString()).replaceAll('{' r'productcode' '}', encodeQueryParameter(_serializers, productcode, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    OBPv310GetProductTree200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(OBPv310GetProductTree200Response),
      ) as OBPv310GetProductTree200Response;
    ...
    return Response<OBPv310GetProductTree200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [bankid] - The BANKID identifier
  /// * [productcode] - The PRODUCTCODE identifier
  /// * [oBPv400UpdateProductFeeRequest] - Request body
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [OBPv400GetProductFee200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OBPv400GetProductFee200Response>> oBPv400CreateProductFee({ 
    required String bankid,
    required String productcode,
    required OBPv400UpdateProductFeeRequest oBPv400UpdateProductFeeRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/obp/v4.0.0/banks/{bankid}/products/{productcode}/fee'.replaceAll('{' r'bankid' '}', encodeQueryParameter(_serializers, bankid, const FullType(String)).toString()).replaceAll('{' r'productcode' '}', encodeQueryParameter(_serializers, productcode, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(OBPv400UpdateProductFeeRequest);
      _bodyData = _serializers.serialize(oBPv400UpdateProductFeeRequest, specifiedType: _type);
    ...
    OBPv400GetProductFee200Response? _responseData;
    ...
    return Response<OBPv400GetProductFee200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> oBPv400DeleteProductCascade({ 
    required String bankid,
    required String productcode,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/obp/v4.0.0/management/cascading/banks/{bankid}/products/{productcode}'.replaceAll('{' r'bankid' '}', encodeQueryParameter(_serializers, bankid, const FullType(String)).toString()).replaceAll('{' r'productcode' '}', encodeQueryParameter(_serializers, productcode, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [bankid] - The BANKID identifier
  /// * [productcode] - The PRODUCTCODE identifier
  /// * [productfeeid] - The PRODUCTFEEID identifier
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> oBPv400DeleteProductFee({ 
    required String bankid,
    required String productcode,
    required String productfeeid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/obp/v4.0.0/banks/{bankid}/products/{productcode}/fees/{productfeeid}'.replaceAll('{' r'bankid' '}', encodeQueryParameter(_serializers, bankid, const FullType(String)).toString()).replaceAll('{' r'productcode' '}', encodeQueryParameter(_serializers, productcode, const FullType(String)).toString()).replaceAll('{' r'productfeeid' '}', encodeQueryParameter(_serializers, productfeeid, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [OBPv400GetProduct200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OBPv400GetProduct200Response>> oBPv400GetProduct({ 
    required String bankid,
    required String productcode,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/obp/v4.0.0/banks/{bankid}/products/{productcode}'.replaceAll('{' r'bankid' '}', encodeQueryParameter(_serializers, bankid, const FullType(String)).toString()).replaceAll('{' r'productcode' '}', encodeQueryParameter(_serializers, productcode, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    OBPv400GetProduct200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(OBPv400GetProduct200Response),
      ) as OBPv400GetProduct200Response;
    ...
    return Response<OBPv400GetProduct200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [OBPv400GetProductFee200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OBPv400GetProductFee200Response>> oBPv400GetProductFee({ 
    required String bankid,
    required String productcode,
    required String productfeeid,
    CancelToken? cancelToken,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [OBPv400GetProductFees200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OBPv400GetProductFees200Response>> oBPv400GetProductFees({ 
    required String bankid,
    required String productcode,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/obp/v4.0.0/banks/{bankid}/products/{productcode}/fees'.replaceAll('{' r'bankid' '}', encodeQueryParameter(_serializers, bankid, const FullType(String)).toString()).replaceAll('{' r'productcode' '}', encodeQueryParameter(_serializers, productcode, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    OBPv400GetProductFees200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(OBPv400GetProductFees200Response),
      ) as OBPv400GetProductFees200Response;
    ...
    return Response<OBPv400GetProductFees200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [OBPv400GetProducts200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OBPv400GetProducts200Response>> oBPv400GetProducts({ 
    required String bankid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/obp/v4.0.0/banks/{bankid}/products'.replaceAll('{' r'bankid' '}', encodeQueryParameter(_serializers, bankid, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    OBPv400GetProducts200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(OBPv400GetProducts200Response),
      ) as OBPv400GetProducts200Response;
    ...
    return Response<OBPv400GetProducts200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [OBPv400GetProductFee200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OBPv400GetProductFee200Response>> oBPv400UpdateProductFee({ 
    required String bankid,
    required String productcode,
    required String productfeeid,
    required OBPv400UpdateProductFeeRequest oBPv400UpdateProductFeeRequest,
  ...
  /// * [bankid] - The BANKID identifier
  /// * [productcode] - The PRODUCTCODE identifier
  /// * [oBPv500CreateProductRequest] - Request body
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [OBPv500CreateProduct200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OBPv500CreateProduct200Response>> oBPv500CreateProduct({ 
    required String bankid,
    required String productcode,
    required OBPv500CreateProductRequest oBPv500CreateProductRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/obp/v5.0.0/banks/{bankid}/products/{productcode}'.replaceAll('{' r'bankid' '}', encodeQueryParameter(_serializers, bankid, const FullType(String)).toString()).replaceAll('{' r'productcode' '}', encodeQueryParameter(_serializers, productcode, const FullType(String)).toString());
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(OBPv500CreateProductRequest);
      _bodyData = _serializers.serialize(oBPv500CreateProductRequest, specifiedType: _type);
    ...
    OBPv500CreateProduct200Response? _responseData;
    ...
    return Response<OBPv500CreateProduct200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
