...
class DynamicResourceDocApi {
  ...
  const DynamicResourceDocApi(this._dio, this._serializers);
  ...
  Future<Response<OBPv400BuildDynamicEndpointTemplate200Response>> oBPv400BuildDynamicEndpointTemplate({ 
    ...
    final _path = r'/obp/v4.0.0/management/dynamic-resource-docs/endpoint-code';
  ...
  Future<Response<OBPv400GetBankLevelDynamicResourceDoc200Response>> oBPv400CreateBankLevelDynamicResourceDoc({ 
    ...
    final _path = r'/obp/v4.0.0/management/banks/{bankid}/dynamic-resource-docs'.replaceAll('{' r'bankid' '}', encodeQueryParameter(_serializers, bankid, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<OBPv400GetBankLevelDynamicResourceDoc200Response>> oBPv400CreateDynamicResourceDoc({ 
    ...
    final _path = r'/obp/v4.0.0/management/dynamic-resource-docs';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> oBPv400DeleteBankLevelDynamicResourceDoc({ 
    ...
    final _path = r'/obp/v4.0.0/management/banks/{bankid}/dynamic-resource-docs/DYNAMIC-RESOURCE-DOC-ID'.replaceAll('{' r'bankid' '}', encodeQueryParameter(_serializers, bankid, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> oBPv400DeleteDynamicResourceDoc({ 
    ...
    final _path = r'/obp/v4.0.0/management/dynamic-resource-docs/DYNAMIC-RESOURCE-DOC-ID';
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
