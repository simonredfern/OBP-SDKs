...
part 'obpv500_get_customer_overview200_response_properties.g.dart';
...
/// * [accounts] 
@BuiltValue()
abstract class OBPv500GetCustomerOverview200ResponseProperties implements Built<OBPv500GetCustomerOverview200ResponseProperties, OBPv500GetCustomerOverview200ResponsePropertiesBuilder> {
  ...
  OBPv500GetCustomerOverview200ResponsePropertiesAccounts get accounts;

  OBPv500GetCustomerOverview200ResponseProperties._();

  factory OBPv500GetCustomerOverview200ResponseProperties([void updates(OBPv500GetCustomerOverview200ResponsePropertiesBuilder b)]) = _$OBPv500GetCustomerOverview200ResponseProperties;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(OBPv500GetCustomerOverview200ResponsePropertiesBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<OBPv500GetCustomerOverview200ResponseProperties> get serializer => _$OBPv500GetCustomerOverview200ResponsePropertiesSerializer();
}

class _$OBPv500GetCustomerOverview200ResponsePropertiesSerializer implements PrimitiveSerializer<OBPv500GetCustomerOverview200ResponseProperties> {
  @override
  final Iterable<Type> types = const [OBPv500GetCustomerOverview200ResponseProperties, _$OBPv500GetCustomerOverview200ResponseProperties];

  @override
  final String wireName = r'OBPv500GetCustomerOverview200ResponseProperties';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    OBPv500GetCustomerOverview200ResponseProperties object, {
    ...
    yield serializers.serialize(
      object.accounts,
      specifiedType: const FullType(OBPv500GetCustomerOverview200ResponsePropertiesAccounts),
    );
  }
  ...
  void _deserializeProperties(
    ...
    required OBPv500GetCustomerOverview200ResponsePropertiesBuilder result,
      ...
      switch (key) {
        ...
        case r'accounts':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(OBPv500GetCustomerOverview200ResponsePropertiesAccounts),
          ) as OBPv500GetCustomerOverview200ResponsePropertiesAccounts;
  ...
  @override
  OBPv500GetCustomerOverview200ResponseProperties deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = OBPv500GetCustomerOverview200ResponsePropertiesBuilder();
