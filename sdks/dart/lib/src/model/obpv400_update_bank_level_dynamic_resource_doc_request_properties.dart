...
part 'obpv400_update_bank_level_dynamic_resource_doc_request_properties.g.dart';
...
/// * [summary] 
@BuiltValue()
abstract class OBPv400UpdateBankLevelDynamicResourceDocRequestProperties implements Built<OBPv400UpdateBankLevelDynamicResourceDocRequestProperties, OBPv400UpdateBankLevelDynamicResourceDocRequestPropertiesBuilder> {
  ...
  OBPv400UpdateBankLevelDynamicResourceDocRequestProperties._();

  factory OBPv400UpdateBankLevelDynamicResourceDocRequestProperties([void updates(OBPv400UpdateBankLevelDynamicResourceDocRequestPropertiesBuilder b)]) = _$OBPv400UpdateBankLevelDynamicResourceDocRequestProperties;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(OBPv400UpdateBankLevelDynamicResourceDocRequestPropertiesBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<OBPv400UpdateBankLevelDynamicResourceDocRequestProperties> get serializer => _$OBPv400UpdateBankLevelDynamicResourceDocRequestPropertiesSerializer();
}

class _$OBPv400UpdateBankLevelDynamicResourceDocRequestPropertiesSerializer implements PrimitiveSerializer<OBPv400UpdateBankLevelDynamicResourceDocRequestProperties> {
  @override
  final Iterable<Type> types = const [OBPv400UpdateBankLevelDynamicResourceDocRequestProperties, _$OBPv400UpdateBankLevelDynamicResourceDocRequestProperties];

  @override
  final String wireName = r'OBPv400UpdateBankLevelDynamicResourceDocRequestProperties';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    OBPv400UpdateBankLevelDynamicResourceDocRequestProperties object, {
  ...
  void _deserializeProperties(
    ...
    required OBPv400UpdateBankLevelDynamicResourceDocRequestPropertiesBuilder result,
  ...
  @override
  OBPv400UpdateBankLevelDynamicResourceDocRequestProperties deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = OBPv400UpdateBankLevelDynamicResourceDocRequestPropertiesBuilder();
