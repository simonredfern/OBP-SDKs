...
part 'obpv600_create_retail_customer_request_properties.g.dart';
...
/// * [kycStatus] 
@BuiltValue()
abstract class OBPv600CreateRetailCustomerRequestProperties implements Built<OBPv600CreateRetailCustomerRequestProperties, OBPv600CreateRetailCustomerRequestPropertiesBuilder> {
  ...
  OBPv600CreateRetailCustomerRequestProperties._();

  factory OBPv600CreateRetailCustomerRequestProperties([void updates(OBPv600CreateRetailCustomerRequestPropertiesBuilder b)]) = _$OBPv600CreateRetailCustomerRequestProperties;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(OBPv600CreateRetailCustomerRequestPropertiesBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<OBPv600CreateRetailCustomerRequestProperties> get serializer => _$OBPv600CreateRetailCustomerRequestPropertiesSerializer();
}

class _$OBPv600CreateRetailCustomerRequestPropertiesSerializer implements PrimitiveSerializer<OBPv600CreateRetailCustomerRequestProperties> {
  @override
  final Iterable<Type> types = const [OBPv600CreateRetailCustomerRequestProperties, _$OBPv600CreateRetailCustomerRequestProperties];

  @override
  final String wireName = r'OBPv600CreateRetailCustomerRequestProperties';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    OBPv600CreateRetailCustomerRequestProperties object, {
  ...
  void _deserializeProperties(
    ...
    required OBPv600CreateRetailCustomerRequestPropertiesBuilder result,
  ...
  @override
  OBPv600CreateRetailCustomerRequestProperties deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = OBPv600CreateRetailCustomerRequestPropertiesBuilder();
