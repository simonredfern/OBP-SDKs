...
part 'obpv600_create_customer_request_properties.g.dart';
...
/// * [kycStatus] 
@BuiltValue()
abstract class OBPv600CreateCustomerRequestProperties implements Built<OBPv600CreateCustomerRequestProperties, OBPv600CreateCustomerRequestPropertiesBuilder> {
  ...
  OBPv600CreateCustomerRequestProperties._();

  factory OBPv600CreateCustomerRequestProperties([void updates(OBPv600CreateCustomerRequestPropertiesBuilder b)]) = _$OBPv600CreateCustomerRequestProperties;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(OBPv600CreateCustomerRequestPropertiesBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<OBPv600CreateCustomerRequestProperties> get serializer => _$OBPv600CreateCustomerRequestPropertiesSerializer();
}

class _$OBPv600CreateCustomerRequestPropertiesSerializer implements PrimitiveSerializer<OBPv600CreateCustomerRequestProperties> {
  @override
  final Iterable<Type> types = const [OBPv600CreateCustomerRequestProperties, _$OBPv600CreateCustomerRequestProperties];

  @override
  final String wireName = r'OBPv600CreateCustomerRequestProperties';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    OBPv600CreateCustomerRequestProperties object, {
  ...
  void _deserializeProperties(
    ...
    required OBPv600CreateCustomerRequestPropertiesBuilder result,
  ...
  @override
  OBPv600CreateCustomerRequestProperties deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = OBPv600CreateCustomerRequestPropertiesBuilder();
