...
part 'obpv400_update_dynamic_message_doc_request_properties.g.dart';
...
/// * [inboundTopic] 
@BuiltValue()
abstract class OBPv400UpdateDynamicMessageDocRequestProperties implements Built<OBPv400UpdateDynamicMessageDocRequestProperties, OBPv400UpdateDynamicMessageDocRequestPropertiesBuilder> {
  ...
  OBPv400UpdateDynamicMessageDocRequestProperties._();

  factory OBPv400UpdateDynamicMessageDocRequestProperties([void updates(OBPv400UpdateDynamicMessageDocRequestPropertiesBuilder b)]) = _$OBPv400UpdateDynamicMessageDocRequestProperties;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(OBPv400UpdateDynamicMessageDocRequestPropertiesBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<OBPv400UpdateDynamicMessageDocRequestProperties> get serializer => _$OBPv400UpdateDynamicMessageDocRequestPropertiesSerializer();
}

class _$OBPv400UpdateDynamicMessageDocRequestPropertiesSerializer implements PrimitiveSerializer<OBPv400UpdateDynamicMessageDocRequestProperties> {
  @override
  final Iterable<Type> types = const [OBPv400UpdateDynamicMessageDocRequestProperties, _$OBPv400UpdateDynamicMessageDocRequestProperties];

  @override
  final String wireName = r'OBPv400UpdateDynamicMessageDocRequestProperties';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    OBPv400UpdateDynamicMessageDocRequestProperties object, {
  ...
  void _deserializeProperties(
    ...
    required OBPv400UpdateDynamicMessageDocRequestPropertiesBuilder result,
  ...
  @override
  OBPv400UpdateDynamicMessageDocRequestProperties deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = OBPv400UpdateDynamicMessageDocRequestPropertiesBuilder();
