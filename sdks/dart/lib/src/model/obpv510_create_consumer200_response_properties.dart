...
part 'obpv510_create_consumer200_response_properties.g.dart';
...
/// * [created] 
@BuiltValue()
abstract class OBPv510CreateConsumer200ResponseProperties implements Built<OBPv510CreateConsumer200ResponseProperties, OBPv510CreateConsumer200ResponsePropertiesBuilder> {
  ...
  OBPv400UpdateSystemLevelEndpointTagRequestPropertiesTagName get consumerSecret;
  ...
  OBPv510CreateConsumer200ResponseProperties._();

  factory OBPv510CreateConsumer200ResponseProperties([void updates(OBPv510CreateConsumer200ResponsePropertiesBuilder b)]) = _$OBPv510CreateConsumer200ResponseProperties;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(OBPv510CreateConsumer200ResponsePropertiesBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<OBPv510CreateConsumer200ResponseProperties> get serializer => _$OBPv510CreateConsumer200ResponsePropertiesSerializer();
}

class _$OBPv510CreateConsumer200ResponsePropertiesSerializer implements PrimitiveSerializer<OBPv510CreateConsumer200ResponseProperties> {
  @override
  final Iterable<Type> types = const [OBPv510CreateConsumer200ResponseProperties, _$OBPv510CreateConsumer200ResponseProperties];

  @override
  final String wireName = r'OBPv510CreateConsumer200ResponseProperties';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    OBPv510CreateConsumer200ResponseProperties object, {
  ...
  void _deserializeProperties(
    ...
    required OBPv510CreateConsumer200ResponsePropertiesBuilder result,
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'consumer_secret':
          ...
          result.consumerSecret.replace(valueDes);
          break;
        case r'description':
          final valueDes = serializers.deserialize(
            value,
  ...
  @override
  OBPv510CreateConsumer200ResponseProperties deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = OBPv510CreateConsumer200ResponsePropertiesBuilder();
