...
part 'obpv400_get_product200_response_properties.g.dart';
...
/// * [parentProductCode] 
@BuiltValue()
abstract class OBPv400GetProduct200ResponseProperties implements Built<OBPv400GetProduct200ResponseProperties, OBPv400GetProduct200ResponsePropertiesBuilder> {
  ...
  OBPv400GetProduct200ResponsePropertiesAttributes get attributes;
  ...
  OBPv400GetProduct200ResponsePropertiesFees get fees;
  ...
  OBPv400GetProduct200ResponseProperties._();

  factory OBPv400GetProduct200ResponseProperties([void updates(OBPv400GetProduct200ResponsePropertiesBuilder b)]) = _$OBPv400GetProduct200ResponseProperties;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(OBPv400GetProduct200ResponsePropertiesBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<OBPv400GetProduct200ResponseProperties> get serializer => _$OBPv400GetProduct200ResponsePropertiesSerializer();
}

class _$OBPv400GetProduct200ResponsePropertiesSerializer implements PrimitiveSerializer<OBPv400GetProduct200ResponseProperties> {
  @override
  final Iterable<Type> types = const [OBPv400GetProduct200ResponseProperties, _$OBPv400GetProduct200ResponseProperties];

  @override
  final String wireName = r'OBPv400GetProduct200ResponseProperties';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    OBPv400GetProduct200ResponseProperties object, {
    ...
    yield serializers.serialize(
      object.fees,
      specifiedType: const FullType(OBPv400GetProduct200ResponsePropertiesFees),
    );
  ...
  void _deserializeProperties(
    ...
    required OBPv400GetProduct200ResponsePropertiesBuilder result,
      ...
      switch (key) {
        ...
        case r'fees':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(OBPv400GetProduct200ResponsePropertiesFees),
          ) as OBPv400GetProduct200ResponsePropertiesFees;
  ...
  @override
  OBPv400GetProduct200ResponseProperties deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = OBPv400GetProduct200ResponsePropertiesBuilder();
