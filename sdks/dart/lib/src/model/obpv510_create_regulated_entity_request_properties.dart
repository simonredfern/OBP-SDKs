...
part 'obpv510_create_regulated_entity_request_properties.g.dart';
...
@BuiltValue()
abstract class OBPv510CreateRegulatedEntityRequestProperties implements Built<OBPv510CreateRegulatedEntityRequestProperties, OBPv510CreateRegulatedEntityRequestPropertiesBuilder> {
  ...
  OBPv510CreateRegulatedEntityRequestProperties._();

  factory OBPv510CreateRegulatedEntityRequestProperties([void updates(OBPv510CreateRegulatedEntityRequestPropertiesBuilder b)]) = _$OBPv510CreateRegulatedEntityRequestProperties;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(OBPv510CreateRegulatedEntityRequestPropertiesBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<OBPv510CreateRegulatedEntityRequestProperties> get serializer => _$OBPv510CreateRegulatedEntityRequestPropertiesSerializer();
}

class _$OBPv510CreateRegulatedEntityRequestPropertiesSerializer implements PrimitiveSerializer<OBPv510CreateRegulatedEntityRequestProperties> {
  @override
  final Iterable<Type> types = const [OBPv510CreateRegulatedEntityRequestProperties, _$OBPv510CreateRegulatedEntityRequestProperties];

  @override
  final String wireName = r'OBPv510CreateRegulatedEntityRequestProperties';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    OBPv510CreateRegulatedEntityRequestProperties object, {
  ...
  void _deserializeProperties(
    ...
    required OBPv510CreateRegulatedEntityRequestPropertiesBuilder result,
  ...
  @override
  OBPv510CreateRegulatedEntityRequestProperties deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = OBPv510CreateRegulatedEntityRequestPropertiesBuilder();
