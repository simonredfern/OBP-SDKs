...
part 'obpv510_update_atm_request_properties.g.dart';
...
/// * [phone] 
@BuiltValue()
abstract class OBPv510UpdateAtmRequestProperties implements Built<OBPv510UpdateAtmRequestProperties, OBPv510UpdateAtmRequestPropertiesBuilder> {
  ...
  OBPv510UpdateAtmRequestProperties._();

  factory OBPv510UpdateAtmRequestProperties([void updates(OBPv510UpdateAtmRequestPropertiesBuilder b)]) = _$OBPv510UpdateAtmRequestProperties;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(OBPv510UpdateAtmRequestPropertiesBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<OBPv510UpdateAtmRequestProperties> get serializer => _$OBPv510UpdateAtmRequestPropertiesSerializer();
}

class _$OBPv510UpdateAtmRequestPropertiesSerializer implements PrimitiveSerializer<OBPv510UpdateAtmRequestProperties> {
  @override
  final Iterable<Type> types = const [OBPv510UpdateAtmRequestProperties, _$OBPv510UpdateAtmRequestProperties];

  @override
  final String wireName = r'OBPv510UpdateAtmRequestProperties';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    OBPv510UpdateAtmRequestProperties object, {
  ...
  void _deserializeProperties(
    ...
    required OBPv510UpdateAtmRequestPropertiesBuilder result,
  ...
  @override
  OBPv510UpdateAtmRequestProperties deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = OBPv510UpdateAtmRequestPropertiesBuilder();
