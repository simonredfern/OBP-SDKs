...
$apiInstance = new OpenBankProject\Api\ViewCustomApi(
...
try {
    ...
    echo 'Exception when calling ViewCustomApi->oBPv121DeleteViewForBankAccount: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ViewCustomApi->oBPv200GetPermissionsForBankAccount: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ViewCustomApi->oBPv300CreateViewForBankAccount: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ViewCustomApi->oBPv300GetAccountsHeld: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ViewCustomApi->oBPv300GetPermissionForUserForBankAccount: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ViewCustomApi->oBPv300UpdateViewForBankAccount: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ViewCustomApi->oBPv500GetViewsForBankAccount: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ViewCustomApi->oBPv510CreateCustomView: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ViewCustomApi->oBPv510CreateUserWithAccountAccessById: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ViewCustomApi->oBPv510DeleteCustomView: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ViewCustomApi->oBPv510GetCustomView: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ViewCustomApi->oBPv510GrantUserAccessToViewById: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ViewCustomApi->oBPv510RevokeUserAccessToViewById: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ViewCustomApi->oBPv510UpdateCustomView: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ViewCustomApi->oBPv600CreateCustomViewManagement: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ViewCustomApi->oBPv600GetCustomViews: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ViewCustomApi->oBPv600GetSystemViewById: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ViewCustomApi->oBPv600GetSystemViews: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ViewCustomApi->oBPv600GetViewPermissions: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ViewCustomApi->oBPv600HasAccountAccess: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ViewCustomApi->oBPv600UpdateSystemView: ', $e->getMessage(), PHP_EOL;
}
```
