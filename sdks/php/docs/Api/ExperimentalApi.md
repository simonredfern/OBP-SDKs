...
Operations related to Experimental
...
$apiInstance = new OpenBankProject\Api\ExperimentalApi(
...
try {
    ...
    echo 'Exception when calling ExperimentalApi->oBPv310CreateMeeting: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ExperimentalApi->oBPv310GetMeeting: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ExperimentalApi->oBPv310GetMeetings: ', $e->getMessage(), PHP_EOL;
}
```
