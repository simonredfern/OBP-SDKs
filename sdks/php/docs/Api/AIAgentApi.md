...
$apiInstance = new OpenBankProject\Api\AIAgentApi(
...
try {
    ...
    echo 'Exception when calling AIAgentApi->oBPv600DeleteSignalChannel: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling AIAgentApi->oBPv600GetSignalChannelInfo: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling AIAgentApi->oBPv600GetSignalChannels: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling AIAgentApi->oBPv600GetSignalMessages: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling AIAgentApi->oBPv600GetSignalStats: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling AIAgentApi->oBPv600PublishSignalMessage: ', $e->getMessage(), PHP_EOL;
}
```
