...
Operations related to Entitlement
...
$apiInstance = new OpenBankProject\Api\EntitlementApi(
...
try {
    ...
    echo 'Exception when calling EntitlementApi->oBPv200AddEntitlement: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling EntitlementApi->oBPv200DeleteEntitlement: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling EntitlementApi->oBPv200GetPermissionsForBankAccount: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling EntitlementApi->oBPv210GetEntitlementsByBankAndUser: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling EntitlementApi->oBPv300AddEntitlementRequest: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling EntitlementApi->oBPv300DeleteEntitlementRequest: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling EntitlementApi->oBPv300GetAllEntitlementRequests: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling EntitlementApi->oBPv300GetEntitlementRequests: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling EntitlementApi->oBPv300GetEntitlementRequestsForCurrentUser: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling EntitlementApi->oBPv300GetEntitlementsForCurrentUser: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling EntitlementApi->oBPv310GetAllEntitlements: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling EntitlementApi->oBPv400CreateUserWithRoles: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling EntitlementApi->oBPv400GetEntitlements: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling EntitlementApi->oBPv400GetEntitlementsForBank: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling EntitlementApi->oBPv510GetEntitlementsAndPermissions: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling EntitlementApi->oBPv600AddUserToGroup: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling EntitlementApi->oBPv600DeleteEntitlement: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling EntitlementApi->oBPv600GetGroupEntitlements: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling EntitlementApi->oBPv600GetRolesWithEntitlementCountsAtAllBanks: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling EntitlementApi->oBPv600GetUserGroupMemberships: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling EntitlementApi->oBPv600RemoveUserFromGroup: ', $e->getMessage(), PHP_EOL;
}
```
