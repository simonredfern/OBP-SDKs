...
Operations related to Documentation
...
$apiInstance = new OpenBankProject\Api\DocumentationApi(
...
try {
    ...
    echo 'Exception when calling DocumentationApi->oBPv140GetBankLevelDynamicResourceDocsObp: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DocumentationApi->oBPv140GetResourceDocsObp: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DocumentationApi->oBPv140GetResourceDocsOpenAPI31: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DocumentationApi->oBPv140GetResourceDocsSwagger: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DocumentationApi->oBPv220GetMessageDocs: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
oBPv300GetApiGlossary(): \OpenBankProject\Model\OBPv300GetApiGlossary200Response
```
...
try {
    $result = $apiInstance->oBPv300GetApiGlossary();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DocumentationApi->oBPv300GetApiGlossary: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenBankProject\Model\OBPv300GetApiGlossary200Response**](../Model/OBPv300GetApiGlossary200Response.md)
...
try {
    ...
    echo 'Exception when calling DocumentationApi->oBPv310GetMessageDocsSwagger: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DocumentationApi->oBPv600GetMessageDocsJsonSchema: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DocumentationApi->oBPv600GetScannedApiVersions: ', $e->getMessage(), PHP_EOL;
}
```
