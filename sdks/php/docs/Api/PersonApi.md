...
$apiInstance = new OpenBankProject\Api\PersonApi(
...
try {
    ...
    echo 'Exception when calling PersonApi->oBPv140AddCustomerMessage: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling PersonApi->oBPv400CreateCustomerMessage: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling PersonApi->oBPv510CreateAgent: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling PersonApi->oBPv510UpdateAgentStatus: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling PersonApi->oBPv600CreateCustomer: ', $e->getMessage(), PHP_EOL;
}
```
