# OpenBankProject\TransactionFirehoseApi
...
$apiInstance = new OpenBankProject\Api\TransactionFirehoseApi(
...
try {
    ...
    echo 'Exception when calling TransactionFirehoseApi->oBPv300GetFirehoseTransactionsForBankAccount: ', $e->getMessage(), PHP_EOL;
}
```
