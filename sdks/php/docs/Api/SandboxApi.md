...
```php
oBPv210SandboxDataImport($obpv210_sandbox_data_import_request): \OpenBankProject\Model\OBPv121UpdateTransactionNarrative200Response
```
...
| ------------- | ------------- | ------------- | ------------- |
| **obpv210_sandbox_data_import_request** | [**\OpenBankProject\Model\OBPv210SandboxDataImportRequest**](../Model/OBPv210SandboxDataImportRequest.md)| Request body | |
