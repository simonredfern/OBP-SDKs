...
try {
    ...
    echo 'Exception when calling AccountApplicationApi->oBPv310CreateAccountApplication: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling AccountApplicationApi->oBPv310GetAccountApplication: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling AccountApplicationApi->oBPv310GetAccountApplications: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling AccountApplicationApi->oBPv310UpdateAccountApplicationStatus: ', $e->getMessage(), PHP_EOL;
}
```
