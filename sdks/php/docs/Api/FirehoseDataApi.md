...
Operations related to FirehoseData
...
$apiInstance = new OpenBankProject\Api\FirehoseDataApi(
...
try {
    ...
    echo 'Exception when calling FirehoseDataApi->oBPv300GetFirehoseTransactionsForBankAccount: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling FirehoseDataApi->oBPv310GetFirehoseCustomers: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling FirehoseDataApi->oBPv400GetFastFirehoseAccountsAtOneBank: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling FirehoseDataApi->oBPv400GetFirehoseAccountsAtOneBank: ', $e->getMessage(), PHP_EOL;
}
```
