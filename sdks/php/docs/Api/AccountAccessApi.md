...
$apiInstance = new OpenBankProject\Api\AccountAccessApi(
...
try {
    ...
    echo 'Exception when calling AccountAccessApi->oBPv510CreateUserWithAccountAccessById: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling AccountAccessApi->oBPv510GrantUserAccessToViewById: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling AccountAccessApi->oBPv510RevokeUserAccessToViewById: ', $e->getMessage(), PHP_EOL;
}
```
