...
```php
oBPv130GetCards(): \OpenBankProject\Model\OBPv130GetCards200Response
```
...
$apiInstance = new OpenBankProject\Api\CardApi(
...
try {
    $result = $apiInstance->oBPv130GetCards();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CardApi->oBPv130GetCards: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenBankProject\Model\OBPv130GetCards200Response**](../Model/OBPv130GetCards200Response.md)
...
try {
    ...
    echo 'Exception when calling CardApi->oBPv310CreateCardAttribute: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling CardApi->oBPv310DeleteCardForBank: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
oBPv310GetCardForBank($bankid, $cardid): \OpenBankProject\Model\OBPv310GetCardForBank200Response
```
...
try {
    $result = $apiInstance->oBPv310GetCardForBank($bankid, $cardid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CardApi->oBPv310GetCardForBank: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenBankProject\Model\OBPv310GetCardForBank200Response**](../Model/OBPv310GetCardForBank200Response.md)
...
```php
oBPv310GetCardsForBank($bankid): \OpenBankProject\Model\OBPv310GetCardsForBank200Response
```
...
try {
    $result = $apiInstance->oBPv310GetCardsForBank($bankid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CardApi->oBPv310GetCardsForBank: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenBankProject\Model\OBPv310GetCardsForBank200Response**](../Model/OBPv310GetCardsForBank200Response.md)
...
```php
oBPv310GetStatusOfCreditCardOrder($bankid, $accountid, $viewid): \OpenBankProject\Model\OBPv310GetStatusOfCreditCardOrder200Response
```
...
try {
    $result = $apiInstance->oBPv310GetStatusOfCreditCardOrder($bankid, $accountid, $viewid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CardApi->oBPv310GetStatusOfCreditCardOrder: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenBankProject\Model\OBPv310GetStatusOfCreditCardOrder200Response**](../Model/OBPv310GetStatusOfCreditCardOrder200Response.md)
...
try {
    ...
    echo 'Exception when calling CardApi->oBPv310UpdateCardAttribute: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
oBPv310UpdatedCardForBank($bankid, $cardid, $obpv310_updated_card_for_bank_request): \OpenBankProject\Model\OBPv310GetCardsForBank200ResponsePropertiesCardsItems
```
...
| **bankid** | **string**| The BANKID identifier | |
| **cardid** | **string**| The CARDID identifier | |
| **obpv310_updated_card_for_bank_request** | [**\OpenBankProject\Model\OBPv310UpdatedCardForBankRequest**](../Model/OBPv310UpdatedCardForBankRequest.md)| Request body | |

### Return type

[**\OpenBankProject\Model\OBPv310GetCardsForBank200ResponsePropertiesCardsItems**](../Model/OBPv310GetCardsForBank200ResponsePropertiesCardsItems.md)
...
try {
    ...
    echo 'Exception when calling CardApi->oBPv400CreateOrUpdateCardAttributeDefinition: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling CardApi->oBPv400DeleteCardAttributeDefinition: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling CardApi->oBPv400GetCardAttributeDefinition: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
oBPv500AddCardForBank($bankid, $obpv500_add_card_for_bank_request): \OpenBankProject\Model\OBPv500AddCardForBank200Response
```
...
| ------------- | ------------- | ------------- | ------------- |
| **bankid** | **string**| The BANKID identifier | |
| **obpv500_add_card_for_bank_request** | [**\OpenBankProject\Model\OBPv500AddCardForBankRequest**](../Model/OBPv500AddCardForBankRequest.md)| Request body | |

### Return type

[**\OpenBankProject\Model\OBPv500AddCardForBank200Response**](../Model/OBPv500AddCardForBank200Response.md)
