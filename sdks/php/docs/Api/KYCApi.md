...
$apiInstance = new OpenBankProject\Api\KYCApi(
...
try {
    ...
    echo 'Exception when calling KYCApi->oBPv200AddKycCheck: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling KYCApi->oBPv200AddKycDocument: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling KYCApi->oBPv200AddKycMedia: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling KYCApi->oBPv200AddKycStatus: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling KYCApi->oBPv200GetKycChecks: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling KYCApi->oBPv200GetKycDocuments: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling KYCApi->oBPv200GetKycMedia: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling KYCApi->oBPv200GetKycStatuses: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling KYCApi->oBPv310CreateTaxResidence: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling KYCApi->oBPv310DeleteCustomerAddress: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling KYCApi->oBPv310DeleteTaxResidence: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling KYCApi->oBPv310GetCustomerAddresses: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling KYCApi->oBPv310GetTaxResidence: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling KYCApi->oBPv400CreateUserInvitation: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling KYCApi->oBPv400GetCustomersByCustomerPhoneNumber: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling KYCApi->oBPv400GetUserInvitationAnonymous: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling KYCApi->oBPv500GetCustomerOverview: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling KYCApi->oBPv500GetCustomerOverviewFlat: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling KYCApi->oBPv600GetCustomerByCustomerNumber: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling KYCApi->oBPv600GetCustomersByLegalName: ', $e->getMessage(), PHP_EOL;
}
```
