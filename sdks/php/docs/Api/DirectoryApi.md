...
$apiInstance = new OpenBankProject\Api\DirectoryApi(
...
try {
    ...
    echo 'Exception when calling DirectoryApi->oBPv510CreateConsumerDynamicRegistration: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DirectoryApi->oBPv510CreateRegulatedEntity: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DirectoryApi->oBPv510CreateRegulatedEntityAttribute: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DirectoryApi->oBPv510DeleteRegulatedEntity: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DirectoryApi->oBPv510DeleteRegulatedEntityAttribute: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DirectoryApi->oBPv510GetAllRegulatedEntityAttributes: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DirectoryApi->oBPv510GetRegulatedEntityAttributeById: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DirectoryApi->oBPv510GetRegulatedEntityById: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DirectoryApi->oBPv510RegulatedEntities: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DirectoryApi->oBPv510UpdateRegulatedEntityAttribute: ', $e->getMessage(), PHP_EOL;
}
```
