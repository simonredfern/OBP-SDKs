...
try {
    ...
    echo 'Exception when calling ChannelApi->oBPv600DeleteSignalChannel: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ChannelApi->oBPv600GetSignalChannelInfo: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ChannelApi->oBPv600GetSignalChannels: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ChannelApi->oBPv600GetSignalMessages: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ChannelApi->oBPv600GetSignalStats: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ChannelApi->oBPv600PublishSignalMessage: ', $e->getMessage(), PHP_EOL;
}
```
