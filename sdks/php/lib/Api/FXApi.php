...
class FXApi
{
    ...
    public function oBPv220CreateFxRequest($bankid, $obpv220_create_fx_request, string $contentType = self::contentTypes['oBPv220CreateFx'][0])
    {
        ...
        $resourcePath = '/obp/v2.2.0/banks/{bankid}/fx';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function oBPv220GetCurrentFxRateRequest($bankid, $fromcurrencycode, $tocurrencycode, string $contentType = self::contentTypes['oBPv220GetCurrentFxRate'][0])
    {
        ...
        $resourcePath = '/obp/v2.2.0/banks/{bankid}/fx/{fromcurrencycode}/{tocurrencycode}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($fromcurrencycode !== null) {
            $resourcePath = str_replace(
                '{' . 'fromcurrencycode' . '}',
                ObjectSerializer::toPathValue($fromcurrencycode),
                $resourcePath
            );
        }
        // path params
        if ($tocurrencycode !== null) {
            $resourcePath = str_replace(
                '{' . 'tocurrencycode' . '}',
                ObjectSerializer::toPathValue($tocurrencycode),
                $resourcePath
            );
        }
